...
public:
	...
	/**
	 * Appends or sets a value into the default attribute array
	 * @return true if the attribute was found and cleared, false if it was not found.
	 */
	bool AppendSetDefaultAttribute(const FString& AttributeName, const FString& AttributeValue);

	/**
	 * Clears a value into the default attribute array
	 * @return true if the attribute was found and cleared, false if it was not found.
	 */
	...
	*/
	...
	{
	public:
		explicit Lock(FRH_AnalyticsProviderEventCache& EventCache)
...
private:
	...
	*/
	struct FAnalyticsEventEntry
	{
		...
		*/
		FAnalyticsEventEntry(FString&& InEventName, const FDateTime& InTimestamp, int32 InEventSizeChars)
