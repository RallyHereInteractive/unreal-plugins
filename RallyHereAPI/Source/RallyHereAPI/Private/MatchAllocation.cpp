...
bool FRHAPI_MatchAllocation::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	...
	const bool AllocationId_IsValid = JsonAllocationIdField.IsValid() && (!JsonAllocationIdField->IsNull() && TryGetJsonValue(JsonAllocationIdField, AllocationId));
	ParseSuccess &= AllocationId_IsValid; 
