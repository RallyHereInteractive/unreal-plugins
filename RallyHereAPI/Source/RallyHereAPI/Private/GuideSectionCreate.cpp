...
////////////////////////////////////////////////////
// Implementation for FRHAPI_GuideSectionCreate

void FRHAPI_GuideSectionCreate::WriteJson(TSharedRef<TJsonWriter<>>& Writer) const
{
	Writer->WriteObjectStart();
	Writer->WriteIdentifierPrefix(TEXT("section_type"));
	RallyHereAPI::WriteJsonValue(Writer, SectionType);
	...
	if (Content_IsSet)
	{
		...
		RallyHereAPI::WriteJsonValue(Writer, Content_Optional);
	}
	if (Ref1_IsSet)
	{
...
bool FRHAPI_GuideSectionCreate::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	...
	const TSharedPtr<FJsonValue> JsonSectionTypeField = (*Object)->TryGetField(TEXT("section_type"));
	const bool SectionType_IsValid = JsonSectionTypeField.IsValid() && (!JsonSectionTypeField->IsNull() && TryGetJsonValue(JsonSectionTypeField, SectionType));
	ParseSuccess &= SectionType_IsValid; 
	...
	{
		Content_IsNull = JsonContentField->IsNull();
		Content_IsSet = Content_IsNull || TryGetJsonValue(JsonContentField, Content_Optional);
		ParseSuccess &= Content_IsSet;
	}
