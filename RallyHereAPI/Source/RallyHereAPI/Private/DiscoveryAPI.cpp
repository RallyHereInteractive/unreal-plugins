...
FHttpRequestPtr FDiscoveryAPI::GetDiscovery(const FRequest_GetDiscovery& Request, const FDelegate_GetDiscovery& Delegate /*= FDelegate_GetDiscovery()*/, int32 Priority /*= DefaultRallyHereAPIPriority*/)
{
    if (!IsValid())
        return nullptr;
    ...
    ResponseDelegate.BindRaw(this, &FDiscoveryAPI::OnGetDiscoveryResponse, Delegate, Request.GetRequestMetadata(), Request.GetAuthContext(), Priority);
...
void FDiscoveryAPI::OnGetDiscoveryResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FDelegate_GetDiscovery Delegate, FRequestMetadata RequestMetadata, TSharedPtr<FAuthContext> AuthContextForRetry, int32 Priority)
{
    FHttpRequestCompleteDelegate ResponseDelegate;
    ...
    if (AuthContextForRetry)
    {
        ...
        ResponseDelegate.BindRaw(this, &FDiscoveryAPI::OnGetDiscoveryResponse, Delegate, RequestMetadata, TSharedPtr<FAuthContext>(), Priority);
    }
