...
bool FRHAPI_EventParamsSchemaResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	...
	const bool EventParamSchemas_IsValid = JsonEventParamSchemasField.IsValid() && (!JsonEventParamSchemasField->IsNull() && TryGetJsonValue(JsonEventParamSchemasField, EventParamSchemas));
	ParseSuccess &= EventParamSchemas_IsValid; 
