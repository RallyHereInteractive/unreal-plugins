...
////////////////////////////////////////////////////
// Implementation for FRHAPI_PurchasePrice
...
bool FRHAPI_PurchasePrice::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	...
	if (JsonPriceCouponItemIdField.IsValid())
	{
		PriceCouponItemId_IsNull = JsonPriceCouponItemIdField->IsNull();
		PriceCouponItemId_IsSet = PriceCouponItemId_IsNull || TryGetJsonValue(JsonPriceCouponItemIdField, PriceCouponItemId_Optional);
