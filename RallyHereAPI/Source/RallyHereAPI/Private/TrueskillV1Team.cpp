...
////////////////////////////////////////////////////
// Implementation for FRHAPI_TrueskillV1Team

void FRHAPI_TrueskillV1Team::WriteJson(TSharedRef<TJsonWriter<>>& Writer) const
{
...
bool FRHAPI_TrueskillV1Team::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
    ...
    ParseSuccess &= RallyHereAPI::TryGetJsonValue(*Object, TEXT("rank"), Rank);
