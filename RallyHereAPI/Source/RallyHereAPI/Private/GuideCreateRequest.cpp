...
////////////////////////////////////////////////////
// Implementation for FRHAPI_GuideCreateRequest

void FRHAPI_GuideCreateRequest::WriteJson(TSharedRef<TJsonWriter<>>& Writer) const
{
	...
	if (Sections_IsSet)
	{
		Writer->WriteIdentifierPrefix(TEXT("sections"));
		RallyHereAPI::WriteJsonValue(Writer, Sections_Optional);
	}
	Writer->WriteObjectEnd();
}

bool FRHAPI_GuideCreateRequest::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	...
	const TSharedPtr<FJsonValue> JsonSectionsField = (*Object)->TryGetField(TEXT("sections"));
	if (JsonSectionsField.IsValid())
	{
		Sections_IsSet = TryGetJsonValue(JsonSectionsField, Sections_Optional);
		ParseSuccess &= Sections_IsSet;
	}
