...
////////////////////////////////////////////////////
// Implementation for FRHAPI_TrueskillV1PlayerData

void FRHAPI_TrueskillV1PlayerData::WriteJson(TSharedRef<TJsonWriter<>>& Writer) const
{
...
bool FRHAPI_TrueskillV1PlayerData::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
    ...
    ParseSuccess &= RallyHereAPI::TryGetJsonValue(*Object, TEXT("seconds_in_match"), SecondsInMatch);
