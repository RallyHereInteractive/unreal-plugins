...
////////////////////////////////////////////////////
// Implementation for FRHAPI_PexHostRequest

void FRHAPI_PexHostRequest::WriteJson(TSharedRef<TJsonWriter<>>& Writer) const
{
...
bool FRHAPI_PexHostRequest::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	...
	if (JsonConnectionCountField.IsValid())
	{
		ConnectionCount_IsNull = JsonConnectionCountField->IsNull();
		ConnectionCount_IsSet = ConnectionCount_IsNull || TryGetJsonValue(JsonConnectionCountField, ConnectionCount_Optional);
	...
	if (JsonTotalUniquePlayersField.IsValid())
	{
		TotalUniquePlayers_IsNull = JsonTotalUniquePlayersField->IsNull();
		TotalUniquePlayers_IsSet = TotalUniquePlayers_IsNull || TryGetJsonValue(JsonTotalUniquePlayersField, TotalUniquePlayers_Optional);
