...
////////////////////////////////////////////////////
// Implementation for FRHAPI_FailedPlayerOrderCreateSingle

void FRHAPI_FailedPlayerOrderCreateSingle::WriteJson(TSharedRef<TJsonWriter<>>& Writer) const
{
	...
	if (ErrorInfo_IsSet)
	{
		Writer->WriteIdentifierPrefix(TEXT("error_info"));
		RallyHereAPI::WriteJsonValue(Writer, ErrorInfo_Optional);
	}
	Writer->WriteObjectEnd();
}

bool FRHAPI_FailedPlayerOrderCreateSingle::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	...
	const TSharedPtr<FJsonValue> JsonErrorInfoField = (*Object)->TryGetField(TEXT("error_info"));
	if (JsonErrorInfoField.IsValid())
	{
		ErrorInfo_IsSet = TryGetJsonValue(JsonErrorInfoField, ErrorInfo_Optional);
		ParseSuccess &= ErrorInfo_IsSet;
	}
