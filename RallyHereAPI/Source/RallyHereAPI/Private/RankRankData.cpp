...
////////////////////////////////////////////////////
// Implementation for FRHAPI_RankRankData

void FRHAPI_RankRankData::WriteJson(TSharedRef<TJsonWriter<>>& Writer) const
{
...
bool FRHAPI_RankRankData::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
