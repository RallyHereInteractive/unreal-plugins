...
bool FRequest_SetSinglePlayerIdSetting::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
    ...
    if (Consumes.Num() == 0 || Consumes.Contains(TEXT("application/json"))) // Default to Json Body request
    {
        ...
        WriteJsonValue(Writer, BodySetSinglePlayerIdSettingV1PlayerPlayerIdSettingTypeSettingTypeIdKeyKeyPut);
        Writer->Close();
    ...
    {
        UE_LOG(LogRallyHereAPI, Error, TEXT("FRequest_SetSinglePlayerIdSetting - Body parameter (FRHAPI_BodySetSinglePlayerIdSettingV1PlayerPlayerIdSettingTypeSettingTypeIdKeyKeyPut) was ignored, not supported in multipart form"));
    }
    else if (Consumes.Contains(TEXT("application/x-www-form-urlencoded")))
    {
        UE_LOG(LogRallyHereAPI, Error, TEXT("FRequest_SetSinglePlayerIdSetting - Body parameter (FRHAPI_BodySetSinglePlayerIdSettingV1PlayerPlayerIdSettingTypeSettingTypeIdKeyKeyPut) was ignored, not supported in urlencoded requests"));
    }
    else
    {
...
bool FRequest_SetSinglePlayerUuidSetting::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
    ...
    if (Consumes.Num() == 0 || Consumes.Contains(TEXT("application/json"))) // Default to Json Body request
    {
        ...
        WriteJsonValue(Writer, BodySetSinglePlayerUuidSettingV2PlayerPlayerUuidSettingTypeSettingTypeIdKeyKeyPut);
        Writer->Close();
    ...
    {
        UE_LOG(LogRallyHereAPI, Error, TEXT("FRequest_SetSinglePlayerUuidSetting - Body parameter (FRHAPI_BodySetSinglePlayerUuidSettingV2PlayerPlayerUuidSettingTypeSettingTypeIdKeyKeyPut) was ignored, not supported in multipart form"));
    }
    else if (Consumes.Contains(TEXT("application/x-www-form-urlencoded")))
    {
        UE_LOG(LogRallyHereAPI, Error, TEXT("FRequest_SetSinglePlayerUuidSetting - Body parameter (FRHAPI_BodySetSinglePlayerUuidSettingV2PlayerPlayerUuidSettingTypeSettingTypeIdKeyKeyPut) was ignored, not supported in urlencoded requests"));
    }
    else
    {
