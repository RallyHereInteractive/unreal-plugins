...
struct RALLYHEREAPI_API FRHAPI_PersonInfoResponse : public FRHAPI_Model
{
	...
	*/
	...
	FORCEINLINE FString& GetEmail() { return Email_Optional; }
	/** @brief Gets the value of Email_Optional, regardless of it having been set */
	FORCEINLINE const FString& GetEmail() const { return Email_Optional; }
	/** @brief Gets the value of Email_Optional, if it has been set, otherwise it returns DefaultValue */
	FORCEINLINE const FString& GetEmail(const FString& DefaultValue) const { if (Email_IsSet) return Email_Optional; return DefaultValue; }
	/** @brief Fills OutValue with the value of Email_Optional and returns true if it has been set, otherwise returns false */
	FORCEINLINE bool GetEmail(FString& OutValue) const { if (Email_IsSet) OutValue = Email_Optional; return Email_IsSet; }
	/** @brief Returns a pointer to Email_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE FString* GetEmailOrNull() { if (Email_IsSet) return (&Email_Optional); return nullptr; }
	/** @brief Returns a pointer to Email_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE const FString* GetEmailOrNull() const { if (Email_IsSet) return (&Email_Optional); return nullptr; }
	/** @brief Sets the value of Email_Optional and also sets Email_IsSet to true */
	FORCEINLINE void SetEmail(const FString& NewValue) { Email_Optional = NewValue; Email_IsSet = true;  }
	/** @brief Sets the value of Email_Optional and also sets Email_IsSet to true using move semantics */
	FORCEINLINE void SetEmail(FString&& NewValue) { Email_Optional = NewValue; Email_IsSet = true;  }
