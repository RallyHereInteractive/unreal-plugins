...
#include "PexCount.h"
#include "PexStat.h"
#include "PexClientRequest.generated.h"

/** @defgroup RHAPI_PexClientRequest RallyHere API Model PexClientRequest
 *  @{
 */
...
struct RALLYHEREAPI_API FRHAPI_PexClientRequest : public FRHAPI_Model
{
	GENERATED_BODY()
