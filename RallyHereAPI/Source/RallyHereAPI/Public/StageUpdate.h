...
#include "StageUpdate.generated.h"

/** @defgroup RHAPI_StageUpdate RallyHere API Model StageUpdate
 *  @{
 */

/**
 * @brief Fields to update a stage with.  NOTE: the fields shared between this and the StageMatchmakeParams are used to determine which     matchmaking pool this stage will be placed into
 */
USTRUCT(BlueprintType)
struct RALLYHEREAPI_API FRHAPI_StageUpdate : public FRHAPI_Model
{
	GENERATED_BODY()
