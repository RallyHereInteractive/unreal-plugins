...
struct RALLYHEREAPI_API FRHAPI_PlayerOrder : public FRHAPI_Model
{
	...
	*/
	...
	FORCEINLINE FString& GetOrderId() { return OrderId; }
	/** @brief Gets the value of OrderId */
	FORCEINLINE const FString& GetOrderId() const { return OrderId; }
	/** @brief Sets the value of OrderId */
	FORCEINLINE void SetOrderId(const FString& NewValue) { OrderId = NewValue;   }
	/** @brief Sets the value of OrderId using move semantics */
	FORCEINLINE void SetOrderId(FString&& NewValue) { OrderId = NewValue;   }
	...
	FORCEINLINE FDateTime& GetCreatedTime() { return CreatedTime; }
	/** @brief Gets the value of CreatedTime */
	FORCEINLINE const FDateTime& GetCreatedTime() const { return CreatedTime; }
	/** @brief Sets the value of CreatedTime */
	FORCEINLINE void SetCreatedTime(const FDateTime& NewValue) { CreatedTime = NewValue;   }
	/** @brief Sets the value of CreatedTime using move semantics */
	FORCEINLINE void SetCreatedTime(FDateTime&& NewValue) { CreatedTime = NewValue;   }
	...
	FORCEINLINE TArray<FRHAPI_PlayerOrderEntry>& GetEntries() { return Entries; }
	/** @brief Gets the value of Entries */
	FORCEINLINE const TArray<FRHAPI_PlayerOrderEntry>& GetEntries() const { return Entries; }
	/** @brief Sets the value of Entries */
	FORCEINLINE void SetEntries(const TArray<FRHAPI_PlayerOrderEntry>& NewValue) { Entries = NewValue;   }
	/** @brief Sets the value of Entries using move semantics */
	FORCEINLINE void SetEntries(TArray<FRHAPI_PlayerOrderEntry>&& NewValue) { Entries = NewValue;   }
};
