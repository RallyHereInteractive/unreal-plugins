...
#include "UnionCCU.h"
#include "PlatformUnionCCUsAnyPlatform.generated.h"

/** @defgroup RHAPI_PlatformUnionCCUsAnyPlatform RallyHere API Model PlatformUnionCCUsAnyPlatform
 *  @{
 */
...
struct RALLYHEREAPI_API FRHAPI_PlatformUnionCCUsAnyPlatform : public FRHAPI_Model
{
    GENERATED_BODY()
