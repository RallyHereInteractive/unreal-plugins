...
struct RALLYHEREAPI_API FRHAPI_MatchMakingTemplateGroup : public FRHAPI_Model
{
	...
	*/
	...
	FORCEINLINE FGuid& GetTemplateGroupId() { return TemplateGroupId; }
	/** @brief Gets the value of TemplateGroupId */
	FORCEINLINE const FGuid& GetTemplateGroupId() const { return TemplateGroupId; }
	/** @brief Sets the value of TemplateGroupId */
	FORCEINLINE void SetTemplateGroupId(const FGuid& NewValue) { TemplateGroupId = NewValue;   }
	/** @brief Sets the value of TemplateGroupId using move semantics */
	FORCEINLINE void SetTemplateGroupId(FGuid&& NewValue) { TemplateGroupId = NewValue;   }
	...
	FORCEINLINE TArray<FRHAPI_MatchMakingTemplate>& GetTemplateOptions() { return TemplateOptions; }
	/** @brief Gets the value of TemplateOptions */
	FORCEINLINE const TArray<FRHAPI_MatchMakingTemplate>& GetTemplateOptions() const { return TemplateOptions; }
	/** @brief Sets the value of TemplateOptions */
	FORCEINLINE void SetTemplateOptions(const TArray<FRHAPI_MatchMakingTemplate>& NewValue) { TemplateOptions = NewValue;   }
	/** @brief Sets the value of TemplateOptions using move semantics */
	FORCEINLINE void SetTemplateOptions(TArray<FRHAPI_MatchMakingTemplate>&& NewValue) { TemplateOptions = NewValue;   }
