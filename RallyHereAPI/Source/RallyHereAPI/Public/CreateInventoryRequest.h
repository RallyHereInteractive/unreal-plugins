...
struct RALLYHEREAPI_API FRHAPI_CreateInventoryRequest : public FRHAPI_Model
{
	...
	*/
	...
	/** @brief Gets the value of ItemId */
	FORCEINLINE const int32& GetItemId() const { return ItemId; }
	/** @brief Sets the value of ItemId */
	FORCEINLINE void SetItemId(const int32& NewValue) { ItemId = NewValue;   }
	/** @brief Sets the value of ItemId using move semantics */
	FORCEINLINE void SetItemId(int32&& NewValue) { ItemId = NewValue;   }
	...
	FORCEINLINE ERHAPI_CreateInventoryType& GetType() { return Type_Optional; }
	/** @brief Gets the value of Type_Optional, regardless of it having been set */
	FORCEINLINE const ERHAPI_CreateInventoryType& GetType() const { return Type_Optional; }
	/** @brief Gets the value of Type_Optional, if it has been set, otherwise it returns DefaultValue */
	FORCEINLINE const ERHAPI_CreateInventoryType& GetType(const ERHAPI_CreateInventoryType& DefaultValue) const { if (Type_IsSet) return Type_Optional; return DefaultValue; }
	/** @brief Fills OutValue with the value of Type_Optional and returns true if it has been set, otherwise returns false */
	FORCEINLINE bool GetType(ERHAPI_CreateInventoryType& OutValue) const { if (Type_IsSet) OutValue = Type_Optional; return Type_IsSet; }
	/** @brief Returns a pointer to Type_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE ERHAPI_CreateInventoryType* GetTypeOrNull() { if (Type_IsSet) return (&Type_Optional); return nullptr; }
	/** @brief Returns a pointer to Type_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE const ERHAPI_CreateInventoryType* GetTypeOrNull() const { if (Type_IsSet) return (&Type_Optional); return nullptr; }
	/** @brief Sets the value of Type_Optional and also sets Type_IsSet to true */
	FORCEINLINE void SetType(const ERHAPI_CreateInventoryType& NewValue) { Type_Optional = NewValue; Type_IsSet = true;  }
	/** @brief Sets the value of Type_Optional and also sets Type_IsSet to true using move semantics */
	FORCEINLINE void SetType(ERHAPI_CreateInventoryType&& NewValue) { Type_Optional = NewValue; Type_IsSet = true;  }
