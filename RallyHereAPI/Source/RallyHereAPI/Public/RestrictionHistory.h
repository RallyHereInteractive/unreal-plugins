...
#include "RestrictionHistory.generated.h"

/** @defgroup RHAPI_RestrictionHistory RallyHere API Model RestrictionHistory
 *  @{
 */

/**
 * @brief List of restriction events that have been applied to a user
 */
USTRUCT(BlueprintType)
struct RALLYHEREAPI_API FRHAPI_RestrictionHistory : public FRHAPI_Model
{
	GENERATED_BODY()
	...
	*/
	...
	/** @brief The restriction history entries */
	UPROPERTY(BlueprintReadWrite, Category = "RallyHere")
	TArray<FRHAPI_RestrictionEvent> Entries{  };
	/** @brief Gets the value of Entries */
	FORCEINLINE TArray<FRHAPI_RestrictionEvent>& GetEntries() { return Entries; }
	/** @brief Gets the value of Entries */
	FORCEINLINE const TArray<FRHAPI_RestrictionEvent>& GetEntries() const { return Entries; }
	/** @brief Sets the value of Entries */
	FORCEINLINE void SetEntries(const TArray<FRHAPI_RestrictionEvent>& NewValue) { Entries = NewValue;   }
	/** @brief Sets the value of Entries using move semantics */
	FORCEINLINE void SetEntries(TArray<FRHAPI_RestrictionEvent>&& NewValue) { Entries = NewValue;   }
