...
struct RALLYHEREAPI_API FRHAPI_RestrictionHistory : public FRHAPI_Model
{
	...
	*/
	...
	TArray<FRHAPI_RestrictionEvent>& GetEntries() { return Entries; }
	/** @brief Gets the value of Entries */
	const TArray<FRHAPI_RestrictionEvent>& GetEntries() const { return Entries; }
	/** @brief Sets the value of Entries */
	void SetEntries(const TArray<FRHAPI_RestrictionEvent>& NewValue) { Entries = NewValue;   }
	/** @brief Sets the value of Entries using move semantics */
	void SetEntries(TArray<FRHAPI_RestrictionEvent>&& NewValue) { Entries = NewValue;   }
