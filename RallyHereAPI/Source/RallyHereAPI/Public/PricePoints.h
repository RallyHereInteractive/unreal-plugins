...
struct RALLYHEREAPI_API FRHAPI_PricePoints : public FRHAPI_Model
{
	...
	*/
	...
	FORCEINLINE TMap<FString, FRHAPI_PricePoint>& GetPricePoints() { return PricePoints_Optional; }
	/** @brief Gets the value of PricePoints_Optional, regardless of it having been set */
	FORCEINLINE const TMap<FString, FRHAPI_PricePoint>& GetPricePoints() const { return PricePoints_Optional; }
	/** @brief Gets the value of PricePoints_Optional, if it has been set, otherwise it returns DefaultValue */
	FORCEINLINE const TMap<FString, FRHAPI_PricePoint>& GetPricePoints(const TMap<FString, FRHAPI_PricePoint>& DefaultValue) const { if (PricePoints_IsSet) return PricePoints_Optional; return DefaultValue; }
	/** @brief Fills OutValue with the value of PricePoints_Optional and returns true if it has been set, otherwise returns false */
	FORCEINLINE bool GetPricePoints(TMap<FString, FRHAPI_PricePoint>& OutValue) const { if (PricePoints_IsSet) OutValue = PricePoints_Optional; return PricePoints_IsSet; }
	/** @brief Returns a pointer to PricePoints_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE TMap<FString, FRHAPI_PricePoint>* GetPricePointsOrNull() { if (PricePoints_IsSet) return (&PricePoints_Optional); return nullptr; }
	/** @brief Returns a pointer to PricePoints_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE const TMap<FString, FRHAPI_PricePoint>* GetPricePointsOrNull() const { if (PricePoints_IsSet) return (&PricePoints_Optional); return nullptr; }
	/** @brief Sets the value of PricePoints_Optional and also sets PricePoints_IsSet to true */
	FORCEINLINE void SetPricePoints(const TMap<FString, FRHAPI_PricePoint>& NewValue) { PricePoints_Optional = NewValue; PricePoints_IsSet = true;  }
	/** @brief Sets the value of PricePoints_Optional and also sets PricePoints_IsSet to true using move semantics */
	FORCEINLINE void SetPricePoints(TMap<FString, FRHAPI_PricePoint>&& NewValue) { PricePoints_Optional = NewValue; PricePoints_IsSet = true;  }
