...
struct RALLYHEREAPI_API FRHAPI_SearchGuideResponse : public FRHAPI_Model
{
	...
	*/
	...
	TArray<FRHAPI_GuideSearchResult>& GetResults() { return Results_Optional; }
	/** @brief Gets the value of Results_Optional, regardless of it having been set */
	const TArray<FRHAPI_GuideSearchResult>& GetResults() const { return Results_Optional; }
	/** @brief Gets the value of Results_Optional, if it has been set, otherwise it returns DefaultValue */
	const TArray<FRHAPI_GuideSearchResult>& GetResults(const TArray<FRHAPI_GuideSearchResult>& DefaultValue) const { if (Results_IsSet) return Results_Optional; return DefaultValue; }
	/** @brief Fills OutValue with the value of Results_Optional and returns true if it has been set, otherwise returns false */
	bool GetResults(TArray<FRHAPI_GuideSearchResult>& OutValue) const { if (Results_IsSet) OutValue = Results_Optional; return Results_IsSet; }
	/** @brief Returns a pointer to Results_Optional, if it has been set, otherwise returns nullptr */
	TArray<FRHAPI_GuideSearchResult>* GetResultsOrNull() { if (Results_IsSet) return (&Results_Optional); return nullptr; }
	/** @brief Returns a pointer to Results_Optional, if it has been set, otherwise returns nullptr */
	const TArray<FRHAPI_GuideSearchResult>* GetResultsOrNull() const { if (Results_IsSet) return (&Results_Optional); return nullptr; }
	/** @brief Sets the value of Results_Optional and also sets Results_IsSet to true */
	void SetResults(const TArray<FRHAPI_GuideSearchResult>& NewValue) { Results_Optional = NewValue; Results_IsSet = true;  }
	/** @brief Sets the value of Results_Optional and also sets Results_IsSet to true using move semantics */
	void SetResults(TArray<FRHAPI_GuideSearchResult>&& NewValue) { Results_Optional = NewValue; Results_IsSet = true;  }
