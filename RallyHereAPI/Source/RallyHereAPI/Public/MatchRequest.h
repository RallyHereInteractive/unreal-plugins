...
struct RALLYHEREAPI_API FRHAPI_MatchRequest : public FRHAPI_Model
{
	...
	*/
	...
	FORCEINLINE TArray<FRHAPI_MatchPlayerRequest>& GetPlayers() { return Players_Optional; }
	/** @brief Gets the value of Players_Optional, regardless of it having been set */
	FORCEINLINE const TArray<FRHAPI_MatchPlayerRequest>& GetPlayers() const { return Players_Optional; }
	/** @brief Gets the value of Players_Optional, if it has been set, otherwise it returns DefaultValue */
	FORCEINLINE const TArray<FRHAPI_MatchPlayerRequest>& GetPlayers(const TArray<FRHAPI_MatchPlayerRequest>& DefaultValue) const { if (Players_IsSet) return Players_Optional; return DefaultValue; }
	/** @brief Fills OutValue with the value of Players_Optional and returns true if it has been set, otherwise returns false */
	FORCEINLINE bool GetPlayers(TArray<FRHAPI_MatchPlayerRequest>& OutValue) const { if (Players_IsSet) OutValue = Players_Optional; return Players_IsSet; }
	/** @brief Returns a pointer to Players_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE TArray<FRHAPI_MatchPlayerRequest>* GetPlayersOrNull() { if (Players_IsSet) return (&Players_Optional); return nullptr; }
	/** @brief Returns a pointer to Players_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE const TArray<FRHAPI_MatchPlayerRequest>* GetPlayersOrNull() const { if (Players_IsSet) return (&Players_Optional); return nullptr; }
	/** @brief Sets the value of Players_Optional and also sets Players_IsSet to true */
	FORCEINLINE void SetPlayers(const TArray<FRHAPI_MatchPlayerRequest>& NewValue) { Players_Optional = NewValue; Players_IsSet = true;  }
	/** @brief Sets the value of Players_Optional and also sets Players_IsSet to true using move semantics */
	FORCEINLINE void SetPlayers(TArray<FRHAPI_MatchPlayerRequest>&& NewValue) { Players_Optional = NewValue; Players_IsSet = true;  }
	...
	FORCEINLINE TArray<FRHAPI_MatchSegmentRequest>& GetSegments() { return Segments_Optional; }
	/** @brief Gets the value of Segments_Optional, regardless of it having been set */
	FORCEINLINE const TArray<FRHAPI_MatchSegmentRequest>& GetSegments() const { return Segments_Optional; }
	/** @brief Gets the value of Segments_Optional, if it has been set, otherwise it returns DefaultValue */
	FORCEINLINE const TArray<FRHAPI_MatchSegmentRequest>& GetSegments(const TArray<FRHAPI_MatchSegmentRequest>& DefaultValue) const { if (Segments_IsSet) return Segments_Optional; return DefaultValue; }
	/** @brief Fills OutValue with the value of Segments_Optional and returns true if it has been set, otherwise returns false */
	FORCEINLINE bool GetSegments(TArray<FRHAPI_MatchSegmentRequest>& OutValue) const { if (Segments_IsSet) OutValue = Segments_Optional; return Segments_IsSet; }
	/** @brief Returns a pointer to Segments_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE TArray<FRHAPI_MatchSegmentRequest>* GetSegmentsOrNull() { if (Segments_IsSet) return (&Segments_Optional); return nullptr; }
	/** @brief Returns a pointer to Segments_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE const TArray<FRHAPI_MatchSegmentRequest>* GetSegmentsOrNull() const { if (Segments_IsSet) return (&Segments_Optional); return nullptr; }
	/** @brief Sets the value of Segments_Optional and also sets Segments_IsSet to true */
	FORCEINLINE void SetSegments(const TArray<FRHAPI_MatchSegmentRequest>& NewValue) { Segments_Optional = NewValue; Segments_IsSet = true;  }
	/** @brief Sets the value of Segments_Optional and also sets Segments_IsSet to true using move semantics */
	FORCEINLINE void SetSegments(TArray<FRHAPI_MatchSegmentRequest>&& NewValue) { Segments_Optional = NewValue; Segments_IsSet = true;  }
