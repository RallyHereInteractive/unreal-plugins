...
struct RALLYHEREAPI_API FRHAPI_PlayerOrderEntry : public FRHAPI_Model
{
	...
	*/
	...
	FORCEINLINE FString& GetEntryId() { return EntryId; }
	/** @brief Gets the value of EntryId */
	FORCEINLINE const FString& GetEntryId() const { return EntryId; }
	/** @brief Sets the value of EntryId */
	FORCEINLINE void SetEntryId(const FString& NewValue) { EntryId = NewValue;   }
	/** @brief Sets the value of EntryId using move semantics */
	FORCEINLINE void SetEntryId(FString&& NewValue) { EntryId = NewValue;   }
	...
	FORCEINLINE ERHAPI_PlayerOrderEntryResult& GetResult() { return Result_Optional; }
	/** @brief Gets the value of Result_Optional, regardless of it having been set */
	FORCEINLINE const ERHAPI_PlayerOrderEntryResult& GetResult() const { return Result_Optional; }
	/** @brief Gets the value of Result_Optional, if it has been set, otherwise it returns DefaultValue */
	FORCEINLINE const ERHAPI_PlayerOrderEntryResult& GetResult(const ERHAPI_PlayerOrderEntryResult& DefaultValue) const { if (Result_IsSet) return Result_Optional; return DefaultValue; }
	/** @brief Fills OutValue with the value of Result_Optional and returns true if it has been set, otherwise returns false */
	FORCEINLINE bool GetResult(ERHAPI_PlayerOrderEntryResult& OutValue) const { if (Result_IsSet) OutValue = Result_Optional; return Result_IsSet; }
	/** @brief Returns a pointer to Result_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE ERHAPI_PlayerOrderEntryResult* GetResultOrNull() { if (Result_IsSet) return (&Result_Optional); return nullptr; }
	/** @brief Returns a pointer to Result_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE const ERHAPI_PlayerOrderEntryResult* GetResultOrNull() const { if (Result_IsSet) return (&Result_Optional); return nullptr; }
	/** @brief Sets the value of Result_Optional and also sets Result_IsSet to true */
	FORCEINLINE void SetResult(const ERHAPI_PlayerOrderEntryResult& NewValue) { Result_Optional = NewValue; Result_IsSet = true;  }
	/** @brief Sets the value of Result_Optional and also sets Result_IsSet to true using move semantics */
	FORCEINLINE void SetResult(ERHAPI_PlayerOrderEntryResult&& NewValue) { Result_Optional = NewValue; Result_IsSet = true;  }
	...
	FORCEINLINE TArray<FRHAPI_PlayerOrderDetail>& GetDetails() { return Details_Optional; }
	/** @brief Gets the value of Details_Optional, regardless of it having been set */
	FORCEINLINE const TArray<FRHAPI_PlayerOrderDetail>& GetDetails() const { return Details_Optional; }
	/** @brief Gets the value of Details_Optional, if it has been set, otherwise it returns DefaultValue */
	FORCEINLINE const TArray<FRHAPI_PlayerOrderDetail>& GetDetails(const TArray<FRHAPI_PlayerOrderDetail>& DefaultValue) const { if (Details_IsSet) return Details_Optional; return DefaultValue; }
	/** @brief Fills OutValue with the value of Details_Optional and returns true if it has been set, otherwise returns false */
	FORCEINLINE bool GetDetails(TArray<FRHAPI_PlayerOrderDetail>& OutValue) const { if (Details_IsSet) OutValue = Details_Optional; return Details_IsSet; }
	/** @brief Returns a pointer to Details_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE TArray<FRHAPI_PlayerOrderDetail>* GetDetailsOrNull() { if (Details_IsSet) return (&Details_Optional); return nullptr; }
	/** @brief Returns a pointer to Details_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE const TArray<FRHAPI_PlayerOrderDetail>* GetDetailsOrNull() const { if (Details_IsSet) return (&Details_Optional); return nullptr; }
	/** @brief Sets the value of Details_Optional and also sets Details_IsSet to true */
	FORCEINLINE void SetDetails(const TArray<FRHAPI_PlayerOrderDetail>& NewValue) { Details_Optional = NewValue; Details_IsSet = true;  }
	/** @brief Sets the value of Details_Optional and also sets Details_IsSet to true using move semantics */
	FORCEINLINE void SetDetails(TArray<FRHAPI_PlayerOrderDetail>&& NewValue) { Details_Optional = NewValue; Details_IsSet = true;  }
