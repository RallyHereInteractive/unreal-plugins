...
#include "Stage.h"
#include "StageSearchResults.generated.h"

/** @defgroup RHAPI_StageSearchResults RallyHere API Model StageSearchResults
 *  @{
 */
...
struct RALLYHEREAPI_API FRHAPI_StageSearchResults : public FRHAPI_Model
{
	GENERATED_BODY()
	...
	*/
	...
	TArray<FRHAPI_Stage> Stages{  };
	/** @brief Gets the value of Stages */
	FORCEINLINE TArray<FRHAPI_Stage>& GetStages() { return Stages; }
	/** @brief Gets the value of Stages */
	FORCEINLINE const TArray<FRHAPI_Stage>& GetStages() const { return Stages; }
	/** @brief Sets the value of Stages */
	FORCEINLINE void SetStages(const TArray<FRHAPI_Stage>& NewValue) { Stages = NewValue;   }
	/** @brief Sets the value of Stages using move semantics */
	FORCEINLINE void SetStages(TArray<FRHAPI_Stage>&& NewValue) { Stages = NewValue;   }
