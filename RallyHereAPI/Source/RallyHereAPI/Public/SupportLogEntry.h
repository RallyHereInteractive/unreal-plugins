...
struct RALLYHEREAPI_API FRHAPI_SupportLogEntry : public FRHAPI_Model
{
	...
	*/
	...
	FORCEINLINE FString& GetSupportActionLogId() { return SupportActionLogId; }
	/** @brief Gets the value of SupportActionLogId */
	FORCEINLINE const FString& GetSupportActionLogId() const { return SupportActionLogId; }
	/** @brief Sets the value of SupportActionLogId */
	FORCEINLINE void SetSupportActionLogId(const FString& NewValue) { SupportActionLogId = NewValue;   }
	/** @brief Sets the value of SupportActionLogId using move semantics */
	FORCEINLINE void SetSupportActionLogId(FString&& NewValue) { SupportActionLogId = NewValue;   }
