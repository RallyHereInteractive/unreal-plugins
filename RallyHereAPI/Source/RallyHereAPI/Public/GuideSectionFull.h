...
#include "GuideSectionFull.generated.h"

/** @defgroup RHAPI_GuideSectionFull RallyHere API Model GuideSectionFull
 *  @{
 */
...
struct RALLYHEREAPI_API FRHAPI_GuideSectionFull : public FRHAPI_Model
{
	GENERATED_BODY()
