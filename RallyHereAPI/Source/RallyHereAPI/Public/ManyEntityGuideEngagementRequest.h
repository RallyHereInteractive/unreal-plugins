...
#include "ManyEntityGuideEngagementRequest.generated.h"

/** @defgroup RHAPI_ManyEntityGuideEngagementRequest RallyHere API Model ManyEntityGuideEngagementRequest
 *  @{
 */
...
struct RALLYHEREAPI_API FRHAPI_ManyEntityGuideEngagementRequest : public FRHAPI_Model
{
	GENERATED_BODY()
	...
	*/
	...
	TArray<FGuid> Guides_Optional{  };
	/** @brief true if Guides_Optional has been set to a value */
	UPROPERTY(BlueprintReadWrite, Category = "RallyHere")
