...
struct RALLYHEREAPI_API FRHAPI_PexClientQueryParams : public FRHAPI_Model
{
	...
	*/
	...
	bool GetPlayerUuid(FString& OutValue) const { if (PlayerUuid_IsSet) OutValue = PlayerUuid_Optional; return PlayerUuid_IsSet; }
	/** @brief Returns a pointer to PlayerUuid_Optional, if it has been set, otherwise returns nullptr */
	FString* GetPlayerUuidOrNull() { if (PlayerUuid_IsSet) return &PlayerUuid_Optional; return nullptr; }
	/** @brief Returns a pointer to PlayerUuid_Optional, if it has been set, otherwise returns nullptr */
	const FString* GetPlayerUuidOrNull() const { if (PlayerUuid_IsSet) return &PlayerUuid_Optional; return nullptr; }
	/** @brief Sets the value of PlayerUuid_Optional and also sets PlayerUuid_IsSet to true */
	void SetPlayerUuid(const FString& NewValue) { PlayerUuid_Optional = NewValue; PlayerUuid_IsSet = true; }
	/** @brief Sets the value of PlayerUuid_Optional and also sets PlayerUuid_IsSet to true using move semantics */
	void SetPlayerUuid(FString&& NewValue) { PlayerUuid_Optional = NewValue; PlayerUuid_IsSet = true; }
