...
struct RALLYHEREAPI_API FRHAPI_CreateInventoryRequests : public FRHAPI_Model
{
	...
	*/
	...
	FORCEINLINE TArray<FRHAPI_CreateInventoryRequest>& GetInventory() { return Inventory; }
	/** @brief Gets the value of Inventory */
	FORCEINLINE const TArray<FRHAPI_CreateInventoryRequest>& GetInventory() const { return Inventory; }
	/** @brief Sets the value of Inventory */
	FORCEINLINE void SetInventory(const TArray<FRHAPI_CreateInventoryRequest>& NewValue) { Inventory = NewValue;   }
	/** @brief Sets the value of Inventory using move semantics */
	FORCEINLINE void SetInventory(TArray<FRHAPI_CreateInventoryRequest>&& NewValue) { Inventory = NewValue;   }
};
