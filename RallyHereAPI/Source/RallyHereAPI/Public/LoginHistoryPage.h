...
struct RALLYHEREAPI_API FRHAPI_LoginHistoryPage : public FRHAPI_Model
{
	...
	*/
	...
	FORCEINLINE TArray<FRHAPI_LoginHistoryEntry>& GetEntries() { return Entries; }
	/** @brief Gets the value of Entries */
	FORCEINLINE const TArray<FRHAPI_LoginHistoryEntry>& GetEntries() const { return Entries; }
	/** @brief Sets the value of Entries */
	FORCEINLINE void SetEntries(const TArray<FRHAPI_LoginHistoryEntry>& NewValue) { Entries = NewValue;   }
	/** @brief Sets the value of Entries using move semantics */
	FORCEINLINE void SetEntries(TArray<FRHAPI_LoginHistoryEntry>&& NewValue) { Entries = NewValue;   }
