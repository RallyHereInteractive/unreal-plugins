...
struct RALLYHEREAPI_API FRHAPI_GuideCreateRequest : public FRHAPI_Model
{
	...
	*/
	...
	TArray<FRHAPI_GuideSectionCreate>& GetSections() { return Sections_Optional; }
	/** @brief Gets the value of Sections_Optional, regardless of it having been set */
	const TArray<FRHAPI_GuideSectionCreate>& GetSections() const { return Sections_Optional; }
	/** @brief Gets the value of Sections_Optional, if it has been set, otherwise it returns DefaultValue */
	const TArray<FRHAPI_GuideSectionCreate>& GetSections(const TArray<FRHAPI_GuideSectionCreate>& DefaultValue) const { if (Sections_IsSet) return Sections_Optional; return DefaultValue; }
	/** @brief Fills OutValue with the value of Sections_Optional and returns true if it has been set, otherwise returns false */
	bool GetSections(TArray<FRHAPI_GuideSectionCreate>& OutValue) const { if (Sections_IsSet) OutValue = Sections_Optional; return Sections_IsSet; }
	/** @brief Returns a pointer to Sections_Optional, if it has been set, otherwise returns nullptr */
	TArray<FRHAPI_GuideSectionCreate>* GetSectionsOrNull() { if (Sections_IsSet) return (&Sections_Optional); return nullptr; }
	/** @brief Returns a pointer to Sections_Optional, if it has been set, otherwise returns nullptr */
	const TArray<FRHAPI_GuideSectionCreate>* GetSectionsOrNull() const { if (Sections_IsSet) return (&Sections_Optional); return nullptr; }
	/** @brief Sets the value of Sections_Optional and also sets Sections_IsSet to true */
	void SetSections(const TArray<FRHAPI_GuideSectionCreate>& NewValue) { Sections_Optional = NewValue; Sections_IsSet = true;  }
	/** @brief Sets the value of Sections_Optional and also sets Sections_IsSet to true using move semantics */
	void SetSections(TArray<FRHAPI_GuideSectionCreate>&& NewValue) { Sections_Optional = NewValue; Sections_IsSet = true;  }
