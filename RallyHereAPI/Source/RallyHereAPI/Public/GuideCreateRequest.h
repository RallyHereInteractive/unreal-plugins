...
/** @defgroup RHAPI_GuideCreateRequest RallyHere API Model GuideCreateRequest
 *  @{
 */
...
struct RALLYHEREAPI_API FRHAPI_GuideCreateRequest : public FRHAPI_Model
{
	GENERATED_BODY()
	...
	*/
	...
	FORCEINLINE ERHAPI_GuideEntityType& GetOwnerEntityType() { return OwnerEntityType_Optional; }
	/** @brief Gets the value of OwnerEntityType_Optional, regardless of it having been set */
	FORCEINLINE const ERHAPI_GuideEntityType& GetOwnerEntityType() const { return OwnerEntityType_Optional; }
	/** @brief Gets the value of OwnerEntityType_Optional, if it has been set, otherwise it returns DefaultValue */
	FORCEINLINE const ERHAPI_GuideEntityType& GetOwnerEntityType(const ERHAPI_GuideEntityType& DefaultValue) const { if (OwnerEntityType_IsSet) return OwnerEntityType_Optional; return DefaultValue; }
	...
	FORCEINLINE bool GetOwnerEntityType(ERHAPI_GuideEntityType& OutValue) const { if (OwnerEntityType_IsSet && !OwnerEntityType_IsNull) OutValue = OwnerEntityType_Optional; return OwnerEntityType_IsSet; }
	/** @brief Returns a pointer to OwnerEntityType_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE ERHAPI_GuideEntityType* GetOwnerEntityTypeOrNull() { if (OwnerEntityType_IsSet) return (OwnerEntityType_IsNull ? nullptr : &OwnerEntityType_Optional); return nullptr; }
	/** @brief Returns a pointer to OwnerEntityType_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE const ERHAPI_GuideEntityType* GetOwnerEntityTypeOrNull() const { if (OwnerEntityType_IsSet) return (OwnerEntityType_IsNull ? nullptr : &OwnerEntityType_Optional); return nullptr; }
	/** @brief Sets the value of OwnerEntityType_Optional and also sets OwnerEntityType_IsSet to true */
	FORCEINLINE void SetOwnerEntityType(const ERHAPI_GuideEntityType& NewValue) { OwnerEntityType_Optional = NewValue; OwnerEntityType_IsSet = true; OwnerEntityType_IsNull = false; }
	/** @brief Sets the value of OwnerEntityType_Optional and also sets OwnerEntityType_IsSet to true using move semantics */
	FORCEINLINE void SetOwnerEntityType(ERHAPI_GuideEntityType&& NewValue) { OwnerEntityType_Optional = NewValue; OwnerEntityType_IsSet = true; OwnerEntityType_IsNull = false; }
	...
	UPROPERTY(BlueprintReadWrite, Category = "RallyHere")
	TArray<FRHAPI_GuideSectionCreate> Sections_Optional{  };
	...
	FORCEINLINE TArray<FRHAPI_GuideSectionCreate>& GetSections() { return Sections_Optional; }
	/** @brief Gets the value of Sections_Optional, regardless of it having been set */
	FORCEINLINE const TArray<FRHAPI_GuideSectionCreate>& GetSections() const { return Sections_Optional; }
	/** @brief Gets the value of Sections_Optional, if it has been set, otherwise it returns DefaultValue */
	FORCEINLINE const TArray<FRHAPI_GuideSectionCreate>& GetSections(const TArray<FRHAPI_GuideSectionCreate>& DefaultValue) const { if (Sections_IsSet) return Sections_Optional; return DefaultValue; }
	/** @brief Fills OutValue with the value of Sections_Optional and returns true if it has been set, otherwise returns false */
	FORCEINLINE bool GetSections(TArray<FRHAPI_GuideSectionCreate>& OutValue) const { if (Sections_IsSet) OutValue = Sections_Optional; return Sections_IsSet; }
	/** @brief Returns a pointer to Sections_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE TArray<FRHAPI_GuideSectionCreate>* GetSectionsOrNull() { if (Sections_IsSet) return (&Sections_Optional); return nullptr; }
	/** @brief Returns a pointer to Sections_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE const TArray<FRHAPI_GuideSectionCreate>* GetSectionsOrNull() const { if (Sections_IsSet) return (&Sections_Optional); return nullptr; }
	/** @brief Sets the value of Sections_Optional and also sets Sections_IsSet to true */
	FORCEINLINE void SetSections(const TArray<FRHAPI_GuideSectionCreate>& NewValue) { Sections_Optional = NewValue; Sections_IsSet = true;  }
	/** @brief Sets the value of Sections_Optional and also sets Sections_IsSet to true using move semantics */
	FORCEINLINE void SetSections(TArray<FRHAPI_GuideSectionCreate>&& NewValue) { Sections_Optional = NewValue; Sections_IsSet = true;  }
