...
#include "PexClientScores.generated.h"

/** @defgroup RHAPI_PexClientScores RallyHere API Model PexClientScores
 *  @{
 */
...
struct RALLYHEREAPI_API FRHAPI_PexClientScores : public FRHAPI_Model
{
	GENERATED_BODY()
