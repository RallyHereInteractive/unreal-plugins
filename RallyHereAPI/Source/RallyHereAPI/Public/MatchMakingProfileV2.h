...
struct RALLYHEREAPI_API FRHAPI_MatchMakingProfileV2 : public FRHAPI_Model
{
	...
	*/
	...
	void SetNumSidesToDefault() { SetNumSides(0); }
	...
	void SetMaxPlayersPerSideToDefault() { SetMaxPlayersPerSide(0); }
	...
	void SetMinPlayersPerSideToDefault() { SetMinPlayersPerSide(0); }
	...
	/** @brief Gets the value of LegacyConfig_Optional, regardless of it having been set */
	const FRHAPI_JsonObject& GetLegacyConfig() const { return LegacyConfig_Optional; }
	/** @brief Gets the value of LegacyConfig_Optional, if it has been set, otherwise it returns DefaultValue */
	const FRHAPI_JsonObject& GetLegacyConfig(const FRHAPI_JsonObject& DefaultValue) const { if (LegacyConfig_IsSet) return LegacyConfig_Optional; return DefaultValue; }
	/** @brief Fills OutValue with the value of LegacyConfig_Optional and returns true if it has been set, otherwise returns false */
	bool GetLegacyConfig(FRHAPI_JsonObject& OutValue) const { if (LegacyConfig_IsSet) OutValue = LegacyConfig_Optional; return LegacyConfig_IsSet; }
	/** @brief Returns a pointer to LegacyConfig_Optional, if it has been set, otherwise returns nullptr */
	FRHAPI_JsonObject* GetLegacyConfigOrNull() { if (LegacyConfig_IsSet) return (&LegacyConfig_Optional); return nullptr; }
	/** @brief Returns a pointer to LegacyConfig_Optional, if it has been set, otherwise returns nullptr */
	const FRHAPI_JsonObject* GetLegacyConfigOrNull() const { if (LegacyConfig_IsSet) return (&LegacyConfig_Optional); return nullptr; }
	/** @brief Sets the value of LegacyConfig_Optional and also sets LegacyConfig_IsSet to true */
	void SetLegacyConfig(const FRHAPI_JsonObject& NewValue) { LegacyConfig_Optional = NewValue; LegacyConfig_IsSet = true;  }
	...
	/** @brief Checks whether SessionTemplateId_Optional has been set */
	bool IsSessionTemplateIdSet() const { return SessionTemplateId_IsSet; }
};
