...
#include "PlayerRequest.generated.h"

/** @defgroup RHAPI_PlayerRequest RallyHere API Model PlayerRequest
 *  @{
 */
...
struct RALLYHEREAPI_API FRHAPI_PlayerRequest : public FRHAPI_Model
{
    GENERATED_BODY()
