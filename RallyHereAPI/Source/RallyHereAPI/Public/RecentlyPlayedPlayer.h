...
#include "RecentlyPlayedPlayer.generated.h"

/** @defgroup RHAPI_RecentlyPlayedPlayer RallyHere API Model RecentlyPlayedPlayer
 *  @{
 */

/**
 * @brief Player that was recently played with
 */
USTRUCT(BlueprintType)
struct RALLYHEREAPI_API FRHAPI_RecentlyPlayedPlayer : public FRHAPI_Model
{
	GENERATED_BODY()
