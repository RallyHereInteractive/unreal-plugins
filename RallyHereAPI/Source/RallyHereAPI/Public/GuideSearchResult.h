...
#include "GuideSearchResult.generated.h"

/** @defgroup RHAPI_GuideSearchResult RallyHere API Model GuideSearchResult
 *  @{
 */
...
struct RALLYHEREAPI_API FRHAPI_GuideSearchResult : public FRHAPI_Model
{
	GENERATED_BODY()
