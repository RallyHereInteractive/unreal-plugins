...
struct RALLYHEREAPI_API FRHAPI_PexHostScores : public FRHAPI_Model
{
	...
	*/
	...
	UPROPERTY(BlueprintReadWrite, Category = "RallyHere")
	bool TotalUniquePlayersScore_Optional{  };
	...
	bool GetTotalUniquePlayersScore(bool& OutValue) const { if (TotalUniquePlayersScore_IsSet) OutValue = TotalUniquePlayersScore_Optional; return TotalUniquePlayersScore_IsSet; }
	/** @brief Returns a pointer to TotalUniquePlayersScore_Optional, if it has been set, otherwise returns nullptr */
	bool* GetTotalUniquePlayersScoreOrNull() { if (TotalUniquePlayersScore_IsSet) return &TotalUniquePlayersScore_Optional; return nullptr; }
	/** @brief Returns a pointer to TotalUniquePlayersScore_Optional, if it has been set, otherwise returns nullptr */
	const bool* GetTotalUniquePlayersScoreOrNull() const { if (TotalUniquePlayersScore_IsSet) return &TotalUniquePlayersScore_Optional; return nullptr; }
	/** @brief Sets the value of TotalUniquePlayersScore_Optional and also sets TotalUniquePlayersScore_IsSet to true */
	void SetTotalUniquePlayersScore(const bool& NewValue) { TotalUniquePlayersScore_Optional = NewValue; TotalUniquePlayersScore_IsSet = true; }
	...
	void SetTotalUniquePlayersScore(bool&& NewValue) { TotalUniquePlayersScore_Optional = NewValue; TotalUniquePlayersScore_IsSet = true; }
	 /** @brief Clears the value of TotalUniquePlayersScore_Optional and sets TotalUniquePlayersScore_IsSet to false */
	void ClearTotalUniquePlayersScore() { TotalUniquePlayersScore_Optional = false; TotalUniquePlayersScore_IsSet = false; }
	...
	void SetTotalUniquePlayersScoreToDefault() { TotalUniquePlayersScore_Optional = false; TotalUniquePlayersScore_IsSet = true; }
};
