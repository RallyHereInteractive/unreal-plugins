...
/** @defgroup RHAPI_StageCreate RallyHere API Model StageCreate
 *  @{
 */

/**
 * @brief Fields to create a stage with.  NOTE: the fields shared between this and the StageMatchmakeParams are used to determine which     matchmaking pool this stage will be placed into
 */
USTRUCT(BlueprintType)
struct RALLYHEREAPI_API FRHAPI_StageCreate : public FRHAPI_Model
{
	GENERATED_BODY()
