...
#include "GuideSectionCreate.generated.h"

/** @defgroup RHAPI_GuideSectionCreate RallyHere API Model GuideSectionCreate
 *  @{
 */
...
struct RALLYHEREAPI_API FRHAPI_GuideSectionCreate : public FRHAPI_Model
{
	GENERATED_BODY()
