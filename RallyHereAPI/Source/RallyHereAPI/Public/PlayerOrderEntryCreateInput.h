...
#include "PlayerOrderEntryCreateInput.generated.h"

/** @defgroup RHAPI_PlayerOrderEntryCreateInput RallyHere API Model PlayerOrderEntryCreateInput
 *  @{
 */
...
struct RALLYHEREAPI_API FRHAPI_PlayerOrderEntryCreateInput : public FRHAPI_Model
{
	GENERATED_BODY()
