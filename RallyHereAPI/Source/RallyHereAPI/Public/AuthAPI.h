...
struct RALLYHEREAPI_API FResponse_Login : public FResponseAccessorTemplate<FRHAPI_LoginResult, FRHAPI_LoginCompleteMessage, FRHAPI_HTTPValidationError, FRHAPI_HzApiErrorModel>
{
	typedef FResponseAccessorTemplate<FRHAPI_LoginResult, FRHAPI_LoginCompleteMessage, FRHAPI_HTTPValidationError, FRHAPI_HzApiErrorModel> Super;
	...
	*/
	bool TryGetContentFor403(FRHAPI_LoginCompleteMessage& OutContent) const;
