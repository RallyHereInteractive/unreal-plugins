...
struct RALLYHEREAPI_API FRHAPI_PlatformUserLinkRequest : public FRHAPI_Model
{
	...
	*/
	...
	FORCEINLINE FGuid& GetLeaderPersonId() { return LeaderPersonId_Optional; }
	/** @brief Gets the value of LeaderPersonId_Optional, regardless of it having been set */
	FORCEINLINE const FGuid& GetLeaderPersonId() const { return LeaderPersonId_Optional; }
	/** @brief Gets the value of LeaderPersonId_Optional, if it has been set, otherwise it returns DefaultValue */
	FORCEINLINE const FGuid& GetLeaderPersonId(const FGuid& DefaultValue) const { if (LeaderPersonId_IsSet) return LeaderPersonId_Optional; return DefaultValue; }
	...
	FORCEINLINE bool GetLeaderPersonId(FGuid& OutValue) const { if (LeaderPersonId_IsSet) OutValue = LeaderPersonId_Optional; return LeaderPersonId_IsSet; }
	/** @brief Returns a pointer to LeaderPersonId_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE FGuid* GetLeaderPersonIdOrNull() { if (LeaderPersonId_IsSet) return (&LeaderPersonId_Optional); return nullptr; }
	/** @brief Returns a pointer to LeaderPersonId_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE const FGuid* GetLeaderPersonIdOrNull() const { if (LeaderPersonId_IsSet) return (&LeaderPersonId_Optional); return nullptr; }
	/** @brief Sets the value of LeaderPersonId_Optional and also sets LeaderPersonId_IsSet to true */
	FORCEINLINE void SetLeaderPersonId(const FGuid& NewValue) { LeaderPersonId_Optional = NewValue; LeaderPersonId_IsSet = true;  }
	/** @brief Sets the value of LeaderPersonId_Optional and also sets LeaderPersonId_IsSet to true using move semantics */
	FORCEINLINE void SetLeaderPersonId(FGuid&& NewValue) { LeaderPersonId_Optional = NewValue; LeaderPersonId_IsSet = true;  }
	...
	FORCEINLINE ERHAPI_Platform& GetLeaderPlatform() { return LeaderPlatform_Optional; }
	/** @brief Gets the value of LeaderPlatform_Optional, regardless of it having been set */
	FORCEINLINE const ERHAPI_Platform& GetLeaderPlatform() const { return LeaderPlatform_Optional; }
	/** @brief Gets the value of LeaderPlatform_Optional, if it has been set, otherwise it returns DefaultValue */
	FORCEINLINE const ERHAPI_Platform& GetLeaderPlatform(const ERHAPI_Platform& DefaultValue) const { if (LeaderPlatform_IsSet) return LeaderPlatform_Optional; return DefaultValue; }
	...
	FORCEINLINE bool GetLeaderPlatform(ERHAPI_Platform& OutValue) const { if (LeaderPlatform_IsSet) OutValue = LeaderPlatform_Optional; return LeaderPlatform_IsSet; }
	/** @brief Returns a pointer to LeaderPlatform_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE ERHAPI_Platform* GetLeaderPlatformOrNull() { if (LeaderPlatform_IsSet) return (&LeaderPlatform_Optional); return nullptr; }
	/** @brief Returns a pointer to LeaderPlatform_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE const ERHAPI_Platform* GetLeaderPlatformOrNull() const { if (LeaderPlatform_IsSet) return (&LeaderPlatform_Optional); return nullptr; }
	/** @brief Sets the value of LeaderPlatform_Optional and also sets LeaderPlatform_IsSet to true */
	FORCEINLINE void SetLeaderPlatform(const ERHAPI_Platform& NewValue) { LeaderPlatform_Optional = NewValue; LeaderPlatform_IsSet = true;  }
	/** @brief Sets the value of LeaderPlatform_Optional and also sets LeaderPlatform_IsSet to true using move semantics */
	FORCEINLINE void SetLeaderPlatform(ERHAPI_Platform&& NewValue) { LeaderPlatform_Optional = NewValue; LeaderPlatform_IsSet = true;  }
	...
	FORCEINLINE FString& GetLeaderPlatformUserId() { return LeaderPlatformUserId_Optional; }
	/** @brief Gets the value of LeaderPlatformUserId_Optional, regardless of it having been set */
	FORCEINLINE const FString& GetLeaderPlatformUserId() const { return LeaderPlatformUserId_Optional; }
	/** @brief Gets the value of LeaderPlatformUserId_Optional, if it has been set, otherwise it returns DefaultValue */
	FORCEINLINE const FString& GetLeaderPlatformUserId(const FString& DefaultValue) const { if (LeaderPlatformUserId_IsSet) return LeaderPlatformUserId_Optional; return DefaultValue; }
	...
	FORCEINLINE bool GetLeaderPlatformUserId(FString& OutValue) const { if (LeaderPlatformUserId_IsSet) OutValue = LeaderPlatformUserId_Optional; return LeaderPlatformUserId_IsSet; }
	/** @brief Returns a pointer to LeaderPlatformUserId_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE FString* GetLeaderPlatformUserIdOrNull() { if (LeaderPlatformUserId_IsSet) return (&LeaderPlatformUserId_Optional); return nullptr; }
	/** @brief Returns a pointer to LeaderPlatformUserId_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE const FString* GetLeaderPlatformUserIdOrNull() const { if (LeaderPlatformUserId_IsSet) return (&LeaderPlatformUserId_Optional); return nullptr; }
	/** @brief Sets the value of LeaderPlatformUserId_Optional and also sets LeaderPlatformUserId_IsSet to true */
	FORCEINLINE void SetLeaderPlatformUserId(const FString& NewValue) { LeaderPlatformUserId_Optional = NewValue; LeaderPlatformUserId_IsSet = true;  }
	...
	FORCEINLINE void SetLeaderPlatformUserId(FString&& NewValue) { LeaderPlatformUserId_Optional = NewValue; LeaderPlatformUserId_IsSet = true;  }
	...
	FORCEINLINE ERHAPI_Platform& GetFollowerPlatform() { return FollowerPlatform_Optional; }
	/** @brief Gets the value of FollowerPlatform_Optional, regardless of it having been set */
	FORCEINLINE const ERHAPI_Platform& GetFollowerPlatform() const { return FollowerPlatform_Optional; }
	/** @brief Gets the value of FollowerPlatform_Optional, if it has been set, otherwise it returns DefaultValue */
	FORCEINLINE const ERHAPI_Platform& GetFollowerPlatform(const ERHAPI_Platform& DefaultValue) const { if (FollowerPlatform_IsSet) return FollowerPlatform_Optional; return DefaultValue; }
	...
	FORCEINLINE bool GetFollowerPlatform(ERHAPI_Platform& OutValue) const { if (FollowerPlatform_IsSet) OutValue = FollowerPlatform_Optional; return FollowerPlatform_IsSet; }
	/** @brief Returns a pointer to FollowerPlatform_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE ERHAPI_Platform* GetFollowerPlatformOrNull() { if (FollowerPlatform_IsSet) return (&FollowerPlatform_Optional); return nullptr; }
	/** @brief Returns a pointer to FollowerPlatform_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE const ERHAPI_Platform* GetFollowerPlatformOrNull() const { if (FollowerPlatform_IsSet) return (&FollowerPlatform_Optional); return nullptr; }
	/** @brief Sets the value of FollowerPlatform_Optional and also sets FollowerPlatform_IsSet to true */
	FORCEINLINE void SetFollowerPlatform(const ERHAPI_Platform& NewValue) { FollowerPlatform_Optional = NewValue; FollowerPlatform_IsSet = true;  }
	/** @brief Sets the value of FollowerPlatform_Optional and also sets FollowerPlatform_IsSet to true using move semantics */
	FORCEINLINE void SetFollowerPlatform(ERHAPI_Platform&& NewValue) { FollowerPlatform_Optional = NewValue; FollowerPlatform_IsSet = true;  }
	...
	FORCEINLINE FString& GetFollowerPlatformUserId() { return FollowerPlatformUserId_Optional; }
	/** @brief Gets the value of FollowerPlatformUserId_Optional, regardless of it having been set */
	FORCEINLINE const FString& GetFollowerPlatformUserId() const { return FollowerPlatformUserId_Optional; }
	/** @brief Gets the value of FollowerPlatformUserId_Optional, if it has been set, otherwise it returns DefaultValue */
	FORCEINLINE const FString& GetFollowerPlatformUserId(const FString& DefaultValue) const { if (FollowerPlatformUserId_IsSet) return FollowerPlatformUserId_Optional; return DefaultValue; }
	...
	FORCEINLINE bool GetFollowerPlatformUserId(FString& OutValue) const { if (FollowerPlatformUserId_IsSet) OutValue = FollowerPlatformUserId_Optional; return FollowerPlatformUserId_IsSet; }
	/** @brief Returns a pointer to FollowerPlatformUserId_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE FString* GetFollowerPlatformUserIdOrNull() { if (FollowerPlatformUserId_IsSet) return (&FollowerPlatformUserId_Optional); return nullptr; }
	/** @brief Returns a pointer to FollowerPlatformUserId_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE const FString* GetFollowerPlatformUserIdOrNull() const { if (FollowerPlatformUserId_IsSet) return (&FollowerPlatformUserId_Optional); return nullptr; }
	/** @brief Sets the value of FollowerPlatformUserId_Optional and also sets FollowerPlatformUserId_IsSet to true */
	FORCEINLINE void SetFollowerPlatformUserId(const FString& NewValue) { FollowerPlatformUserId_Optional = NewValue; FollowerPlatformUserId_IsSet = true;  }
	...
	FORCEINLINE void SetFollowerPlatformUserId(FString&& NewValue) { FollowerPlatformUserId_Optional = NewValue; FollowerPlatformUserId_IsSet = true;  }
	...
	FORCEINLINE FString& GetScheme() { return Scheme_Optional; }
	/** @brief Gets the value of Scheme_Optional, regardless of it having been set */
	FORCEINLINE const FString& GetScheme() const { return Scheme_Optional; }
	/** @brief Gets the value of Scheme_Optional, if it has been set, otherwise it returns DefaultValue */
	FORCEINLINE const FString& GetScheme(const FString& DefaultValue) const { if (Scheme_IsSet) return Scheme_Optional; return DefaultValue; }
	/** @brief Fills OutValue with the value of Scheme_Optional and returns true if it has been set, otherwise returns false */
	FORCEINLINE bool GetScheme(FString& OutValue) const { if (Scheme_IsSet) OutValue = Scheme_Optional; return Scheme_IsSet; }
	/** @brief Returns a pointer to Scheme_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE FString* GetSchemeOrNull() { if (Scheme_IsSet) return (&Scheme_Optional); return nullptr; }
	/** @brief Returns a pointer to Scheme_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE const FString* GetSchemeOrNull() const { if (Scheme_IsSet) return (&Scheme_Optional); return nullptr; }
	/** @brief Sets the value of Scheme_Optional and also sets Scheme_IsSet to true */
	FORCEINLINE void SetScheme(const FString& NewValue) { Scheme_Optional = NewValue; Scheme_IsSet = true;  }
	/** @brief Sets the value of Scheme_Optional and also sets Scheme_IsSet to true using move semantics */
	FORCEINLINE void SetScheme(FString&& NewValue) { Scheme_Optional = NewValue; Scheme_IsSet = true;  }
	...
	FORCEINLINE FString& GetCredentials() { return Credentials_Optional; }
	/** @brief Gets the value of Credentials_Optional, regardless of it having been set */
	FORCEINLINE const FString& GetCredentials() const { return Credentials_Optional; }
	/** @brief Gets the value of Credentials_Optional, if it has been set, otherwise it returns DefaultValue */
	FORCEINLINE const FString& GetCredentials(const FString& DefaultValue) const { if (Credentials_IsSet) return Credentials_Optional; return DefaultValue; }
	/** @brief Fills OutValue with the value of Credentials_Optional and returns true if it has been set, otherwise returns false */
	FORCEINLINE bool GetCredentials(FString& OutValue) const { if (Credentials_IsSet) OutValue = Credentials_Optional; return Credentials_IsSet; }
	/** @brief Returns a pointer to Credentials_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE FString* GetCredentialsOrNull() { if (Credentials_IsSet) return (&Credentials_Optional); return nullptr; }
	/** @brief Returns a pointer to Credentials_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE const FString* GetCredentialsOrNull() const { if (Credentials_IsSet) return (&Credentials_Optional); return nullptr; }
	/** @brief Sets the value of Credentials_Optional and also sets Credentials_IsSet to true */
	FORCEINLINE void SetCredentials(const FString& NewValue) { Credentials_Optional = NewValue; Credentials_IsSet = true;  }
	/** @brief Sets the value of Credentials_Optional and also sets Credentials_IsSet to true using move semantics */
	FORCEINLINE void SetCredentials(FString&& NewValue) { Credentials_Optional = NewValue; Credentials_IsSet = true;  }
