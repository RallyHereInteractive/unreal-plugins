...
struct RALLYHEREAPI_API FRHAPI_PlayerSessions : public FRHAPI_Model
{
	...
	*/
	...
	FORCEINLINE TMap<FString, FRHAPI_PlayerSession>& GetSessions() { return Sessions_Optional; }
	/** @brief Gets the value of Sessions_Optional, regardless of it having been set */
	FORCEINLINE const TMap<FString, FRHAPI_PlayerSession>& GetSessions() const { return Sessions_Optional; }
	/** @brief Gets the value of Sessions_Optional, if it has been set, otherwise it returns DefaultValue */
	FORCEINLINE const TMap<FString, FRHAPI_PlayerSession>& GetSessions(const TMap<FString, FRHAPI_PlayerSession>& DefaultValue) const { if (Sessions_IsSet) return Sessions_Optional; return DefaultValue; }
	/** @brief Fills OutValue with the value of Sessions_Optional and returns true if it has been set, otherwise returns false */
	FORCEINLINE bool GetSessions(TMap<FString, FRHAPI_PlayerSession>& OutValue) const { if (Sessions_IsSet) OutValue = Sessions_Optional; return Sessions_IsSet; }
	/** @brief Returns a pointer to Sessions_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE TMap<FString, FRHAPI_PlayerSession>* GetSessionsOrNull() { if (Sessions_IsSet) return (&Sessions_Optional); return nullptr; }
	/** @brief Returns a pointer to Sessions_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE const TMap<FString, FRHAPI_PlayerSession>* GetSessionsOrNull() const { if (Sessions_IsSet) return (&Sessions_Optional); return nullptr; }
	/** @brief Sets the value of Sessions_Optional and also sets Sessions_IsSet to true */
	FORCEINLINE void SetSessions(const TMap<FString, FRHAPI_PlayerSession>& NewValue) { Sessions_Optional = NewValue; Sessions_IsSet = true;  }
	/** @brief Sets the value of Sessions_Optional and also sets Sessions_IsSet to true using move semantics */
	FORCEINLINE void SetSessions(TMap<FString, FRHAPI_PlayerSession>&& NewValue) { Sessions_Optional = NewValue; Sessions_IsSet = true;  }
	...
	FORCEINLINE FDateTime& GetLastUpdatedTimestamp() { return LastUpdatedTimestamp_Optional; }
	/** @brief Gets the value of LastUpdatedTimestamp_Optional, regardless of it having been set */
	FORCEINLINE const FDateTime& GetLastUpdatedTimestamp() const { return LastUpdatedTimestamp_Optional; }
	/** @brief Gets the value of LastUpdatedTimestamp_Optional, if it has been set, otherwise it returns DefaultValue */
	FORCEINLINE const FDateTime& GetLastUpdatedTimestamp(const FDateTime& DefaultValue) const { if (LastUpdatedTimestamp_IsSet) return LastUpdatedTimestamp_Optional; return DefaultValue; }
	...
	FORCEINLINE bool GetLastUpdatedTimestamp(FDateTime& OutValue) const { if (LastUpdatedTimestamp_IsSet) OutValue = LastUpdatedTimestamp_Optional; return LastUpdatedTimestamp_IsSet; }
	/** @brief Returns a pointer to LastUpdatedTimestamp_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE FDateTime* GetLastUpdatedTimestampOrNull() { if (LastUpdatedTimestamp_IsSet) return (&LastUpdatedTimestamp_Optional); return nullptr; }
	/** @brief Returns a pointer to LastUpdatedTimestamp_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE const FDateTime* GetLastUpdatedTimestampOrNull() const { if (LastUpdatedTimestamp_IsSet) return (&LastUpdatedTimestamp_Optional); return nullptr; }
	/** @brief Sets the value of LastUpdatedTimestamp_Optional and also sets LastUpdatedTimestamp_IsSet to true */
	FORCEINLINE void SetLastUpdatedTimestamp(const FDateTime& NewValue) { LastUpdatedTimestamp_Optional = NewValue; LastUpdatedTimestamp_IsSet = true;  }
	...
	FORCEINLINE void SetLastUpdatedTimestamp(FDateTime&& NewValue) { LastUpdatedTimestamp_Optional = NewValue; LastUpdatedTimestamp_IsSet = true;  }
