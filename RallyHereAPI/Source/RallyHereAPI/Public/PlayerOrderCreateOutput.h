...
#include "Portal.h"
#include "Source.h"
#include "PlayerOrderCreateOutput.generated.h"

/** @defgroup RHAPI_PlayerOrderCreateOutput RallyHere API Model PlayerOrderCreateOutput
 *  @{
 */
...
struct RALLYHEREAPI_API FRHAPI_PlayerOrderCreateOutput : public FRHAPI_Model
{
	GENERATED_BODY()
