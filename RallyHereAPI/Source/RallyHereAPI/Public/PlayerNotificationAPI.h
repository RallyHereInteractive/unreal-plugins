 ...
 * Required Permissions:
 * 
 * - For any player (including themselves) any of: `notification:player:self:write`, `notification:player:self:*`, `notification:player:write`, `notification:player:*`
*/
 ...
 * Required Permissions:
 * 
 * - For any player (including themselves) any of: `notification:player:self:*`, `notification:player:self:read`, `notification:player:*`, `notification:player:read`
*/
