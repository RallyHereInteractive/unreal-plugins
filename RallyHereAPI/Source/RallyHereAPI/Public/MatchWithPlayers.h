...
struct RALLYHEREAPI_API FRHAPI_MatchWithPlayers : public FRHAPI_Model
{
	...
	*/
	...
	UPROPERTY(BlueprintReadWrite, Category = "RallyHere")
	TArray<FRHAPI_MatchSegmentWithPlayers> Segments_Optional{  };
	...
	FORCEINLINE TArray<FRHAPI_MatchSegmentWithPlayers>& GetSegments() { return Segments_Optional; }
	/** @brief Gets the value of Segments_Optional, regardless of it having been set */
	FORCEINLINE const TArray<FRHAPI_MatchSegmentWithPlayers>& GetSegments() const { return Segments_Optional; }
	/** @brief Gets the value of Segments_Optional, if it has been set, otherwise it returns DefaultValue */
	FORCEINLINE const TArray<FRHAPI_MatchSegmentWithPlayers>& GetSegments(const TArray<FRHAPI_MatchSegmentWithPlayers>& DefaultValue) const { if (Segments_IsSet) return Segments_Optional; return DefaultValue; }
	/** @brief Fills OutValue with the value of Segments_Optional and returns true if it has been set, otherwise returns false */
	FORCEINLINE bool GetSegments(TArray<FRHAPI_MatchSegmentWithPlayers>& OutValue) const { if (Segments_IsSet) OutValue = Segments_Optional; return Segments_IsSet; }
	/** @brief Returns a pointer to Segments_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE TArray<FRHAPI_MatchSegmentWithPlayers>* GetSegmentsOrNull() { if (Segments_IsSet) return (&Segments_Optional); return nullptr; }
	/** @brief Returns a pointer to Segments_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE const TArray<FRHAPI_MatchSegmentWithPlayers>* GetSegmentsOrNull() const { if (Segments_IsSet) return (&Segments_Optional); return nullptr; }
	/** @brief Sets the value of Segments_Optional and also sets Segments_IsSet to true */
	FORCEINLINE void SetSegments(const TArray<FRHAPI_MatchSegmentWithPlayers>& NewValue) { Segments_Optional = NewValue; Segments_IsSet = true;  }
	/** @brief Sets the value of Segments_Optional and also sets Segments_IsSet to true using move semantics */
	FORCEINLINE void SetSegments(TArray<FRHAPI_MatchSegmentWithPlayers>&& NewValue) { Segments_Optional = NewValue; Segments_IsSet = true;  }
