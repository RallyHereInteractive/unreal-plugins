...
#include "Portal.h"
#include "Source.h"
#include "PlayerOrderCreateSingle.generated.h"

/** @defgroup RHAPI_PlayerOrderCreateSingle RallyHere API Model PlayerOrderCreateSingle
 *  @{
 */
...
struct RALLYHEREAPI_API FRHAPI_PlayerOrderCreateSingle : public FRHAPI_Model
{
	GENERATED_BODY()
