...
struct RALLYHEREAPI_API FRHAPI_MatchMakingTemplate : public FRHAPI_Model
{
	...
	*/
	...
	FORCEINLINE TArray<FRHAPI_MatchMakingProfile>& GetProfiles() { return Profiles; }
	/** @brief Gets the value of Profiles */
	FORCEINLINE const TArray<FRHAPI_MatchMakingProfile>& GetProfiles() const { return Profiles; }
	/** @brief Sets the value of Profiles */
	FORCEINLINE void SetProfiles(const TArray<FRHAPI_MatchMakingProfile>& NewValue) { Profiles = NewValue;   }
	/** @brief Sets the value of Profiles using move semantics */
	FORCEINLINE void SetProfiles(TArray<FRHAPI_MatchMakingProfile>&& NewValue) { Profiles = NewValue;   }
};
