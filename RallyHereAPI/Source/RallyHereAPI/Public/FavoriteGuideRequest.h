...
#include "FavoriteGuideRequest.generated.h"

/** @defgroup RHAPI_FavoriteGuideRequest RallyHere API Model FavoriteGuideRequest
 *  @{
 */
...
struct RALLYHEREAPI_API FRHAPI_FavoriteGuideRequest : public FRHAPI_Model
{
	GENERATED_BODY()
