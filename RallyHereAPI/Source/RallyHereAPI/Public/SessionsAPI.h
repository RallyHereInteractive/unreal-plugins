 ...
 * Delete this session. It will be removed from the public browser, matchmaking, and backfills before being deleted
 * 
 * For all sessions:
 * 
 ...
 * * None
*/
struct RALLYHEREAPI_API FRequest_DeleteSession : public FRequest
{
	FRequest_DeleteSession();
	virtual ~FRequest_DeleteSession() = default;
...
/** The response type for FRequest_DeleteSession */
struct RALLYHEREAPI_API FResponse_DeleteSession : public FResponseAccessorTemplate<FRHAPI_HzApiErrorModel, FRHAPI_HTTPValidationError>
{
	typedef FResponseAccessorTemplate<FRHAPI_HzApiErrorModel, FRHAPI_HTTPValidationError> Super;

	FResponse_DeleteSession(FRequestMetadata InRequestMetadata);
	//virtual ~FResponse_DeleteSession() = default;
...
/** The delegate class for FRequest_DeleteSession */
DECLARE_DELEGATE_OneParam(FDelegate_DeleteSession, const FResponse_DeleteSession&);

/** @brief A helper metadata object for DeleteSession that defines the relationship between Request, Delegate, API, etc.  Intended for use with templating */
struct RALLYHEREAPI_API Traits_DeleteSession
{
	/** The request type */
	typedef FRequest_DeleteSession Request;
	/** The response type */
	typedef FResponse_DeleteSession Response;
	/** The delegate type, triggered by the response */
	typedef FDelegate_DeleteSession Delegate;
	/** The API object that supports this API call */
	typedef FSessionsAPI API;
	/** A human readable name for this API call */
	static FString Name;
...
/**
 * @brief Get Player Permission By Uuid
 ...
 * * None
*/
struct RALLYHEREAPI_API FRequest_GetPlayerPermissionByUuid : public FRequest
{
	FRequest_GetPlayerPermissionByUuid();
	virtual ~FRequest_GetPlayerPermissionByUuid() = default;
...
/** The response type for FRequest_GetPlayerPermissionByUuid */
struct RALLYHEREAPI_API FResponse_GetPlayerPermissionByUuid : public FResponseAccessorTemplate<FRHAPI_SessionPermissions, FRHAPI_HzApiErrorModel, FRHAPI_HTTPValidationError>
{
	typedef FResponseAccessorTemplate<FRHAPI_SessionPermissions, FRHAPI_HzApiErrorModel, FRHAPI_HTTPValidationError> Super;

	FResponse_GetPlayerPermissionByUuid(FRequestMetadata InRequestMetadata);
	//virtual ~FResponse_GetPlayerPermissionByUuid() = default;
	...
	/** Default Response Content */
	UE_DEPRECATED(5.0, "Direct use of Content is deprecated, please use TryGetDefaultContent(), TryGetContent(), TryGetResponse<>(), or TryGetContentFor<>() instead.")
	FRHAPI_SessionPermissions Content;
	...
	// Default Response Helpers
	/** @brief Attempt to retrieve the content in the default response */
	bool TryGetDefaultContent(FRHAPI_SessionPermissions& OutContent) const { return TryGetContent<FRHAPI_SessionPermissions>(OutContent); }
	/** @brief Attempt to retrieve the content in the default response */
	bool TryGetDefaultContent(TOptional<FRHAPI_SessionPermissions>& OutContent) const { return TryGetContent<FRHAPI_SessionPermissions>(OutContent); }
	/** @brief Attempt to retrieve the content in the default response */
	const FRHAPI_SessionPermissions* TryGetDefaultContentAsPointer() const { return TryGetContentAsPointer<FRHAPI_SessionPermissions>(); }
	/** @brief Attempt to retrieve the content in the default response */
	TOptional<FRHAPI_SessionPermissions> TryGetDefaultContentAsOptional() const { return TryGetContentAsOptional<FRHAPI_SessionPermissions>(); }
	...
	Successful Response
	*/
	bool TryGetContentFor200(FRHAPI_SessionPermissions& OutContent) const;
	/* Used to identify this version of the content.  Provide with a get request to avoid downloading the same data multiple times. */
	TOptional<FString> GetHeader200_ETag() const;
...
/** The delegate class for FRequest_GetPlayerPermissionByUuid */
DECLARE_DELEGATE_OneParam(FDelegate_GetPlayerPermissionByUuid, const FResponse_GetPlayerPermissionByUuid&);

/** @brief A helper metadata object for GetPlayerPermissionByUuid that defines the relationship between Request, Delegate, API, etc.  Intended for use with templating */
struct RALLYHEREAPI_API Traits_GetPlayerPermissionByUuid
{
	/** The request type */
	typedef FRequest_GetPlayerPermissionByUuid Request;
	/** The response type */
	typedef FResponse_GetPlayerPermissionByUuid Response;
	/** The delegate type, triggered by the response */
	typedef FDelegate_GetPlayerPermissionByUuid Delegate;
	/** The API object that supports this API call */
	typedef FSessionsAPI API;
	/** A human readable name for this API call */
	static FString Name;
...
/**
 * @brief Give Player Permission By Uuid
 ...
 * * None
*/
struct RALLYHEREAPI_API FRequest_GivePlayerPermissionByUuid : public FRequest
{
	FRequest_GivePlayerPermissionByUuid();
	virtual ~FRequest_GivePlayerPermissionByUuid() = default;
...
/** The response type for FRequest_GivePlayerPermissionByUuid */
struct RALLYHEREAPI_API FResponse_GivePlayerPermissionByUuid : public FResponseAccessorTemplate<FRHAPI_SessionPermissions, FRHAPI_HzApiErrorModel, FRHAPI_HTTPValidationError>
{
	typedef FResponseAccessorTemplate<FRHAPI_SessionPermissions, FRHAPI_HzApiErrorModel, FRHAPI_HTTPValidationError> Super;

	FResponse_GivePlayerPermissionByUuid(FRequestMetadata InRequestMetadata);
	//virtual ~FResponse_GivePlayerPermissionByUuid() = default;
...
/** The delegate class for FRequest_GivePlayerPermissionByUuid */
DECLARE_DELEGATE_OneParam(FDelegate_GivePlayerPermissionByUuid, const FResponse_GivePlayerPermissionByUuid&);

/** @brief A helper metadata object for GivePlayerPermissionByUuid that defines the relationship between Request, Delegate, API, etc.  Intended for use with templating */
struct RALLYHEREAPI_API Traits_GivePlayerPermissionByUuid
{
	/** The request type */
	typedef FRequest_GivePlayerPermissionByUuid Request;
	/** The response type */
	typedef FResponse_GivePlayerPermissionByUuid Response;
	/** The delegate type, triggered by the response */
	typedef FDelegate_GivePlayerPermissionByUuid Delegate;
	/** The API object that supports this API call */
	typedef FSessionsAPI API;
	/** A human readable name for this API call */
	static FString Name;
...
/**
 * @brief Invite Player By Uuid V2
...
*/
struct RALLYHEREAPI_API FRequest_InvitePlayerByUuidV2 : public FRequest
{
	FRequest_InvitePlayerByUuidV2();
	virtual ~FRequest_InvitePlayerByUuidV2() = default;
...
/** The response type for FRequest_InvitePlayerByUuidV2 */
struct RALLYHEREAPI_API FResponse_InvitePlayerByUuidV2 : public FResponseAccessorTemplate<FRHAPI_SessionPlayerUpdateResponse, FRHAPI_HzApiErrorModel, FRHAPI_HTTPValidationError>
{
	...
	FResponse_InvitePlayerByUuidV2(FRequestMetadata InRequestMetadata);
	//virtual ~FResponse_InvitePlayerByUuidV2() = default;
...
/** The delegate class for FRequest_InvitePlayerByUuidV2 */
DECLARE_DELEGATE_OneParam(FDelegate_InvitePlayerByUuidV2, const FResponse_InvitePlayerByUuidV2&);

/** @brief A helper metadata object for InvitePlayerByUuidV2 that defines the relationship between Request, Delegate, API, etc.  Intended for use with templating */
struct RALLYHEREAPI_API Traits_InvitePlayerByUuidV2
{
	/** The request type */
	typedef FRequest_InvitePlayerByUuidV2 Request;
	/** The response type */
	typedef FResponse_InvitePlayerByUuidV2 Response;
	/** The delegate type, triggered by the response */
	typedef FDelegate_InvitePlayerByUuidV2 Delegate;
	/** The API object that supports this API call */
	typedef FSessionsAPI API;
	/** A human readable name for this API call */
	static FString Name;
...
*/
struct RALLYHEREAPI_API FRequest_MovePlayerByUuidV2 : public FRequest
{
	FRequest_MovePlayerByUuidV2();
	virtual ~FRequest_MovePlayerByUuidV2() = default;
...
/** The response type for FRequest_MovePlayerByUuidV2 */
struct RALLYHEREAPI_API FResponse_MovePlayerByUuidV2 : public FResponseAccessorTemplate<FRHAPI_SessionPlayerUpdateResponse, FRHAPI_HzApiErrorModel, FRHAPI_HTTPValidationError>
{
	typedef FResponseAccessorTemplate<FRHAPI_SessionPlayerUpdateResponse, FRHAPI_HzApiErrorModel, FRHAPI_HTTPValidationError> Super;

	FResponse_MovePlayerByUuidV2(FRequestMetadata InRequestMetadata);
	//virtual ~FResponse_MovePlayerByUuidV2() = default;
...
/** The delegate class for FRequest_MovePlayerByUuidV2 */
DECLARE_DELEGATE_OneParam(FDelegate_MovePlayerByUuidV2, const FResponse_MovePlayerByUuidV2&);

/** @brief A helper metadata object for MovePlayerByUuidV2 that defines the relationship between Request, Delegate, API, etc.  Intended for use with templating */
struct RALLYHEREAPI_API Traits_MovePlayerByUuidV2
{
	/** The request type */
	typedef FRequest_MovePlayerByUuidV2 Request;
	/** The response type */
	typedef FResponse_MovePlayerByUuidV2 Response;
	/** The delegate type, triggered by the response */
	typedef FDelegate_MovePlayerByUuidV2 Delegate;
	/** The API object that supports this API call */
	typedef FSessionsAPI API;
	/** A human readable name for this API call */
	static FString Name;
...
/**
 * @brief Promote Player By Uuid V2
 * Invite a player to the session
 * 
 * Required Permissions:
 * 
...
*/
struct RALLYHEREAPI_API FRequest_PromotePlayerByUuidV2 : public FRequest
{
	FRequest_PromotePlayerByUuidV2();
	virtual ~FRequest_PromotePlayerByUuidV2() = default;
...
/** The response type for FRequest_PromotePlayerByUuidV2 */
struct RALLYHEREAPI_API FResponse_PromotePlayerByUuidV2 : public FResponseAccessorTemplate<FRHAPI_SessionPlayerUpdateResponse, FRHAPI_HzApiErrorModel, FRHAPI_HTTPValidationError>
{
	typedef FResponseAccessorTemplate<FRHAPI_SessionPlayerUpdateResponse, FRHAPI_HzApiErrorModel, FRHAPI_HTTPValidationError> Super;

	FResponse_PromotePlayerByUuidV2(FRequestMetadata InRequestMetadata);
	//virtual ~FResponse_PromotePlayerByUuidV2() = default;
...
/** The delegate class for FRequest_PromotePlayerByUuidV2 */
DECLARE_DELEGATE_OneParam(FDelegate_PromotePlayerByUuidV2, const FResponse_PromotePlayerByUuidV2&);

/** @brief A helper metadata object for PromotePlayerByUuidV2 that defines the relationship between Request, Delegate, API, etc.  Intended for use with templating */
struct RALLYHEREAPI_API Traits_PromotePlayerByUuidV2
{
	/** The request type */
	typedef FRequest_PromotePlayerByUuidV2 Request;
	/** The response type */
	typedef FResponse_PromotePlayerByUuidV2 Response;
	/** The delegate type, triggered by the response */
	typedef FDelegate_PromotePlayerByUuidV2 Delegate;
	/** The API object that supports this API call */
	typedef FSessionsAPI API;
	/** A human readable name for this API call */
	static FString Name;
...
/**
 * @brief Remove Player Permission By Uuid
 ...
 * * None
*/
struct RALLYHEREAPI_API FRequest_RemovePlayerPermissionByUuid : public FRequest
{
	FRequest_RemovePlayerPermissionByUuid();
	virtual ~FRequest_RemovePlayerPermissionByUuid() = default;
...
/** The response type for FRequest_RemovePlayerPermissionByUuid */
struct RALLYHEREAPI_API FResponse_RemovePlayerPermissionByUuid : public FResponseAccessorTemplate<FRHAPI_HzApiErrorModel, FRHAPI_HTTPValidationError>
{
	typedef FResponseAccessorTemplate<FRHAPI_HzApiErrorModel, FRHAPI_HTTPValidationError> Super;

	FResponse_RemovePlayerPermissionByUuid(FRequestMetadata InRequestMetadata);
	//virtual ~FResponse_RemovePlayerPermissionByUuid() = default;
...
/** The delegate class for FRequest_RemovePlayerPermissionByUuid */
DECLARE_DELEGATE_OneParam(FDelegate_RemovePlayerPermissionByUuid, const FResponse_RemovePlayerPermissionByUuid&);

/** @brief A helper metadata object for RemovePlayerPermissionByUuid that defines the relationship between Request, Delegate, API, etc.  Intended for use with templating */
struct RALLYHEREAPI_API Traits_RemovePlayerPermissionByUuid
{
	/** The request type */
	typedef FRequest_RemovePlayerPermissionByUuid Request;
	/** The response type */
	typedef FResponse_RemovePlayerPermissionByUuid Response;
	/** The delegate type, triggered by the response */
	typedef FDelegate_RemovePlayerPermissionByUuid Delegate;
	/** The API object that supports this API call */
	typedef FSessionsAPI API;
	/** A human readable name for this API call */
	static FString Name;
...
/**
 * @brief Update Player By Uuid V2
 ...
 * Required Session Permissions: `SessionPermissions.session_admin` for users that do not have the `session:promote:any` auth permission
*/
struct RALLYHEREAPI_API FRequest_UpdatePlayerByUuidV2 : public FRequest
{
	FRequest_UpdatePlayerByUuidV2();
	virtual ~FRequest_UpdatePlayerByUuidV2() = default;
...
/** The response type for FRequest_UpdatePlayerByUuidV2 */
struct RALLYHEREAPI_API FResponse_UpdatePlayerByUuidV2 : public FResponseAccessorTemplate<FRHAPI_SessionPlayerUpdateResponse, FRHAPI_HzApiErrorModel, FRHAPI_HTTPValidationError>
{
	typedef FResponseAccessorTemplate<FRHAPI_SessionPlayerUpdateResponse, FRHAPI_HzApiErrorModel, FRHAPI_HTTPValidationError> Super;

	FResponse_UpdatePlayerByUuidV2(FRequestMetadata InRequestMetadata);
	//virtual ~FResponse_UpdatePlayerByUuidV2() = default;
...
/** The delegate class for FRequest_UpdatePlayerByUuidV2 */
DECLARE_DELEGATE_OneParam(FDelegate_UpdatePlayerByUuidV2, const FResponse_UpdatePlayerByUuidV2&);

/** @brief A helper metadata object for UpdatePlayerByUuidV2 that defines the relationship between Request, Delegate, API, etc.  Intended for use with templating */
struct RALLYHEREAPI_API Traits_UpdatePlayerByUuidV2
{
	/** The request type */
	typedef FRequest_UpdatePlayerByUuidV2 Request;
	/** The response type */
	typedef FResponse_UpdatePlayerByUuidV2 Response;
	/** The delegate type, triggered by the response */
	typedef FDelegate_UpdatePlayerByUuidV2 Delegate;
	/** The API object that supports this API call */
	typedef FSessionsAPI API;
	/** A human readable name for this API call */
	static FString Name;
...
public:
	...
	FHttpRequestPtr DeleteSession(const FRequest_DeleteSession& Request, const FDelegate_DeleteSession& Delegate = FDelegate_DeleteSession(), int32 Priority = DefaultRallyHereAPIPriority);
	...
	FHttpRequestPtr GetPlayerPermissionByUuid(const FRequest_GetPlayerPermissionByUuid& Request, const FDelegate_GetPlayerPermissionByUuid& Delegate = FDelegate_GetPlayerPermissionByUuid(), int32 Priority = DefaultRallyHereAPIPriority);
	void OnGetPlayerPermissionByUuidResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FDelegate_GetPlayerPermissionByUuid Delegate, FRequestMetadata RequestMetadata, TSharedPtr<FAuthContext> AuthContextForRetry, int32 Priority);
	...
	FHttpRequestPtr InvitePlayerByUuidV2(const FRequest_InvitePlayerByUuidV2& Request, const FDelegate_InvitePlayerByUuidV2& Delegate = FDelegate_InvitePlayerByUuidV2(), int32 Priority = DefaultRallyHereAPIPriority);
	void OnInvitePlayerByUuidV2Response(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FDelegate_InvitePlayerByUuidV2 Delegate, FRequestMetadata RequestMetadata, TSharedPtr<FAuthContext> AuthContextForRetry, int32 Priority);
	...
	FHttpRequestPtr MovePlayerByUuidV2(const FRequest_MovePlayerByUuidV2& Request, const FDelegate_MovePlayerByUuidV2& Delegate = FDelegate_MovePlayerByUuidV2(), int32 Priority = DefaultRallyHereAPIPriority);
	void OnMovePlayerByUuidV2Response(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FDelegate_MovePlayerByUuidV2 Delegate, FRequestMetadata RequestMetadata, TSharedPtr<FAuthContext> AuthContextForRetry, int32 Priority);
	...
	FHttpRequestPtr PromotePlayerByUuidV2(const FRequest_PromotePlayerByUuidV2& Request, const FDelegate_PromotePlayerByUuidV2& Delegate = FDelegate_PromotePlayerByUuidV2(), int32 Priority = DefaultRallyHereAPIPriority);
	void OnPromotePlayerByUuidV2Response(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FDelegate_PromotePlayerByUuidV2 Delegate, FRequestMetadata RequestMetadata, TSharedPtr<FAuthContext> AuthContextForRetry, int32 Priority);
	FHttpRequestPtr RemovePlayerPermissionByUuid(const FRequest_RemovePlayerPermissionByUuid& Request, const FDelegate_RemovePlayerPermissionByUuid& Delegate = FDelegate_RemovePlayerPermissionByUuid(), int32 Priority = DefaultRallyHereAPIPriority);
	void OnRemovePlayerPermissionByUuidResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FDelegate_RemovePlayerPermissionByUuid Delegate, FRequestMetadata RequestMetadata, TSharedPtr<FAuthContext> AuthContextForRetry, int32 Priority);
	...
	FHttpRequestPtr UpdatePlayerByUuidV2(const FRequest_UpdatePlayerByUuidV2& Request, const FDelegate_UpdatePlayerByUuidV2& Delegate = FDelegate_UpdatePlayerByUuidV2(), int32 Priority = DefaultRallyHereAPIPriority);
	void OnUpdatePlayerByUuidV2Response(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FDelegate_UpdatePlayerByUuidV2 Delegate, FRequestMetadata RequestMetadata, TSharedPtr<FAuthContext> AuthContextForRetry, int32 Priority);
