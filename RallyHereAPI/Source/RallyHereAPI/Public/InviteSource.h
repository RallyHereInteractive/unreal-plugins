...
#include "InviteSource.generated.h"
...
RALLYHEREAPI_API FStringFormatArg ToStringFormatArg(const ERHAPI_InviteSource& Value);
RALLYHEREAPI_API void WriteJsonValue(TSharedRef<TJsonWriter<>>& Writer, const ERHAPI_InviteSource& Value);
RALLYHEREAPI_API bool TryGetJsonValue(const TSharedPtr<FJsonValue>& JsonValue, ERHAPI_InviteSource& Value);
