...
#include "BaseBackfillRequest.generated.h"

/** @defgroup RHAPI_BaseBackfillRequest RallyHere API Model BaseBackfillRequest
 *  @{
 */
...
struct RALLYHEREAPI_API FRHAPI_BaseBackfillRequest : public FRHAPI_Model
{
	GENERATED_BODY()
