...
struct RALLYHEREAPI_API FRHAPI_GuideFull : public FRHAPI_Model
{
	...
	*/
	...
	FORCEINLINE FString& GetGuideType() { return GuideType; }
	/** @brief Gets the value of GuideType */
	FORCEINLINE const FString& GetGuideType() const { return GuideType; }
	/** @brief Sets the value of GuideType */
	FORCEINLINE void SetGuideType(const FString& NewValue) { GuideType = NewValue;   }
	/** @brief Sets the value of GuideType using move semantics */
	FORCEINLINE void SetGuideType(FString&& NewValue) { GuideType = NewValue;   }

	UPROPERTY(BlueprintReadWrite, Category = "RallyHere")
	FString Language{  };
	/** @brief Gets the value of Language */
	FORCEINLINE FString& GetLanguage() { return Language; }
	/** @brief Gets the value of Language */
	FORCEINLINE const FString& GetLanguage() const { return Language; }
	/** @brief Sets the value of Language */
	FORCEINLINE void SetLanguage(const FString& NewValue) { Language = NewValue;   }
	/** @brief Sets the value of Language using move semantics */
	FORCEINLINE void SetLanguage(FString&& NewValue) { Language = NewValue;   }

	/** @brief Version this guide was created for */
	UPROPERTY(BlueprintReadWrite, Category = "RallyHere")
	FString GameVersion{  };
	/** @brief Gets the value of GameVersion */
	FORCEINLINE FString& GetGameVersion() { return GameVersion; }
	/** @brief Gets the value of GameVersion */
	FORCEINLINE const FString& GetGameVersion() const { return GameVersion; }
	/** @brief Sets the value of GameVersion */
	FORCEINLINE void SetGameVersion(const FString& NewValue) { GameVersion = NewValue;   }
	/** @brief Sets the value of GameVersion using move semantics */
	FORCEINLINE void SetGameVersion(FString&& NewValue) { GameVersion = NewValue;   }
	...
	FORCEINLINE int32& GetV() { return V_Optional; }
	/** @brief Gets the value of V_Optional, regardless of it having been set */
	FORCEINLINE const int32& GetV() const { return V_Optional; }
	/** @brief Gets the value of V_Optional, if it has been set, otherwise it returns DefaultValue */
	FORCEINLINE const int32& GetV(const int32& DefaultValue) const { if (V_IsSet) return V_Optional; return DefaultValue; }
	/** @brief Fills OutValue with the value of V_Optional and returns true if it has been set, otherwise returns false */
	FORCEINLINE bool GetV(int32& OutValue) const { if (V_IsSet) OutValue = V_Optional; return V_IsSet; }
	/** @brief Returns a pointer to V_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE int32* GetVOrNull() { if (V_IsSet) return (&V_Optional); return nullptr; }
	/** @brief Returns a pointer to V_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE const int32* GetVOrNull() const { if (V_IsSet) return (&V_Optional); return nullptr; }
	/** @brief Sets the value of V_Optional and also sets V_IsSet to true */
	FORCEINLINE void SetV(const int32& NewValue) { V_Optional = NewValue; V_IsSet = true;  }
	/** @brief Sets the value of V_Optional and also sets V_IsSet to true using move semantics */
	FORCEINLINE void SetV(int32&& NewValue) { V_Optional = NewValue; V_IsSet = true;  }
	...
	FORCEINLINE int32 GetDefaultValue_V() { return 1; }
	...
	FORCEINLINE int32& GetPromotionPriority() { return PromotionPriority_Optional; }
	/** @brief Gets the value of PromotionPriority_Optional, regardless of it having been set */
	FORCEINLINE const int32& GetPromotionPriority() const { return PromotionPriority_Optional; }
	/** @brief Gets the value of PromotionPriority_Optional, if it has been set, otherwise it returns DefaultValue */
	FORCEINLINE const int32& GetPromotionPriority(const int32& DefaultValue) const { if (PromotionPriority_IsSet) return PromotionPriority_Optional; return DefaultValue; }
	...
	FORCEINLINE bool GetPromotionPriority(int32& OutValue) const { if (PromotionPriority_IsSet) OutValue = PromotionPriority_Optional; return PromotionPriority_IsSet; }
	/** @brief Returns a pointer to PromotionPriority_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE int32* GetPromotionPriorityOrNull() { if (PromotionPriority_IsSet) return (&PromotionPriority_Optional); return nullptr; }
	/** @brief Returns a pointer to PromotionPriority_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE const int32* GetPromotionPriorityOrNull() const { if (PromotionPriority_IsSet) return (&PromotionPriority_Optional); return nullptr; }
	/** @brief Sets the value of PromotionPriority_Optional and also sets PromotionPriority_IsSet to true */
	FORCEINLINE void SetPromotionPriority(const int32& NewValue) { PromotionPriority_Optional = NewValue; PromotionPriority_IsSet = true;  }
	/** @brief Sets the value of PromotionPriority_Optional and also sets PromotionPriority_IsSet to true using move semantics */
	FORCEINLINE void SetPromotionPriority(int32&& NewValue) { PromotionPriority_Optional = NewValue; PromotionPriority_IsSet = true;  }
	...
	/** @brief Returns the default value of PromotionPriority */
	FORCEINLINE int32 GetDefaultValue_PromotionPriority() { return 0; }
	...
	FORCEINLINE ERHAPI_GuideEntityType& GetOwnerEntityType() { return OwnerEntityType; }
	/** @brief Gets the value of OwnerEntityType */
	FORCEINLINE const ERHAPI_GuideEntityType& GetOwnerEntityType() const { return OwnerEntityType; }
	/** @brief Sets the value of OwnerEntityType */
	FORCEINLINE void SetOwnerEntityType(const ERHAPI_GuideEntityType& NewValue) { OwnerEntityType = NewValue;   }
	/** @brief Sets the value of OwnerEntityType using move semantics */
	FORCEINLINE void SetOwnerEntityType(ERHAPI_GuideEntityType&& NewValue) { OwnerEntityType = NewValue;   }

	UPROPERTY(BlueprintReadWrite, Category = "RallyHere")
	FString OwnerEntityId{  };
	/** @brief Gets the value of OwnerEntityId */
	FORCEINLINE FString& GetOwnerEntityId() { return OwnerEntityId; }
	/** @brief Gets the value of OwnerEntityId */
	FORCEINLINE const FString& GetOwnerEntityId() const { return OwnerEntityId; }
	/** @brief Sets the value of OwnerEntityId */
	FORCEINLINE void SetOwnerEntityId(const FString& NewValue) { OwnerEntityId = NewValue;   }
	/** @brief Sets the value of OwnerEntityId using move semantics */
	FORCEINLINE void SetOwnerEntityId(FString&& NewValue) { OwnerEntityId = NewValue;   }
	...
	FORCEINLINE int32& GetFavorites() { return Favorites_Optional; }
	/** @brief Gets the value of Favorites_Optional, regardless of it having been set */
	FORCEINLINE const int32& GetFavorites() const { return Favorites_Optional; }
	/** @brief Gets the value of Favorites_Optional, if it has been set, otherwise it returns DefaultValue */
	FORCEINLINE const int32& GetFavorites(const int32& DefaultValue) const { if (Favorites_IsSet) return Favorites_Optional; return DefaultValue; }
	/** @brief Fills OutValue with the value of Favorites_Optional and returns true if it has been set, otherwise returns false */
	FORCEINLINE bool GetFavorites(int32& OutValue) const { if (Favorites_IsSet) OutValue = Favorites_Optional; return Favorites_IsSet; }
	/** @brief Returns a pointer to Favorites_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE int32* GetFavoritesOrNull() { if (Favorites_IsSet) return (&Favorites_Optional); return nullptr; }
	/** @brief Returns a pointer to Favorites_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE const int32* GetFavoritesOrNull() const { if (Favorites_IsSet) return (&Favorites_Optional); return nullptr; }
	/** @brief Sets the value of Favorites_Optional and also sets Favorites_IsSet to true */
	FORCEINLINE void SetFavorites(const int32& NewValue) { Favorites_Optional = NewValue; Favorites_IsSet = true;  }
	/** @brief Sets the value of Favorites_Optional and also sets Favorites_IsSet to true using move semantics */
	FORCEINLINE void SetFavorites(int32&& NewValue) { Favorites_Optional = NewValue; Favorites_IsSet = true;  }
	...
	/** @brief Returns the default value of Favorites */
	FORCEINLINE int32 GetDefaultValue_Favorites() { return 0; }
	...
	FORCEINLINE int32& GetUpvotes() { return Upvotes_Optional; }
	/** @brief Gets the value of Upvotes_Optional, regardless of it having been set */
	FORCEINLINE const int32& GetUpvotes() const { return Upvotes_Optional; }
	/** @brief Gets the value of Upvotes_Optional, if it has been set, otherwise it returns DefaultValue */
	FORCEINLINE const int32& GetUpvotes(const int32& DefaultValue) const { if (Upvotes_IsSet) return Upvotes_Optional; return DefaultValue; }
	/** @brief Fills OutValue with the value of Upvotes_Optional and returns true if it has been set, otherwise returns false */
	FORCEINLINE bool GetUpvotes(int32& OutValue) const { if (Upvotes_IsSet) OutValue = Upvotes_Optional; return Upvotes_IsSet; }
	/** @brief Returns a pointer to Upvotes_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE int32* GetUpvotesOrNull() { if (Upvotes_IsSet) return (&Upvotes_Optional); return nullptr; }
	/** @brief Returns a pointer to Upvotes_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE const int32* GetUpvotesOrNull() const { if (Upvotes_IsSet) return (&Upvotes_Optional); return nullptr; }
	/** @brief Sets the value of Upvotes_Optional and also sets Upvotes_IsSet to true */
	FORCEINLINE void SetUpvotes(const int32& NewValue) { Upvotes_Optional = NewValue; Upvotes_IsSet = true;  }
	/** @brief Sets the value of Upvotes_Optional and also sets Upvotes_IsSet to true using move semantics */
	FORCEINLINE void SetUpvotes(int32&& NewValue) { Upvotes_Optional = NewValue; Upvotes_IsSet = true;  }
	...
	/** @brief Returns the default value of Upvotes */
	FORCEINLINE int32 GetDefaultValue_Upvotes() { return 0; }
	...
	FORCEINLINE int32& GetDownvotes() { return Downvotes_Optional; }
	/** @brief Gets the value of Downvotes_Optional, regardless of it having been set */
	FORCEINLINE const int32& GetDownvotes() const { return Downvotes_Optional; }
	/** @brief Gets the value of Downvotes_Optional, if it has been set, otherwise it returns DefaultValue */
	FORCEINLINE const int32& GetDownvotes(const int32& DefaultValue) const { if (Downvotes_IsSet) return Downvotes_Optional; return DefaultValue; }
	/** @brief Fills OutValue with the value of Downvotes_Optional and returns true if it has been set, otherwise returns false */
	FORCEINLINE bool GetDownvotes(int32& OutValue) const { if (Downvotes_IsSet) OutValue = Downvotes_Optional; return Downvotes_IsSet; }
	/** @brief Returns a pointer to Downvotes_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE int32* GetDownvotesOrNull() { if (Downvotes_IsSet) return (&Downvotes_Optional); return nullptr; }
	/** @brief Returns a pointer to Downvotes_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE const int32* GetDownvotesOrNull() const { if (Downvotes_IsSet) return (&Downvotes_Optional); return nullptr; }
	/** @brief Sets the value of Downvotes_Optional and also sets Downvotes_IsSet to true */
	FORCEINLINE void SetDownvotes(const int32& NewValue) { Downvotes_Optional = NewValue; Downvotes_IsSet = true;  }
	/** @brief Sets the value of Downvotes_Optional and also sets Downvotes_IsSet to true using move semantics */
	FORCEINLINE void SetDownvotes(int32&& NewValue) { Downvotes_Optional = NewValue; Downvotes_IsSet = true;  }
	...
	/** @brief Returns the default value of Downvotes */
	FORCEINLINE int32 GetDefaultValue_Downvotes() { return 0; }
	...
	FORCEINLINE TArray<FRHAPI_GuideSectionFull>& GetSections() { return Sections_Optional; }
	/** @brief Gets the value of Sections_Optional, regardless of it having been set */
	FORCEINLINE const TArray<FRHAPI_GuideSectionFull>& GetSections() const { return Sections_Optional; }
	/** @brief Gets the value of Sections_Optional, if it has been set, otherwise it returns DefaultValue */
	FORCEINLINE const TArray<FRHAPI_GuideSectionFull>& GetSections(const TArray<FRHAPI_GuideSectionFull>& DefaultValue) const { if (Sections_IsSet) return Sections_Optional; return DefaultValue; }
	/** @brief Fills OutValue with the value of Sections_Optional and returns true if it has been set, otherwise returns false */
	FORCEINLINE bool GetSections(TArray<FRHAPI_GuideSectionFull>& OutValue) const { if (Sections_IsSet) OutValue = Sections_Optional; return Sections_IsSet; }
	/** @brief Returns a pointer to Sections_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE TArray<FRHAPI_GuideSectionFull>* GetSectionsOrNull() { if (Sections_IsSet) return (&Sections_Optional); return nullptr; }
	/** @brief Returns a pointer to Sections_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE const TArray<FRHAPI_GuideSectionFull>* GetSectionsOrNull() const { if (Sections_IsSet) return (&Sections_Optional); return nullptr; }
	/** @brief Sets the value of Sections_Optional and also sets Sections_IsSet to true */
	FORCEINLINE void SetSections(const TArray<FRHAPI_GuideSectionFull>& NewValue) { Sections_Optional = NewValue; Sections_IsSet = true;  }
	/** @brief Sets the value of Sections_Optional and also sets Sections_IsSet to true using move semantics */
	FORCEINLINE void SetSections(TArray<FRHAPI_GuideSectionFull>&& NewValue) { Sections_Optional = NewValue; Sections_IsSet = true;  }
