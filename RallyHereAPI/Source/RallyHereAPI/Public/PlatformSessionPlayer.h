...
struct RALLYHEREAPI_API FRHAPI_PlatformSessionPlayer : public FRHAPI_Model
{
	...
	*/
	...
	FORCEINLINE bool& GetLeader() { return Leader_Optional; }
	/** @brief Gets the value of Leader_Optional, regardless of it having been set */
	FORCEINLINE const bool& GetLeader() const { return Leader_Optional; }
	/** @brief Gets the value of Leader_Optional, if it has been set, otherwise it returns DefaultValue */
	FORCEINLINE const bool& GetLeader(const bool& DefaultValue) const { if (Leader_IsSet) return Leader_Optional; return DefaultValue; }
	/** @brief Fills OutValue with the value of Leader_Optional and returns true if it has been set, otherwise returns false */
	FORCEINLINE bool GetLeader(bool& OutValue) const { if (Leader_IsSet) OutValue = Leader_Optional; return Leader_IsSet; }
	/** @brief Returns a pointer to Leader_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE bool* GetLeaderOrNull() { if (Leader_IsSet) return (&Leader_Optional); return nullptr; }
	/** @brief Returns a pointer to Leader_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE const bool* GetLeaderOrNull() const { if (Leader_IsSet) return (&Leader_Optional); return nullptr; }
	/** @brief Sets the value of Leader_Optional and also sets Leader_IsSet to true */
	FORCEINLINE void SetLeader(const bool& NewValue) { Leader_Optional = NewValue; Leader_IsSet = true;  }
	/** @brief Sets the value of Leader_Optional and also sets Leader_IsSet to true using move semantics */
	FORCEINLINE void SetLeader(bool&& NewValue) { Leader_Optional = NewValue; Leader_IsSet = true;  }
	...
	/** @brief Returns the default value of Leader */
	FORCEINLINE bool GetDefaultValue_Leader() { return false; }
};
