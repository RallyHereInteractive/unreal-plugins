...
#include "MatchSegmentRequestInput.generated.h"

/** @defgroup RHAPI_MatchSegmentRequestInput RallyHere API Model MatchSegmentRequestInput
 *  @{
 */
...
struct RALLYHEREAPI_API FRHAPI_MatchSegmentRequestInput : public FRHAPI_Model
{
    GENERATED_BODY()
