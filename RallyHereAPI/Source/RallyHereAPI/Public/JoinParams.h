...
struct RALLYHEREAPI_API FRHAPI_JoinParams : public FRHAPI_Model
{
	...
	*/
	...
	FORCEINLINE FString& GetPublicConnStr() { return PublicConnStr; }
	/** @brief Gets the value of PublicConnStr */
	FORCEINLINE const FString& GetPublicConnStr() const { return PublicConnStr; }
	/** @brief Sets the value of PublicConnStr */
	FORCEINLINE void SetPublicConnStr(const FString& NewValue) { PublicConnStr = NewValue;   }
	/** @brief Sets the value of PublicConnStr using move semantics */
	FORCEINLINE void SetPublicConnStr(FString&& NewValue) { PublicConnStr = NewValue;   }

	/** @brief Private connection string for instance */
	UPROPERTY(BlueprintReadWrite, Category = "RallyHere")
	FString PrivateConnStr{  };
	/** @brief Gets the value of PrivateConnStr */
	FORCEINLINE FString& GetPrivateConnStr() { return PrivateConnStr; }
	/** @brief Gets the value of PrivateConnStr */
	FORCEINLINE const FString& GetPrivateConnStr() const { return PrivateConnStr; }
	/** @brief Sets the value of PrivateConnStr */
	FORCEINLINE void SetPrivateConnStr(const FString& NewValue) { PrivateConnStr = NewValue;   }
	/** @brief Sets the value of PrivateConnStr using move semantics */
	FORCEINLINE void SetPrivateConnStr(FString&& NewValue) { PrivateConnStr = NewValue;   }
