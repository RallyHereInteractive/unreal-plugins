...
struct RALLYHEREAPI_API FRHAPI_PexClientResponse : public FRHAPI_Model
{
	...
	*/
	...
	bool GetScores(FRHAPI_PexClientScores& OutValue) const { if (Scores_IsSet) OutValue = Scores_Optional; return Scores_IsSet; }
	/** @brief Returns a pointer to Scores_Optional, if it has been set, otherwise returns nullptr */
	FRHAPI_PexClientScores* GetScoresOrNull() { if (Scores_IsSet) return &Scores_Optional; return nullptr; }
	/** @brief Returns a pointer to Scores_Optional, if it has been set, otherwise returns nullptr */
	const FRHAPI_PexClientScores* GetScoresOrNull() const { if (Scores_IsSet) return &Scores_Optional; return nullptr; }
	/** @brief Sets the value of Scores_Optional and also sets Scores_IsSet to true */
	void SetScores(const FRHAPI_PexClientScores& NewValue) { Scores_Optional = NewValue; Scores_IsSet = true; }
	/** @brief Sets the value of Scores_Optional and also sets Scores_IsSet to true using move semantics */
	void SetScores(FRHAPI_PexClientScores&& NewValue) { Scores_Optional = NewValue; Scores_IsSet = true; }
