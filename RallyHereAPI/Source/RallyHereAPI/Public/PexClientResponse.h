...
struct RALLYHEREAPI_API FRHAPI_PexClientResponse : public FRHAPI_Model
{
	...
	*/
	...
	/** @brief Gets the value of GameThreadTime_Optional, regardless of it having been set */
	const FRHAPI_PexStat& GetGameThreadTime() const { return GameThreadTime_Optional; }
	...
	/** @brief Gets the value of RenderThreadTime_Optional, regardless of it having been set */
	const FRHAPI_PexStat& GetRenderThreadTime() const { return RenderThreadTime_Optional; }
	...
	/** @brief Gets the value of GpuTime_Optional, regardless of it having been set */
	const FRHAPI_PexStat& GetGpuTime() const { return GpuTime_Optional; }
	...
	FRHAPI_PexClientScores& GetScores() { return Scores_Optional; }
	/** @brief Gets the value of Scores_Optional, regardless of it having been set */
	const FRHAPI_PexClientScores& GetScores() const { return Scores_Optional; }
	/** @brief Gets the value of Scores_Optional, if it has been set, otherwise it returns DefaultValue */
	const FRHAPI_PexClientScores& GetScores(const FRHAPI_PexClientScores& DefaultValue) const { if (Scores_IsSet) return Scores_Optional; return DefaultValue; }
	/** @brief Fills OutValue with the value of Scores_Optional and returns true if it has been set, otherwise returns false */
	bool GetScores(FRHAPI_PexClientScores& OutValue) const { if (Scores_IsSet && !Scores_IsNull) OutValue = Scores_Optional; return Scores_IsSet; }
	/** @brief Returns a pointer to Scores_Optional, if it has been set, otherwise returns nullptr */
	FRHAPI_PexClientScores* GetScoresOrNull() { if (Scores_IsSet) return (Scores_IsNull ? nullptr : &Scores_Optional); return nullptr; }
	/** @brief Returns a pointer to Scores_Optional, if it has been set, otherwise returns nullptr */
	const FRHAPI_PexClientScores* GetScoresOrNull() const { if (Scores_IsSet) return (Scores_IsNull ? nullptr : &Scores_Optional); return nullptr; }
	/** @brief Sets the value of Scores_Optional and also sets Scores_IsSet to true */
	void SetScores(const FRHAPI_PexClientScores& NewValue) { Scores_Optional = NewValue; Scores_IsSet = true; Scores_IsNull = false; }
	/** @brief Sets the value of Scores_Optional and also sets Scores_IsSet to true using move semantics */
	void SetScores(FRHAPI_PexClientScores&& NewValue) { Scores_Optional = NewValue; Scores_IsSet = true; Scores_IsNull = false; }
