...
struct RALLYHEREAPI_API FRHAPI_Vendors : public FRHAPI_Model
{
	...
	*/
	...
	FORCEINLINE TMap<FString, FRHAPI_Vendor>& GetVendors() { return Vendors_Optional; }
	/** @brief Gets the value of Vendors_Optional, regardless of it having been set */
	FORCEINLINE const TMap<FString, FRHAPI_Vendor>& GetVendors() const { return Vendors_Optional; }
	/** @brief Gets the value of Vendors_Optional, if it has been set, otherwise it returns DefaultValue */
	FORCEINLINE const TMap<FString, FRHAPI_Vendor>& GetVendors(const TMap<FString, FRHAPI_Vendor>& DefaultValue) const { if (Vendors_IsSet) return Vendors_Optional; return DefaultValue; }
	/** @brief Fills OutValue with the value of Vendors_Optional and returns true if it has been set, otherwise returns false */
	FORCEINLINE bool GetVendors(TMap<FString, FRHAPI_Vendor>& OutValue) const { if (Vendors_IsSet) OutValue = Vendors_Optional; return Vendors_IsSet; }
	/** @brief Returns a pointer to Vendors_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE TMap<FString, FRHAPI_Vendor>* GetVendorsOrNull() { if (Vendors_IsSet) return (&Vendors_Optional); return nullptr; }
	/** @brief Returns a pointer to Vendors_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE const TMap<FString, FRHAPI_Vendor>* GetVendorsOrNull() const { if (Vendors_IsSet) return (&Vendors_Optional); return nullptr; }
	/** @brief Sets the value of Vendors_Optional and also sets Vendors_IsSet to true */
	FORCEINLINE void SetVendors(const TMap<FString, FRHAPI_Vendor>& NewValue) { Vendors_Optional = NewValue; Vendors_IsSet = true;  }
	/** @brief Sets the value of Vendors_Optional and also sets Vendors_IsSet to true using move semantics */
	FORCEINLINE void SetVendors(TMap<FString, FRHAPI_Vendor>&& NewValue) { Vendors_Optional = NewValue; Vendors_IsSet = true;  }
