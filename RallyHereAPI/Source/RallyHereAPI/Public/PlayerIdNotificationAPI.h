 ...
 * Required Permissions:
 * 
 * - For any playerid (including themselves) any of: `notification:playerid:*`, `notification:playerid:write`, `notification:playerid:self:write`, `notification:playerid:self:*`
*/
 ...
 * Required Permissions:
 * 
 * - For any playerid (including themselves) any of: `notification:playerid:*`, `notification:playerid:read`, `notification:playerid:self:read`, `notification:playerid:self:*`
*/
