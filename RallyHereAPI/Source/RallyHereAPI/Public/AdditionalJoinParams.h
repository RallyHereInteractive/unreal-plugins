...
struct RALLYHEREAPI_API FRHAPI_AdditionalJoinParams : public FRHAPI_Model
{
	...
	*/
	...
	FORCEINLINE TMap<FString, float>& GetDoubleArgs() { return DoubleArgs_Optional; }
	/** @brief Gets the value of DoubleArgs_Optional, regardless of it having been set */
	FORCEINLINE const TMap<FString, float>& GetDoubleArgs() const { return DoubleArgs_Optional; }
	/** @brief Gets the value of DoubleArgs_Optional, if it has been set, otherwise it returns DefaultValue */
	FORCEINLINE const TMap<FString, float>& GetDoubleArgs(const TMap<FString, float>& DefaultValue) const { if (DoubleArgs_IsSet) return DoubleArgs_Optional; return DefaultValue; }
	/** @brief Fills OutValue with the value of DoubleArgs_Optional and returns true if it has been set, otherwise returns false */
	FORCEINLINE bool GetDoubleArgs(TMap<FString, float>& OutValue) const { if (DoubleArgs_IsSet) OutValue = DoubleArgs_Optional; return DoubleArgs_IsSet; }
	/** @brief Returns a pointer to DoubleArgs_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE TMap<FString, float>* GetDoubleArgsOrNull() { if (DoubleArgs_IsSet) return (&DoubleArgs_Optional); return nullptr; }
	/** @brief Returns a pointer to DoubleArgs_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE const TMap<FString, float>* GetDoubleArgsOrNull() const { if (DoubleArgs_IsSet) return (&DoubleArgs_Optional); return nullptr; }
	/** @brief Sets the value of DoubleArgs_Optional and also sets DoubleArgs_IsSet to true */
	FORCEINLINE void SetDoubleArgs(const TMap<FString, float>& NewValue) { DoubleArgs_Optional = NewValue; DoubleArgs_IsSet = true;  }
	/** @brief Sets the value of DoubleArgs_Optional and also sets DoubleArgs_IsSet to true using move semantics */
	FORCEINLINE void SetDoubleArgs(TMap<FString, float>&& NewValue) { DoubleArgs_Optional = NewValue; DoubleArgs_IsSet = true;  }
	...
	FORCEINLINE TMap<FString, FString>& GetStringArgs() { return StringArgs_Optional; }
	/** @brief Gets the value of StringArgs_Optional, regardless of it having been set */
	FORCEINLINE const TMap<FString, FString>& GetStringArgs() const { return StringArgs_Optional; }
	/** @brief Gets the value of StringArgs_Optional, if it has been set, otherwise it returns DefaultValue */
	FORCEINLINE const TMap<FString, FString>& GetStringArgs(const TMap<FString, FString>& DefaultValue) const { if (StringArgs_IsSet) return StringArgs_Optional; return DefaultValue; }
	/** @brief Fills OutValue with the value of StringArgs_Optional and returns true if it has been set, otherwise returns false */
	FORCEINLINE bool GetStringArgs(TMap<FString, FString>& OutValue) const { if (StringArgs_IsSet) OutValue = StringArgs_Optional; return StringArgs_IsSet; }
	/** @brief Returns a pointer to StringArgs_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE TMap<FString, FString>* GetStringArgsOrNull() { if (StringArgs_IsSet) return (&StringArgs_Optional); return nullptr; }
	/** @brief Returns a pointer to StringArgs_Optional, if it has been set, otherwise returns nullptr */
	FORCEINLINE const TMap<FString, FString>* GetStringArgsOrNull() const { if (StringArgs_IsSet) return (&StringArgs_Optional); return nullptr; }
	/** @brief Sets the value of StringArgs_Optional and also sets StringArgs_IsSet to true */
	FORCEINLINE void SetStringArgs(const TMap<FString, FString>& NewValue) { StringArgs_Optional = NewValue; StringArgs_IsSet = true;  }
	/** @brief Sets the value of StringArgs_Optional and also sets StringArgs_IsSet to true using move semantics */
	FORCEINLINE void SetStringArgs(TMap<FString, FString>&& NewValue) { StringArgs_Optional = NewValue; StringArgs_IsSet = true;  }
