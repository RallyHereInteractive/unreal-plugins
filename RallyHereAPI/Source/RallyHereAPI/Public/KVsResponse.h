...
#include "KVsResponse.generated.h"

/** @defgroup RHAPI_KVsResponse RallyHere API Model KVsResponse
 *  @{
 */
...
struct RALLYHEREAPI_API FRHAPI_KVsResponse : public FRHAPI_Model
{
    ...
    */
    ...
    /** @brief Gets the value of Kvs_Optional, regardless of it having been set */
    const TArray<FRHAPI_AppSetting>& GetKvs() const { return Kvs_Optional; }
    /** @brief Gets the value of Kvs_Optional, if it has been set, otherwise it returns DefaultValue */
    const TArray<FRHAPI_AppSetting>& GetKvs(const TArray<FRHAPI_AppSetting>& DefaultValue) const { if (Kvs_IsSet) return Kvs_Optional; return DefaultValue; }
    /** @brief Fills OutValue with the value of Kvs_Optional and returns true if it has been set, otherwise returns false */
    bool GetKvs(TArray<FRHAPI_AppSetting>& OutValue) const { if (Kvs_IsSet) OutValue = Kvs_Optional; return Kvs_IsSet; }
    /** @brief Returns a pointer to Kvs_Optional, if it has been set, otherwise returns nullptr */
    TArray<FRHAPI_AppSetting>* GetKvsOrNull() { if (Kvs_IsSet) return &Kvs_Optional; return nullptr; }
    /** @brief Returns a pointer to Kvs_Optional, if it has been set, otherwise returns nullptr */
    const TArray<FRHAPI_AppSetting>* GetKvsOrNull() const { if (Kvs_IsSet) return &Kvs_Optional; return nullptr; }
    /** @brief Sets the value of Kvs_Optional and also sets Kvs_IsSet to true */
    void SetKvs(TArray<FRHAPI_AppSetting> NewValue) { Kvs_Optional = NewValue; Kvs_IsSet = true; }
    ...
    /** @brief Gets the value of SecretKvs_Optional, regardless of it having been set */
    const TArray<FRHAPI_AppSetting>& GetSecretKvs() const { return SecretKvs_Optional; }
    /** @brief Gets the value of SecretKvs_Optional, if it has been set, otherwise it returns DefaultValue */
    const TArray<FRHAPI_AppSetting>& GetSecretKvs(const TArray<FRHAPI_AppSetting>& DefaultValue) const { if (SecretKvs_IsSet) return SecretKvs_Optional; return DefaultValue; }
    /** @brief Fills OutValue with the value of SecretKvs_Optional and returns true if it has been set, otherwise returns false */
    bool GetSecretKvs(TArray<FRHAPI_AppSetting>& OutValue) const { if (SecretKvs_IsSet) OutValue = SecretKvs_Optional; return SecretKvs_IsSet; }
    /** @brief Returns a pointer to SecretKvs_Optional, if it has been set, otherwise returns nullptr */
    TArray<FRHAPI_AppSetting>* GetSecretKvsOrNull() { if (SecretKvs_IsSet) return &SecretKvs_Optional; return nullptr; }
    /** @brief Returns a pointer to SecretKvs_Optional, if it has been set, otherwise returns nullptr */
    const TArray<FRHAPI_AppSetting>* GetSecretKvsOrNull() const { if (SecretKvs_IsSet) return &SecretKvs_Optional; return nullptr; }
    /** @brief Sets the value of SecretKvs_Optional and also sets SecretKvs_IsSet to true */
    void SetSecretKvs(TArray<FRHAPI_AppSetting> NewValue) { SecretKvs_Optional = NewValue; SecretKvs_IsSet = true; }
