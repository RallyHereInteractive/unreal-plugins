...
////////////////////////////////////////////////////
// Implementation for FRHAPI_DevNintendoSingleEnv

void FRHAPI_DevNintendoSingleEnv::WriteJson(TSharedRef<TJsonWriter<>>& Writer) const
{
    ...
    Writer->WriteIdentifierPrefix(TEXT("auth_key"));
    RallyHereDeveloperAPI::WriteJsonValue(Writer, AuthKey);
    Writer->WriteObjectEnd();
}

bool FRHAPI_DevNintendoSingleEnv::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
    ...
    const TSharedPtr<FJsonValue> JsonAuthKeyField = (*Object)->TryGetField(TEXT("auth_key"));
    ParseSuccess &= JsonAuthKeyField.IsValid() && !JsonAuthKeyField->IsNull() && TryGetJsonValue(JsonAuthKeyField, AuthKey);
