...
////////////////////////////////////////////////////
// Implementation for FRHAPI_DevAmazonConfig

void FRHAPI_DevAmazonConfig::WriteJson(TSharedRef<TJsonWriter<>>& Writer) const
{
...
bool FRHAPI_DevAmazonConfig::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
