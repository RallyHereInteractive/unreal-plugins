...
////////////////////////////////////////////////////
// Implementation for FRHAPI_DevMachineClass

void FRHAPI_DevMachineClass::WriteJson(TSharedRef<TJsonWriter<>>& Writer) const
{
    Writer->WriteObjectStart();
    Writer->WriteIdentifierPrefix(TEXT("datacenter_provider"));
    RallyHereDeveloperAPI::WriteJsonValue(Writer, DatacenterProvider);
...
bool FRHAPI_DevMachineClass::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
    ...
    ParseSuccess &= JsonDatacenterProviderField.IsValid() && !JsonDatacenterProviderField->IsNull() && TryGetJsonValue(JsonDatacenterProviderField, DatacenterProvider);
