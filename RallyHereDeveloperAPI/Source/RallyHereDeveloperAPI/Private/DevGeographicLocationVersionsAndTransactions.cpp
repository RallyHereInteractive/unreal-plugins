...
////////////////////////////////////////////////////
// Implementation for FRHAPI_DevGeographicLocationVersionsAndTransactions

void FRHAPI_DevGeographicLocationVersionsAndTransactions::WriteJson(TSharedRef<TJsonWriter<>>& Writer) const
{
...
bool FRHAPI_DevGeographicLocationVersionsAndTransactions::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
