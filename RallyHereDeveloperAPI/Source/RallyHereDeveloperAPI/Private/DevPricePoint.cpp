...
////////////////////////////////////////////////////
// Implementation for FRHAPI_DevPricePoint

void FRHAPI_DevPricePoint::WriteJson(TSharedRef<TJsonWriter<>>& Writer) const
{
    ...
    if (PricePointId_IsSet)
    {
        Writer->WriteIdentifierPrefix(TEXT("price_point_id"));
        RallyHereDeveloperAPI::WriteJsonValue(Writer, PricePointId_Optional);
    }
    Writer->WriteObjectEnd();
}

bool FRHAPI_DevPricePoint::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
    ...
    const TSharedPtr<FJsonValue> JsonPricePointIdField = (*Object)->TryGetField(TEXT("price_point_id"));
    if (JsonPricePointIdField.IsValid() && !JsonPricePointIdField->IsNull())
    {
        PricePointId_IsSet = TryGetJsonValue(JsonPricePointIdField, PricePointId_Optional);
        ParseSuccess &= PricePointId_IsSet;
    }
