...
////////////////////////////////////////////////////
// Implementation for FRHAPI_DevHostUpdate

void FRHAPI_DevHostUpdate::WriteJson(TSharedRef<TJsonWriter<>>& Writer) const
{
    ...
    if (GeographicLocationId_IsSet)
    {
        Writer->WriteIdentifierPrefix(TEXT("geographic_location_id"));
        RallyHereDeveloperAPI::WriteJsonValue(Writer, GeographicLocationId_Optional);
    }
    if (DatacenterLocationId_IsSet)
    {
        Writer->WriteIdentifierPrefix(TEXT("datacenter_location_id"));
        RallyHereDeveloperAPI::WriteJsonValue(Writer, DatacenterLocationId_Optional);
    }
    if (MachineClassId_IsSet)
    {
        Writer->WriteIdentifierPrefix(TEXT("machine_class_id"));
        RallyHereDeveloperAPI::WriteJsonValue(Writer, MachineClassId_Optional);
    }
    if (MachineClassOverridesId_IsSet)
    {
        Writer->WriteIdentifierPrefix(TEXT("machine_class_overrides_id"));
        RallyHereDeveloperAPI::WriteJsonValue(Writer, MachineClassOverridesId_Optional);
    }
    if (MachineImageId_IsSet)
    {
        Writer->WriteIdentifierPrefix(TEXT("machine_image_id"));
        RallyHereDeveloperAPI::WriteJsonValue(Writer, MachineImageId_Optional);
    }
    if (DatacenterContractId_IsSet)
    {
        Writer->WriteIdentifierPrefix(TEXT("datacenter_contract_id"));
        RallyHereDeveloperAPI::WriteJsonValue(Writer, DatacenterContractId_Optional);
    }
    Writer->WriteObjectEnd();
}

bool FRHAPI_DevHostUpdate::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
    ...
    if (JsonGeographicLocationIdField.IsValid() && !JsonGeographicLocationIdField->IsNull())
    {
        GeographicLocationId_IsSet = TryGetJsonValue(JsonGeographicLocationIdField, GeographicLocationId_Optional);
        ParseSuccess &= GeographicLocationId_IsSet;
    }
    const TSharedPtr<FJsonValue> JsonDatacenterLocationIdField = (*Object)->TryGetField(TEXT("datacenter_location_id"));
    if (JsonDatacenterLocationIdField.IsValid() && !JsonDatacenterLocationIdField->IsNull())
    {
        DatacenterLocationId_IsSet = TryGetJsonValue(JsonDatacenterLocationIdField, DatacenterLocationId_Optional);
        ParseSuccess &= DatacenterLocationId_IsSet;
    }
    const TSharedPtr<FJsonValue> JsonMachineClassIdField = (*Object)->TryGetField(TEXT("machine_class_id"));
    if (JsonMachineClassIdField.IsValid() && !JsonMachineClassIdField->IsNull())
    {
        MachineClassId_IsSet = TryGetJsonValue(JsonMachineClassIdField, MachineClassId_Optional);
        ParseSuccess &= MachineClassId_IsSet;
    }
    const TSharedPtr<FJsonValue> JsonMachineClassOverridesIdField = (*Object)->TryGetField(TEXT("machine_class_overrides_id"));
    if (JsonMachineClassOverridesIdField.IsValid() && !JsonMachineClassOverridesIdField->IsNull())
    {
        MachineClassOverridesId_IsSet = TryGetJsonValue(JsonMachineClassOverridesIdField, MachineClassOverridesId_Optional);
        ParseSuccess &= MachineClassOverridesId_IsSet;
    }
    const TSharedPtr<FJsonValue> JsonMachineImageIdField = (*Object)->TryGetField(TEXT("machine_image_id"));
    if (JsonMachineImageIdField.IsValid() && !JsonMachineImageIdField->IsNull())
    {
        MachineImageId_IsSet = TryGetJsonValue(JsonMachineImageIdField, MachineImageId_Optional);
        ParseSuccess &= MachineImageId_IsSet;
    }
    const TSharedPtr<FJsonValue> JsonDatacenterContractIdField = (*Object)->TryGetField(TEXT("datacenter_contract_id"));
    if (JsonDatacenterContractIdField.IsValid() && !JsonDatacenterContractIdField->IsNull())
    {
        DatacenterContractId_IsSet = TryGetJsonValue(JsonDatacenterContractIdField, DatacenterContractId_Optional);
        ParseSuccess &= DatacenterContractId_IsSet;
    }
