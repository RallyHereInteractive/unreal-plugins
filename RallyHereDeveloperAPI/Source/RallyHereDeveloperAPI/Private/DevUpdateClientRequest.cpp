...
////////////////////////////////////////////////////
// Implementation for FRHAPI_DevUpdateClientRequest

void FRHAPI_DevUpdateClientRequest::WriteJson(TSharedRef<TJsonWriter<>>& Writer) const
{
    ...
    if (RotateSecret_IsSet)
    {
        Writer->WriteIdentifierPrefix(TEXT("rotate_secret"));
        RallyHereDeveloperAPI::WriteJsonValue(Writer, RotateSecret_Optional);
    }
    Writer->WriteObjectEnd();
}

bool FRHAPI_DevUpdateClientRequest::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
    ...
    const TSharedPtr<FJsonValue> JsonRotateSecretField = (*Object)->TryGetField(TEXT("rotate_secret"));
    if (JsonRotateSecretField.IsValid() && !JsonRotateSecretField->IsNull())
    {
        RotateSecret_IsSet = TryGetJsonValue(JsonRotateSecretField, RotateSecret_Optional);
        ParseSuccess &= RotateSecret_IsSet;
    }
