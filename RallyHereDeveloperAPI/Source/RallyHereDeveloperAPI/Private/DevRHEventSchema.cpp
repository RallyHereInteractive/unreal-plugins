...
////////////////////////////////////////////////////
// Implementation for FRHAPI_DevRHEventSchema

void FRHAPI_DevRHEventSchema::WriteJson(TSharedRef<TJsonWriter<>>& Writer) const
{
...
bool FRHAPI_DevRHEventSchema::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
