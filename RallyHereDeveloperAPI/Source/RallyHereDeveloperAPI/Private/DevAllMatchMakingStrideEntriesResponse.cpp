...
////////////////////////////////////////////////////
// Implementation for FRHAPI_DevAllMatchMakingStrideEntriesResponse

void FRHAPI_DevAllMatchMakingStrideEntriesResponse::WriteJson(TSharedRef<TJsonWriter<>>& Writer) const
{
    ...
    RallyHereDeveloperAPI::WriteJsonValue(Writer, Entries);
    Writer->WriteObjectEnd();
}

bool FRHAPI_DevAllMatchMakingStrideEntriesResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
