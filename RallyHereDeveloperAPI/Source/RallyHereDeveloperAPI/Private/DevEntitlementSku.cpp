...
////////////////////////////////////////////////////
// Implementation for FRHAPI_DevEntitlementSku

void FRHAPI_DevEntitlementSku::WriteJson(TSharedRef<TJsonWriter<>>& Writer) const
{
    ...
    Writer->WriteIdentifierPrefix(TEXT("entitlement_sku_id"));
    RallyHereDeveloperAPI::WriteJsonValue(Writer, EntitlementSkuId);
    Writer->WriteObjectEnd();
}

bool FRHAPI_DevEntitlementSku::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
    ...
    const TSharedPtr<FJsonValue> JsonEntitlementSkuIdField = (*Object)->TryGetField(TEXT("entitlement_sku_id"));
    ParseSuccess &= JsonEntitlementSkuIdField.IsValid() && !JsonEntitlementSkuIdField->IsNull() && TryGetJsonValue(JsonEntitlementSkuIdField, EntitlementSkuId);
