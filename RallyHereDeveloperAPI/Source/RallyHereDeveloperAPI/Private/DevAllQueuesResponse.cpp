...
////////////////////////////////////////////////////
// Implementation for FRHAPI_DevAllQueuesResponse

void FRHAPI_DevAllQueuesResponse::WriteJson(TSharedRef<TJsonWriter<>>& Writer) const
{
    ...
    RallyHereDeveloperAPI::WriteJsonValue(Writer, Queues);
    Writer->WriteObjectEnd();
}

bool FRHAPI_DevAllQueuesResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
