...
////////////////////////////////////////////////////
// Implementation for FRHAPI_DevProduct

void FRHAPI_DevProduct::WriteJson(TSharedRef<TJsonWriter<>>& Writer) const
{
...
bool FRHAPI_DevProduct::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
