...
#include "DevMatchMakingRuleSetFlattened.generated.h"

/** @defgroup RHAPI_DevMatchMakingRuleSetFlattened RallyHere API Model DevMatchMakingRuleSetFlattened
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevMatchMakingRuleSetFlattened : public FRHAPI_DevModel
{
    GENERATED_BODY()
