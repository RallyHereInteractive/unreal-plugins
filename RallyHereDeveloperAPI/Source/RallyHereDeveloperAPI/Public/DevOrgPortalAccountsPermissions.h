...
#include "DevOrgPortalAccountsPermissions.generated.h"

/** @defgroup RHAPI_DevOrgPortalAccountsPermissions RallyHere API Model DevOrgPortalAccountsPermissions
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevOrgPortalAccountsPermissions : public FRHAPI_DevModel
{
    GENERATED_BODY()
