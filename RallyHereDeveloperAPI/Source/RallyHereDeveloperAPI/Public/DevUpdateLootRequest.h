...
#include "DevUpdateLootRequest.generated.h"

/** @defgroup RHAPI_DevUpdateLootRequest RallyHere API Model DevUpdateLootRequest
 *  @{
 */

/**
 * @brief Update an existing Loot entity.
 */
USTRUCT(BlueprintType)
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevUpdateLootRequest : public FRHAPI_DevModel
{
    GENERATED_BODY()
