...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevMatchMakingStrideEntry : public FRHAPI_DevModel
{
    ...
    */
    ...
    /** @brief Gets the value of MatchMakingStrideEntryId */
    FGuid& GetMatchMakingStrideEntryId() { return MatchMakingStrideEntryId; }
    /** @brief Gets the value of MatchMakingStrideEntryId */
    const FGuid& GetMatchMakingStrideEntryId() const { return MatchMakingStrideEntryId; }
    /** @brief Sets the value of MatchMakingStrideEntryId */
    void SetMatchMakingStrideEntryId(FGuid NewValue) { MatchMakingStrideEntryId = NewValue;  }
};
