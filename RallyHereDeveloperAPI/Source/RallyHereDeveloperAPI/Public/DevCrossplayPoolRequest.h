...
#include "DevCrossplayPoolRequest.generated.h"

/** @defgroup RHAPI_DevCrossplayPoolRequest RallyHere API Model DevCrossplayPoolRequest
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevCrossplayPoolRequest : public FRHAPI_DevModel
{
    GENERATED_BODY()
