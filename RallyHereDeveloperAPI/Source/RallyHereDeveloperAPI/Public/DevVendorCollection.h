...
#include "DevVendor.h"
#include "DevVendorCollection.generated.h"

/** @defgroup RHAPI_DevVendorCollection RallyHere API Model DevVendorCollection
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevVendorCollection : public FRHAPI_DevModel
{
    GENERATED_BODY()
    ...
    */
    ...
    /** @brief The Vendors. */
    TArray<FRHAPI_DevVendor> Data_Optional{  };
    ...
    TArray<FRHAPI_DevVendor>& GetData() { return Data_Optional; }
    /** @brief Gets the value of Data_Optional, regardless of it having been set */
    const TArray<FRHAPI_DevVendor>& GetData() const { return Data_Optional; }
    /** @brief Gets the value of Data_Optional, if it has been set, otherwise it returns DefaultValue */
    const TArray<FRHAPI_DevVendor>& GetData(const TArray<FRHAPI_DevVendor>& DefaultValue) const { if (Data_IsSet) return Data_Optional; return DefaultValue; }
    /** @brief Fills OutValue with the value of Data_Optional and returns true if it has been set, otherwise returns false */
    bool GetData(TArray<FRHAPI_DevVendor>& OutValue) const { if (Data_IsSet) OutValue = Data_Optional; return Data_IsSet; }
    /** @brief Returns a pointer to Data_Optional, if it has been set, otherwise returns nullptr */
    TArray<FRHAPI_DevVendor>* GetDataOrNull() { if (Data_IsSet) return &Data_Optional; return nullptr; }
    /** @brief Returns a pointer to Data_Optional, if it has been set, otherwise returns nullptr */
    const TArray<FRHAPI_DevVendor>* GetDataOrNull() const { if (Data_IsSet) return &Data_Optional; return nullptr; }
    /** @brief Sets the value of Data_Optional and also sets Data_IsSet to true */
    void SetData(TArray<FRHAPI_DevVendor> NewValue) { Data_Optional = NewValue; Data_IsSet = true; }
