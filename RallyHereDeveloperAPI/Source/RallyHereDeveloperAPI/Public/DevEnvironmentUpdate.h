...
#include "DevEnvironmentUpdate.generated.h"

/** @defgroup RHAPI_DevEnvironmentUpdate RallyHere API Model DevEnvironmentUpdate
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevEnvironmentUpdate : public FRHAPI_DevModel
{
    GENERATED_BODY()
