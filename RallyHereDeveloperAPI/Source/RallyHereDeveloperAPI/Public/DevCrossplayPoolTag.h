...
#include "DevCrossplayPoolTag.generated.h"

/** @defgroup RHAPI_DevCrossplayPoolTag RallyHere API Model DevCrossplayPoolTag
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevCrossplayPoolTag : public FRHAPI_DevModel
{
    GENERATED_BODY()
    ...
    */
    ...
    /** @brief ID to uniquely identify this CrossplayPoolTag */
    FGuid CrossplayPoolTagId{  };
    /** @brief Gets the value of CrossplayPoolTagId */
    FGuid& GetCrossplayPoolTagId() { return CrossplayPoolTagId; }
    /** @brief Gets the value of CrossplayPoolTagId */
    const FGuid& GetCrossplayPoolTagId() const { return CrossplayPoolTagId; }
    /** @brief Sets the value of CrossplayPoolTagId */
    void SetCrossplayPoolTagId(FGuid NewValue) { CrossplayPoolTagId = NewValue;  }
};
