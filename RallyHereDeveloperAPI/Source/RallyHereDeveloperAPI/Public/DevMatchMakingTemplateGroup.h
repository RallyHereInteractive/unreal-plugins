...
#include "DevMatchMakingTemplateGroup.generated.h"

/** @defgroup RHAPI_DevMatchMakingTemplateGroup RallyHere API Model DevMatchMakingTemplateGroup
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevMatchMakingTemplateGroup : public FRHAPI_DevModel
{
    GENERATED_BODY()
