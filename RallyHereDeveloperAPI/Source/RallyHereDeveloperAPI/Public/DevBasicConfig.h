...
#include "DevBasicConfig.generated.h"

/** @defgroup RHAPI_DevBasicConfig RallyHere API Model DevBasicConfig
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevBasicConfig : public FRHAPI_DevModel
{
    GENERATED_BODY()
    ...
    */
    ...
    /** @brief Whether or not to enable basic logins */
