...
#include "DevMapSelectionListFlattened.generated.h"

/** @defgroup RHAPI_DevMapSelectionListFlattened RallyHere API Model DevMapSelectionListFlattened
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevMapSelectionListFlattened : public FRHAPI_DevModel
{
    GENERATED_BODY()
    ...
    */
    ...
    TArray<FRHAPI_DevMapSelectionListEntryFlattened> Maps_Optional{  };
    ...
    TArray<FRHAPI_DevMapSelectionListEntryFlattened>& GetMaps() { return Maps_Optional; }
    /** @brief Gets the value of Maps_Optional, regardless of it having been set */
    const TArray<FRHAPI_DevMapSelectionListEntryFlattened>& GetMaps() const { return Maps_Optional; }
    /** @brief Gets the value of Maps_Optional, if it has been set, otherwise it returns DefaultValue */
    const TArray<FRHAPI_DevMapSelectionListEntryFlattened>& GetMaps(const TArray<FRHAPI_DevMapSelectionListEntryFlattened>& DefaultValue) const { if (Maps_IsSet) return Maps_Optional; return DefaultValue; }
    /** @brief Fills OutValue with the value of Maps_Optional and returns true if it has been set, otherwise returns false */
    bool GetMaps(TArray<FRHAPI_DevMapSelectionListEntryFlattened>& OutValue) const { if (Maps_IsSet) OutValue = Maps_Optional; return Maps_IsSet; }
    /** @brief Returns a pointer to Maps_Optional, if it has been set, otherwise returns nullptr */
    TArray<FRHAPI_DevMapSelectionListEntryFlattened>* GetMapsOrNull() { if (Maps_IsSet) return &Maps_Optional; return nullptr; }
    /** @brief Returns a pointer to Maps_Optional, if it has been set, otherwise returns nullptr */
    const TArray<FRHAPI_DevMapSelectionListEntryFlattened>* GetMapsOrNull() const { if (Maps_IsSet) return &Maps_Optional; return nullptr; }
    /** @brief Sets the value of Maps_Optional and also sets Maps_IsSet to true */
    void SetMaps(TArray<FRHAPI_DevMapSelectionListEntryFlattened> NewValue) { Maps_Optional = NewValue; Maps_IsSet = true; }
