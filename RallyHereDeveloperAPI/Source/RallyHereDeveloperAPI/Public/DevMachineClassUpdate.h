...
#include "DevMachineClassUpdate.generated.h"

/** @defgroup RHAPI_DevMachineClassUpdate RallyHere API Model DevMachineClassUpdate
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevMachineClassUpdate : public FRHAPI_DevModel
{
    GENERATED_BODY()
