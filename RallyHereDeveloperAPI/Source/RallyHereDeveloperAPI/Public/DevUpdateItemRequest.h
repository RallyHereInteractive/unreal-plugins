...
#include "DevUpdateItemRequest.generated.h"

/** @defgroup RHAPI_DevUpdateItemRequest RallyHere API Model DevUpdateItemRequest
 *  @{
 */

/**
 * @brief Update an existing Item entity.
 */
USTRUCT(BlueprintType)
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevUpdateItemRequest : public FRHAPI_DevModel
{
    GENERATED_BODY()
