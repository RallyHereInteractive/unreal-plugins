...
#include "DevItemCollection.generated.h"

/** @defgroup RHAPI_DevItemCollection RallyHere API Model DevItemCollection
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevItemCollection : public FRHAPI_DevModel
{
    GENERATED_BODY()
    ...
    */
    ...
    /** @brief The Items. */
    TArray<FRHAPI_DevItem> Data_Optional{  };
    ...
    TArray<FRHAPI_DevItem>& GetData() { return Data_Optional; }
    /** @brief Gets the value of Data_Optional, regardless of it having been set */
    const TArray<FRHAPI_DevItem>& GetData() const { return Data_Optional; }
    /** @brief Gets the value of Data_Optional, if it has been set, otherwise it returns DefaultValue */
    const TArray<FRHAPI_DevItem>& GetData(const TArray<FRHAPI_DevItem>& DefaultValue) const { if (Data_IsSet) return Data_Optional; return DefaultValue; }
    /** @brief Fills OutValue with the value of Data_Optional and returns true if it has been set, otherwise returns false */
    bool GetData(TArray<FRHAPI_DevItem>& OutValue) const { if (Data_IsSet) OutValue = Data_Optional; return Data_IsSet; }
    /** @brief Returns a pointer to Data_Optional, if it has been set, otherwise returns nullptr */
    TArray<FRHAPI_DevItem>* GetDataOrNull() { if (Data_IsSet) return &Data_Optional; return nullptr; }
    /** @brief Returns a pointer to Data_Optional, if it has been set, otherwise returns nullptr */
    const TArray<FRHAPI_DevItem>* GetDataOrNull() const { if (Data_IsSet) return &Data_Optional; return nullptr; }
    /** @brief Sets the value of Data_Optional and also sets Data_IsSet to true */
    void SetData(TArray<FRHAPI_DevItem> NewValue) { Data_Optional = NewValue; Data_IsSet = true; }
