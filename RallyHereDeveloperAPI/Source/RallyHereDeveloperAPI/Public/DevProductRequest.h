...
#include "DevProductRequest.generated.h"

/** @defgroup RHAPI_DevProductRequest RallyHere API Model DevProductRequest
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevProductRequest : public FRHAPI_DevModel
{
    GENERATED_BODY()
