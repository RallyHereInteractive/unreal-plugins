...
#include "DevXpQuantityTransform.generated.h"
 ...
 */
UENUM(BlueprintType)
enum class ERHAPI_DevXpQuantityTransform : uint8
{
...
RALLYHEREDEVELOPERAPI_API FString EnumToString(const ERHAPI_DevXpQuantityTransform& EnumValue);
RALLYHEREDEVELOPERAPI_API bool EnumFromString(const FString& EnumAsString, ERHAPI_DevXpQuantityTransform& EnumValue);
RALLYHEREDEVELOPERAPI_API FStringFormatArg ToStringFormatArg(const ERHAPI_DevXpQuantityTransform& Value);
RALLYHEREDEVELOPERAPI_API void WriteJsonValue(TSharedRef<TJsonWriter<>>& Writer, const ERHAPI_DevXpQuantityTransform& Value);
RALLYHEREDEVELOPERAPI_API bool TryGetJsonValue(const TSharedPtr<FJsonValue>& JsonValue, ERHAPI_DevXpQuantityTransform& Value);
