...
#include "DevPatchExternalKeyCampaign.generated.h"

/** @defgroup RHAPI_DevPatchExternalKeyCampaign RallyHere API Model DevPatchExternalKeyCampaign
 *  @{
 */

/**
 * @brief External Key Campaign to patch. Any fields not included in the request or set to null will not be updated.
 */
USTRUCT(BlueprintType)
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevPatchExternalKeyCampaign : public FRHAPI_DevModel
{
    GENERATED_BODY()
