...
#include "DevOrganizationUpdateRequest.generated.h"

/** @defgroup RHAPI_DevOrganizationUpdateRequest RallyHere API Model DevOrganizationUpdateRequest
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevOrganizationUpdateRequest : public FRHAPI_DevModel
{
    GENERATED_BODY()
