...
#include "DevSessionTemplate.generated.h"

/** @defgroup RHAPI_DevSessionTemplate RallyHere API Model DevSessionTemplate
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevSessionTemplate : public FRHAPI_DevModel
{
    GENERATED_BODY()
    ...
    */
    ...
    /** @brief UUID to identify this specific session template */
    ...
    /** @brief List of PlatformSessionTemplates that belong to this session type */
    TArray<FRHAPI_DevPlatformSessionTemplate> PlatformSessionTemplates_Optional{  };
    /** @brief true if PlatformSessionTemplates_Optional has been set to a value */
    bool PlatformSessionTemplates_IsSet{ false };
    /** @brief Gets the value of PlatformSessionTemplates_Optional, regardless of it having been set */
    TArray<FRHAPI_DevPlatformSessionTemplate>& GetPlatformSessionTemplates() { return PlatformSessionTemplates_Optional; }
    /** @brief Gets the value of PlatformSessionTemplates_Optional, regardless of it having been set */
    const TArray<FRHAPI_DevPlatformSessionTemplate>& GetPlatformSessionTemplates() const { return PlatformSessionTemplates_Optional; }
    /** @brief Gets the value of PlatformSessionTemplates_Optional, if it has been set, otherwise it returns DefaultValue */
    const TArray<FRHAPI_DevPlatformSessionTemplate>& GetPlatformSessionTemplates(const TArray<FRHAPI_DevPlatformSessionTemplate>& DefaultValue) const { if (PlatformSessionTemplates_IsSet) return PlatformSessionTemplates_Optional; return DefaultValue; }
    /** @brief Fills OutValue with the value of PlatformSessionTemplates_Optional and returns true if it has been set, otherwise returns false */
    bool GetPlatformSessionTemplates(TArray<FRHAPI_DevPlatformSessionTemplate>& OutValue) const { if (PlatformSessionTemplates_IsSet) OutValue = PlatformSessionTemplates_Optional; return PlatformSessionTemplates_IsSet; }
    /** @brief Returns a pointer to PlatformSessionTemplates_Optional, if it has been set, otherwise returns nullptr */
    TArray<FRHAPI_DevPlatformSessionTemplate>* GetPlatformSessionTemplatesOrNull() { if (PlatformSessionTemplates_IsSet) return &PlatformSessionTemplates_Optional; return nullptr; }
    /** @brief Returns a pointer to PlatformSessionTemplates_Optional, if it has been set, otherwise returns nullptr */
    const TArray<FRHAPI_DevPlatformSessionTemplate>* GetPlatformSessionTemplatesOrNull() const { if (PlatformSessionTemplates_IsSet) return &PlatformSessionTemplates_Optional; return nullptr; }
    /** @brief Sets the value of PlatformSessionTemplates_Optional and also sets PlatformSessionTemplates_IsSet to true */
    void SetPlatformSessionTemplates(TArray<FRHAPI_DevPlatformSessionTemplate> NewValue) { PlatformSessionTemplates_Optional = NewValue; PlatformSessionTemplates_IsSet = true; }
     /** @brief Clears the value of PlatformSessionTemplates_Optional and sets PlatformSessionTemplates_IsSet to false */
    void ClearPlatformSessionTemplates() { PlatformSessionTemplates_IsSet = false; }
