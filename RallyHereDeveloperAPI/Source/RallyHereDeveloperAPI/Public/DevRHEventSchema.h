...
#include "DevRHEventSchema.generated.h"

/** @defgroup RHAPI_DevRHEventSchema RallyHere API Model DevRHEventSchema
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevRHEventSchema : public FRHAPI_DevModel
{
    GENERATED_BODY()
