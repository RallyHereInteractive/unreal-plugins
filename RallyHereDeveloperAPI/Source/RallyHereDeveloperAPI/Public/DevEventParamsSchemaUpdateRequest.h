...
#include "DevEventParamsSchemaUpdateRequest.generated.h"

/** @defgroup RHAPI_DevEventParamsSchemaUpdateRequest RallyHere API Model DevEventParamsSchemaUpdateRequest
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevEventParamsSchemaUpdateRequest : public FRHAPI_DevModel
{
    GENERATED_BODY()
    ...
    */
    ...
    /** @brief Whether this custom event is enabled */
