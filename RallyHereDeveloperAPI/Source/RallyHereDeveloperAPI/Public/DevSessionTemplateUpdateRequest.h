...
#include "DevSessionTemplateUpdateRequest.generated.h"

/** @defgroup RHAPI_DevSessionTemplateUpdateRequest RallyHere API Model DevSessionTemplateUpdateRequest
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevSessionTemplateUpdateRequest : public FRHAPI_DevModel
{
    GENERATED_BODY()
    ...
    */
    ...
    void ClearEngineSessionType() { EngineSessionType_IsSet = false; }
