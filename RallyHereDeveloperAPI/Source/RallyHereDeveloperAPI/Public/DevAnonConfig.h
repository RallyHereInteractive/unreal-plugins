...
#include "DevAnonConfig.generated.h"

/** @defgroup RHAPI_DevAnonConfig RallyHere API Model DevAnonConfig
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevAnonConfig : public FRHAPI_DevModel
{
    GENERATED_BODY()
    ...
    */
    ...
    /** @brief Whether or not to enable anonymous login */
