...
#include "DevLegacyConfig.generated.h"

/** @defgroup RHAPI_DevLegacyConfig RallyHere API Model DevLegacyConfig
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevLegacyConfig : public FRHAPI_DevModel
{
    GENERATED_BODY()
