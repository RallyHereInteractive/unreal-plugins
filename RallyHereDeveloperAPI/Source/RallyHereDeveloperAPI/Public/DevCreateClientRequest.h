...
#include "DevCreateClientRequest.generated.h"

/** @defgroup RHAPI_DevCreateClientRequest RallyHere API Model DevCreateClientRequest
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevCreateClientRequest : public FRHAPI_DevModel
{
    GENERATED_BODY()
