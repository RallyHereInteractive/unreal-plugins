...
#include "DevGeneralConfigCreateUpdate.generated.h"

/** @defgroup RHAPI_DevGeneralConfigCreateUpdate RallyHere API Model DevGeneralConfigCreateUpdate
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevGeneralConfigCreateUpdate : public FRHAPI_DevModel
{
    GENERATED_BODY()
