...
#include "DevMachineImageCreate.generated.h"

/** @defgroup RHAPI_DevMachineImageCreate RallyHere API Model DevMachineImageCreate
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevMachineImageCreate : public FRHAPI_DevModel
{
    GENERATED_BODY()
