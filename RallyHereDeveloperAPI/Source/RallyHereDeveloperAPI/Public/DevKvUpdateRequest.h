...
#include "DevKvUpdateRequest.generated.h"

/** @defgroup RHAPI_DevKvUpdateRequest RallyHere API Model DevKvUpdateRequest
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevKvUpdateRequest : public FRHAPI_DevModel
{
    GENERATED_BODY()
