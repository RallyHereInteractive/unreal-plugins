...
#include "DevUpdatePricePoint.generated.h"

/** @defgroup RHAPI_DevUpdatePricePoint RallyHere API Model DevUpdatePricePoint
 *  @{
 */

/**
 * @brief Price Point to update.
 */
USTRUCT(BlueprintType)
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevUpdatePricePoint : public FRHAPI_DevModel
{
    GENERATED_BODY()
