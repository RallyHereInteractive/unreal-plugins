...
#include "DevEnvironmentCreate.generated.h"

/** @defgroup RHAPI_DevEnvironmentCreate RallyHere API Model DevEnvironmentCreate
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevEnvironmentCreate : public FRHAPI_DevModel
{
    GENERATED_BODY()
