...
#include "DevCreateLootWithVendorRequest.generated.h"

/** @defgroup RHAPI_DevCreateLootWithVendorRequest RallyHere API Model DevCreateLootWithVendorRequest
 *  @{
 */

/**
 * @brief Create an existing Loot entity while creating a Vendor
 */
USTRUCT(BlueprintType)
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevCreateLootWithVendorRequest : public FRHAPI_DevModel
{
    GENERATED_BODY()
