...
#include "DevCreateLootRequest.generated.h"

/** @defgroup RHAPI_DevCreateLootRequest RallyHere API Model DevCreateLootRequest
 *  @{
 */

/**
 * @brief Create a new Loot entity.
 */
USTRUCT(BlueprintType)
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevCreateLootRequest : public FRHAPI_DevModel
{
    GENERATED_BODY()
