...
#include "DevSimpleProductAssignmentCreate.generated.h"

/** @defgroup RHAPI_DevSimpleProductAssignmentCreate RallyHere API Model DevSimpleProductAssignmentCreate
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevSimpleProductAssignmentCreate : public FRHAPI_DevModel
{
    GENERATED_BODY()
