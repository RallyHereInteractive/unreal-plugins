...
#include "DevAccountOrganizationCreateRequest.generated.h"

/** @defgroup RHAPI_DevAccountOrganizationCreateRequest RallyHere API Model DevAccountOrganizationCreateRequest
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevAccountOrganizationCreateRequest : public FRHAPI_DevModel
{
    GENERATED_BODY()
