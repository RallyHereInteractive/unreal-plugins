...
#include "DevMachineClassLabelCreate.generated.h"

/** @defgroup RHAPI_DevMachineClassLabelCreate RallyHere API Model DevMachineClassLabelCreate
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevMachineClassLabelCreate : public FRHAPI_DevModel
{
    GENERATED_BODY()
