...
#include "DevMap.h"
#include "DevMapSelectionListEntryFlattened.generated.h"

/** @defgroup RHAPI_DevMapSelectionListEntryFlattened RallyHere API Model DevMapSelectionListEntryFlattened
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevMapSelectionListEntryFlattened : public FRHAPI_DevModel
{
    GENERATED_BODY()
    ...
    */
    ...
    FRHAPI_DevMap& GetMap() { return Map_Optional; }
    /** @brief Gets the value of Map_Optional, regardless of it having been set */
    const FRHAPI_DevMap& GetMap() const { return Map_Optional; }
    /** @brief Gets the value of Map_Optional, if it has been set, otherwise it returns DefaultValue */
    const FRHAPI_DevMap& GetMap(const FRHAPI_DevMap& DefaultValue) const { if (Map_IsSet) return Map_Optional; return DefaultValue; }
    /** @brief Fills OutValue with the value of Map_Optional and returns true if it has been set, otherwise returns false */
    bool GetMap(FRHAPI_DevMap& OutValue) const { if (Map_IsSet) OutValue = Map_Optional; return Map_IsSet; }
    /** @brief Returns a pointer to Map_Optional, if it has been set, otherwise returns nullptr */
    FRHAPI_DevMap* GetMapOrNull() { if (Map_IsSet) return &Map_Optional; return nullptr; }
    /** @brief Returns a pointer to Map_Optional, if it has been set, otherwise returns nullptr */
    const FRHAPI_DevMap* GetMapOrNull() const { if (Map_IsSet) return &Map_Optional; return nullptr; }
    /** @brief Sets the value of Map_Optional and also sets Map_IsSet to true */
    void SetMap(FRHAPI_DevMap NewValue) { Map_Optional = NewValue; Map_IsSet = true; }
