...
#include "DevMapSelectionListUpdateRequest.generated.h"

/** @defgroup RHAPI_DevMapSelectionListUpdateRequest RallyHere API Model DevMapSelectionListUpdateRequest
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevMapSelectionListUpdateRequest : public FRHAPI_DevModel
{
    GENERATED_BODY()
