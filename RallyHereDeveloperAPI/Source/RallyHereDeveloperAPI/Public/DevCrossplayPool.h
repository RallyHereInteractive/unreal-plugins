...
#include "DevCrossplayPool.generated.h"

/** @defgroup RHAPI_DevCrossplayPool RallyHere API Model DevCrossplayPool
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevCrossplayPool : public FRHAPI_DevModel
{
    GENERATED_BODY()
    ...
    */
    ...
    /** @brief ID to uniquely identify this CrossplayPool */
