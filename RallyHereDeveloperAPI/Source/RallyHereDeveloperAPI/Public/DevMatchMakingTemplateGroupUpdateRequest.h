...
#include "DevMatchMakingTemplateGroupUpdateRequest.generated.h"

/** @defgroup RHAPI_DevMatchMakingTemplateGroupUpdateRequest RallyHere API Model DevMatchMakingTemplateGroupUpdateRequest
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevMatchMakingTemplateGroupUpdateRequest : public FRHAPI_DevModel
{
    GENERATED_BODY()
