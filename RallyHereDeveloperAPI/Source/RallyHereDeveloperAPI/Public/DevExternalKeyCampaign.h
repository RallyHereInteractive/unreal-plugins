...
#include "DevExternalKeyCampaign.generated.h"

/** @defgroup RHAPI_DevExternalKeyCampaign RallyHere API Model DevExternalKeyCampaign
 *  @{
 */

/**
 * @brief A campaign to distribute external keys to players.
 */
USTRUCT(BlueprintType)
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevExternalKeyCampaign : public FRHAPI_DevModel
{
    GENERATED_BODY()
