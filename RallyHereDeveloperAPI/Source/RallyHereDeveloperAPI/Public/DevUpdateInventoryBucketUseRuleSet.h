...
#include "DevUpdateInventoryBucketUseRuleSet.generated.h"

/** @defgroup RHAPI_DevUpdateInventoryBucketUseRuleSet RallyHere API Model DevUpdateInventoryBucketUseRuleSet
 *  @{
 */

/**
 * @brief A collection of Inventory Bucket Use Rules to update.
 */
USTRUCT(BlueprintType)
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevUpdateInventoryBucketUseRuleSet : public FRHAPI_DevModel
{
    GENERATED_BODY()
