...
#include "DevMatchMakingStrideResponse.generated.h"

/** @defgroup RHAPI_DevMatchMakingStrideResponse RallyHere API Model DevMatchMakingStrideResponse
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevMatchMakingStrideResponse : public FRHAPI_DevModel
{
    GENERATED_BODY()
    ...
    */
    ...
    TArray<FRHAPI_DevMatchMakingStrideEntry> Entries_Optional{  };
    ...
    TArray<FRHAPI_DevMatchMakingStrideEntry>& GetEntries() { return Entries_Optional; }
    /** @brief Gets the value of Entries_Optional, regardless of it having been set */
    const TArray<FRHAPI_DevMatchMakingStrideEntry>& GetEntries() const { return Entries_Optional; }
    /** @brief Gets the value of Entries_Optional, if it has been set, otherwise it returns DefaultValue */
    const TArray<FRHAPI_DevMatchMakingStrideEntry>& GetEntries(const TArray<FRHAPI_DevMatchMakingStrideEntry>& DefaultValue) const { if (Entries_IsSet) return Entries_Optional; return DefaultValue; }
    /** @brief Fills OutValue with the value of Entries_Optional and returns true if it has been set, otherwise returns false */
    bool GetEntries(TArray<FRHAPI_DevMatchMakingStrideEntry>& OutValue) const { if (Entries_IsSet) OutValue = Entries_Optional; return Entries_IsSet; }
    /** @brief Returns a pointer to Entries_Optional, if it has been set, otherwise returns nullptr */
    TArray<FRHAPI_DevMatchMakingStrideEntry>* GetEntriesOrNull() { if (Entries_IsSet) return &Entries_Optional; return nullptr; }
    /** @brief Returns a pointer to Entries_Optional, if it has been set, otherwise returns nullptr */
    const TArray<FRHAPI_DevMatchMakingStrideEntry>* GetEntriesOrNull() const { if (Entries_IsSet) return &Entries_Optional; return nullptr; }
    /** @brief Sets the value of Entries_Optional and also sets Entries_IsSet to true */
    void SetEntries(TArray<FRHAPI_DevMatchMakingStrideEntry> NewValue) { Entries_Optional = NewValue; Entries_IsSet = true; }
