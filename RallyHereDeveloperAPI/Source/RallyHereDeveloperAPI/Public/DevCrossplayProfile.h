...
#include "DevCrossplayProfile.generated.h"

/** @defgroup RHAPI_DevCrossplayProfile RallyHere API Model DevCrossplayProfile
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevCrossplayProfile : public FRHAPI_DevModel
{
    GENERATED_BODY()
    ...
    */
    ...
    /** @brief ID to uniquely identify this CrossplayProfile */
    FGuid CrossplayProfileId{  };
    /** @brief Gets the value of CrossplayProfileId */
    FGuid& GetCrossplayProfileId() { return CrossplayProfileId; }
    /** @brief Gets the value of CrossplayProfileId */
    const FGuid& GetCrossplayProfileId() const { return CrossplayProfileId; }
    /** @brief Sets the value of CrossplayProfileId */
    void SetCrossplayProfileId(FGuid NewValue) { CrossplayProfileId = NewValue;  }
};
