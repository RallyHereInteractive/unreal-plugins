...
#include "DevCreateEntitlementSku.generated.h"

/** @defgroup RHAPI_DevCreateEntitlementSku RallyHere API Model DevCreateEntitlementSku
 *  @{
 */

/**
 * @brief Entitlement Sku to create.
 */
USTRUCT(BlueprintType)
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevCreateEntitlementSku : public FRHAPI_DevModel
{
    GENERATED_BODY()
