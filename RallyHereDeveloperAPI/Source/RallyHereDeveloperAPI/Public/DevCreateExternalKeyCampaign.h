...
#include "DevCreateExternalKeyCampaign.generated.h"

/** @defgroup RHAPI_DevCreateExternalKeyCampaign RallyHere API Model DevCreateExternalKeyCampaign
 *  @{
 */

/**
 * @brief External Key Campaign to create.
 */
USTRUCT(BlueprintType)
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevCreateExternalKeyCampaign : public FRHAPI_DevModel
{
    GENERATED_BODY()
