...
#include "DevCustomEndpointUpdate.generated.h"

/** @defgroup RHAPI_DevCustomEndpointUpdate RallyHere API Model DevCustomEndpointUpdate
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevCustomEndpointUpdate : public FRHAPI_DevModel
{
    GENERATED_BODY()
