...
#include "DevMatchMakingRuleSetFlattened.h"
#include "DevMatchMakingTemplateResponse.generated.h"

/** @defgroup RHAPI_DevMatchMakingTemplateResponse RallyHere API Model DevMatchMakingTemplateResponse
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevMatchMakingTemplateResponse : public FRHAPI_DevModel
{
    GENERATED_BODY()
    ...
    */
    ...
    FRHAPI_DevMatchMakingRuleSetFlattened Ruleset_Optional{  };
    ...
    FRHAPI_DevMatchMakingRuleSetFlattened& GetRuleset() { return Ruleset_Optional; }
    /** @brief Gets the value of Ruleset_Optional, regardless of it having been set */
    const FRHAPI_DevMatchMakingRuleSetFlattened& GetRuleset() const { return Ruleset_Optional; }
    /** @brief Gets the value of Ruleset_Optional, if it has been set, otherwise it returns DefaultValue */
    const FRHAPI_DevMatchMakingRuleSetFlattened& GetRuleset(const FRHAPI_DevMatchMakingRuleSetFlattened& DefaultValue) const { if (Ruleset_IsSet) return Ruleset_Optional; return DefaultValue; }
    /** @brief Fills OutValue with the value of Ruleset_Optional and returns true if it has been set, otherwise returns false */
    bool GetRuleset(FRHAPI_DevMatchMakingRuleSetFlattened& OutValue) const { if (Ruleset_IsSet) OutValue = Ruleset_Optional; return Ruleset_IsSet; }
    /** @brief Returns a pointer to Ruleset_Optional, if it has been set, otherwise returns nullptr */
    FRHAPI_DevMatchMakingRuleSetFlattened* GetRulesetOrNull() { if (Ruleset_IsSet) return &Ruleset_Optional; return nullptr; }
    /** @brief Returns a pointer to Ruleset_Optional, if it has been set, otherwise returns nullptr */
    const FRHAPI_DevMatchMakingRuleSetFlattened* GetRulesetOrNull() const { if (Ruleset_IsSet) return &Ruleset_Optional; return nullptr; }
    /** @brief Sets the value of Ruleset_Optional and also sets Ruleset_IsSet to true */
    void SetRuleset(FRHAPI_DevMatchMakingRuleSetFlattened NewValue) { Ruleset_Optional = NewValue; Ruleset_IsSet = true; }
