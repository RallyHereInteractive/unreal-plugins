...
#include "DevMatchMakingProfileListFlattened.generated.h"

/** @defgroup RHAPI_DevMatchMakingProfileListFlattened RallyHere API Model DevMatchMakingProfileListFlattened
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevMatchMakingProfileListFlattened : public FRHAPI_DevModel
{
    GENERATED_BODY()
