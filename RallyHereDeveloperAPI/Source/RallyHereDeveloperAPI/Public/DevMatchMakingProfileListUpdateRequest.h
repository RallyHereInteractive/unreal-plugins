...
#include "DevMatchMakingProfileListUpdateRequest.generated.h"

/** @defgroup RHAPI_DevMatchMakingProfileListUpdateRequest RallyHere API Model DevMatchMakingProfileListUpdateRequest
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevMatchMakingProfileListUpdateRequest : public FRHAPI_DevModel
{
    GENERATED_BODY()
