...
#include "DevHostUpdate.generated.h"

/** @defgroup RHAPI_DevHostUpdate RallyHere API Model DevHostUpdate
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevHostUpdate : public FRHAPI_DevModel
{
    GENERATED_BODY()
