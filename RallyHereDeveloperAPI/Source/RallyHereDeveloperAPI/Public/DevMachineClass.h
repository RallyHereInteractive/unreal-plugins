...
#include "DevMachineClass.generated.h"

/** @defgroup RHAPI_DevMachineClass RallyHere API Model DevMachineClass
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevMachineClass : public FRHAPI_DevModel
{
    GENERATED_BODY()
    ...
    */
    ...
    FRHAPI_DevDatacenterProvider DatacenterProvider{  };
    /** @brief Gets the value of DatacenterProvider */
    FRHAPI_DevDatacenterProvider& GetDatacenterProvider() { return DatacenterProvider; }
    /** @brief Gets the value of DatacenterProvider */
    const FRHAPI_DevDatacenterProvider& GetDatacenterProvider() const { return DatacenterProvider; }
    /** @brief Sets the value of DatacenterProvider */
    void SetDatacenterProvider(FRHAPI_DevDatacenterProvider NewValue) { DatacenterProvider = NewValue;  }
