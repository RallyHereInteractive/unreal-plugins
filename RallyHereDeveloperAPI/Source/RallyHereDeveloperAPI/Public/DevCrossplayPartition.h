...
#include "DevCrossplayPartition.generated.h"

/** @defgroup RHAPI_DevCrossplayPartition RallyHere API Model DevCrossplayPartition
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevCrossplayPartition : public FRHAPI_DevModel
{
    GENERATED_BODY()
    ...
    */
    ...
    /** @brief ID to uniquely identify this CrossplayPartition */
