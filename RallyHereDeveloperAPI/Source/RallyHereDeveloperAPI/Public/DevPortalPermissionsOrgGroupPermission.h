...
#include "DevPortalPermissionsOrgGroupPermission.generated.h"

/** @defgroup RHAPI_DevPortalPermissionsOrgGroupPermission RallyHere API Model DevPortalPermissionsOrgGroupPermission
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevPortalPermissionsOrgGroupPermission : public FRHAPI_DevModel
{
    GENERATED_BODY()
