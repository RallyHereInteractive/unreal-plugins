...
#include "DevInstanceStartupParams.generated.h"

/** @defgroup RHAPI_DevInstanceStartupParams RallyHere API Model DevInstanceStartupParams
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevInstanceStartupParams : public FRHAPI_DevModel
{
    GENERATED_BODY()
