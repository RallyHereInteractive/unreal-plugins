...
#include "DevUpdateXpRequest.generated.h"

/** @defgroup RHAPI_DevUpdateXpRequest RallyHere API Model DevUpdateXpRequest
 *  @{
 */

/**
 * @brief A request to update XP.If thresholds are provided, it will do a full replace of all thresholds on the XP.
 */
USTRUCT(BlueprintType)
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevUpdateXpRequest : public FRHAPI_DevModel
{
    GENERATED_BODY()
