...
#include "DevCreateLootWithVendorRequest.h"
#include "DevVendorType.h"
#include "DevCreateVendorRequest.generated.h"

/** @defgroup RHAPI_DevCreateVendorRequest RallyHere API Model DevCreateVendorRequest
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevCreateVendorRequest : public FRHAPI_DevModel
{
    GENERATED_BODY()
    ...
    */
    ...
    TArray<FRHAPI_DevCreateLootWithVendorRequest> Loot_Optional{  };
    ...
    TArray<FRHAPI_DevCreateLootWithVendorRequest>& GetLoot() { return Loot_Optional; }
    /** @brief Gets the value of Loot_Optional, regardless of it having been set */
    const TArray<FRHAPI_DevCreateLootWithVendorRequest>& GetLoot() const { return Loot_Optional; }
    /** @brief Gets the value of Loot_Optional, if it has been set, otherwise it returns DefaultValue */
    const TArray<FRHAPI_DevCreateLootWithVendorRequest>& GetLoot(const TArray<FRHAPI_DevCreateLootWithVendorRequest>& DefaultValue) const { if (Loot_IsSet) return Loot_Optional; return DefaultValue; }
    /** @brief Fills OutValue with the value of Loot_Optional and returns true if it has been set, otherwise returns false */
    bool GetLoot(TArray<FRHAPI_DevCreateLootWithVendorRequest>& OutValue) const { if (Loot_IsSet) OutValue = Loot_Optional; return Loot_IsSet; }
    /** @brief Returns a pointer to Loot_Optional, if it has been set, otherwise returns nullptr */
    TArray<FRHAPI_DevCreateLootWithVendorRequest>* GetLootOrNull() { if (Loot_IsSet) return &Loot_Optional; return nullptr; }
    /** @brief Returns a pointer to Loot_Optional, if it has been set, otherwise returns nullptr */
    const TArray<FRHAPI_DevCreateLootWithVendorRequest>* GetLootOrNull() const { if (Loot_IsSet) return &Loot_Optional; return nullptr; }
    /** @brief Sets the value of Loot_Optional and also sets Loot_IsSet to true */
    void SetLoot(TArray<FRHAPI_DevCreateLootWithVendorRequest> NewValue) { Loot_Optional = NewValue; Loot_IsSet = true; }
