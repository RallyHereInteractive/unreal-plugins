...
#include "DevInventoryBucketUseRuleSet.generated.h"

/** @defgroup RHAPI_DevInventoryBucketUseRuleSet RallyHere API Model DevInventoryBucketUseRuleSet
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevInventoryBucketUseRuleSet : public FRHAPI_DevModel
{
    GENERATED_BODY()
    ...
    */
    ...
    /** @brief The Inventory Bucket Use Rule Set ID. */
    FGuid RuleSetId{  };
    /** @brief Gets the value of RuleSetId */
    FGuid& GetRuleSetId() { return RuleSetId; }
    /** @brief Gets the value of RuleSetId */
    const FGuid& GetRuleSetId() const { return RuleSetId; }
    /** @brief Sets the value of RuleSetId */
    void SetRuleSetId(FGuid NewValue) { RuleSetId = NewValue;  }

    /** @brief The Legacy Inventory Bucket Use Rule Set ID. */
    int32 LegacyRuleSetId{ 0 };
    /** @brief Gets the value of LegacyRuleSetId */
    int32& GetLegacyRuleSetId() { return LegacyRuleSetId; }
    /** @brief Gets the value of LegacyRuleSetId */
    const int32& GetLegacyRuleSetId() const { return LegacyRuleSetId; }
    /** @brief Sets the value of LegacyRuleSetId */
    void SetLegacyRuleSetId(int32 NewValue) { LegacyRuleSetId = NewValue;  }
    /** @brief Returns true if LegacyRuleSetId matches the default value */
    bool IsLegacyRuleSetIdDefaultValue() const { return LegacyRuleSetId == 0; }
    /** @brief Sets the value of LegacyRuleSetId to its default  */
    void SetLegacyRuleSetIdToDefault() { LegacyRuleSetId = 0;  }
};
