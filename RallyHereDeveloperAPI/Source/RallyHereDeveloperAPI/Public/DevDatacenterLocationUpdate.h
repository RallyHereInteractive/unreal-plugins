...
#include "DevDatacenterLocationUpdate.generated.h"

/** @defgroup RHAPI_DevDatacenterLocationUpdate RallyHere API Model DevDatacenterLocationUpdate
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevDatacenterLocationUpdate : public FRHAPI_DevModel
{
    GENERATED_BODY()
