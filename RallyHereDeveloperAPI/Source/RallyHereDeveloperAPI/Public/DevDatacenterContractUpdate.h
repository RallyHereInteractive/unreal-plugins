...
#include "DevDatacenterContractUpdate.generated.h"

/** @defgroup RHAPI_DevDatacenterContractUpdate RallyHere API Model DevDatacenterContractUpdate
 *  @{
 */
...
struct RALLYHEREDEVELOPERAPI_API FRHAPI_DevDatacenterContractUpdate : public FRHAPI_DevModel
{
    GENERATED_BODY()
