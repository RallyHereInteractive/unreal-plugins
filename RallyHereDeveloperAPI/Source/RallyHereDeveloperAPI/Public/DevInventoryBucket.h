...
#include "DevInventoryBucket.generated.h"
 ...
 */
UENUM(BlueprintType)
enum class ERHAPI_DevInventoryBucket : uint8
{
...
RALLYHEREDEVELOPERAPI_API FString EnumToString(const ERHAPI_DevInventoryBucket& EnumValue);
RALLYHEREDEVELOPERAPI_API bool EnumFromString(const FString& EnumAsString, ERHAPI_DevInventoryBucket& EnumValue);
RALLYHEREDEVELOPERAPI_API FStringFormatArg ToStringFormatArg(const ERHAPI_DevInventoryBucket& Value);
RALLYHEREDEVELOPERAPI_API void WriteJsonValue(TSharedRef<TJsonWriter<>>& Writer, const ERHAPI_DevInventoryBucket& Value);
RALLYHEREDEVELOPERAPI_API bool TryGetJsonValue(const TSharedPtr<FJsonValue>& JsonValue, ERHAPI_DevInventoryBucket& Value);
