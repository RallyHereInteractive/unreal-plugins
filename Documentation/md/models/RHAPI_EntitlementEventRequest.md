...
`public virtual bool `[`FromJson`](#structFRHAPI__EntitlementEventRequest_1ae4945e35af531fe3e0b00d529fa93d7a)`(const TSharedPtr< FJsonValue > & JsonValue)` | Fills this object with data from the passed in JSON.
`public virtual void `[`WriteJson`](#structFRHAPI__EntitlementEventRequest_1aa96d633eb06df99e84270301cfbd2efb)`(TSharedRef< TJsonWriter<>> & Writer) const` | Writes the data from this object into the specified JSON Writer stream.
...
`public inline void `[`SetActionType`](#structFRHAPI__EntitlementEventRequest_1af7d918bf8cb03c0cd4ddee3ebd09fd8c)`(ERHAPI_EntitlementActionType NewValue)` | Sets the value of ActionType.
...
`public inline void `[`SetStatus`](#structFRHAPI__EntitlementEventRequest_1a779c693b254c488c6483b24f56d50225)`(ERHAPI_EntitlementEventStatus NewValue)` | Sets the value of Status_Optional and also sets Status_IsSet to true.
...
`public inline void `[`SetPlayerUuid`](#structFRHAPI__EntitlementEventRequest_1a289b4218fa78e30d197b283ad52b4124)`(FGuid NewValue)` | Sets the value of PlayerUuid_Optional and also sets PlayerUuid_IsSet to true.
...
`public inline void `[`SetPlatform`](#structFRHAPI__EntitlementEventRequest_1a1159303997ace5aa18121f305a0e5b08)`(ERHAPI_Platform NewValue)` | Sets the value of Platform.
...
`public inline void `[`SetPlatformUserId`](#structFRHAPI__EntitlementEventRequest_1aa3bea3a2a34e3992a6e4f24c3360520c)`(FString NewValue)` | Sets the value of PlatformUserId.
...
`public inline void `[`SetSku`](#structFRHAPI__EntitlementEventRequest_1a2636be0a401ed99c883f19cabc7d9172)`(FString NewValue)` | Sets the value of Sku.
...
`public inline void `[`SetQuantity`](#structFRHAPI__EntitlementEventRequest_1a1018fc761bdcb67f9140828642be7523)`(int32 NewValue)` | Sets the value of Quantity_Optional and also sets Quantity_IsSet to true.
...
`public inline void `[`SetPlatformTransactionId`](#structFRHAPI__EntitlementEventRequest_1a4863bd72a119f1f7e11d1ae893091299)`(FString NewValue)` | Sets the value of PlatformTransactionId.
...
#### `public virtual bool `[`FromJson`](#structFRHAPI__EntitlementEventRequest_1ae4945e35af531fe3e0b00d529fa93d7a)`(const TSharedPtr< FJsonValue > & JsonValue)` <a id="structFRHAPI__EntitlementEventRequest_1ae4945e35af531fe3e0b00d529fa93d7a"></a>
...
#### `public virtual void `[`WriteJson`](#structFRHAPI__EntitlementEventRequest_1aa96d633eb06df99e84270301cfbd2efb)`(TSharedRef< TJsonWriter<>> & Writer) const` <a id="structFRHAPI__EntitlementEventRequest_1aa96d633eb06df99e84270301cfbd2efb"></a>
...
#### `public inline void `[`SetActionType`](#structFRHAPI__EntitlementEventRequest_1af7d918bf8cb03c0cd4ddee3ebd09fd8c)`(ERHAPI_EntitlementActionType NewValue)` <a id="structFRHAPI__EntitlementEventRequest_1af7d918bf8cb03c0cd4ddee3ebd09fd8c"></a>
...
#### `public inline void `[`SetStatus`](#structFRHAPI__EntitlementEventRequest_1a779c693b254c488c6483b24f56d50225)`(ERHAPI_EntitlementEventStatus NewValue)` <a id="structFRHAPI__EntitlementEventRequest_1a779c693b254c488c6483b24f56d50225"></a>
...
#### `public inline void `[`SetPlayerUuid`](#structFRHAPI__EntitlementEventRequest_1a289b4218fa78e30d197b283ad52b4124)`(FGuid NewValue)` <a id="structFRHAPI__EntitlementEventRequest_1a289b4218fa78e30d197b283ad52b4124"></a>
...
#### `public inline void `[`SetPlatform`](#structFRHAPI__EntitlementEventRequest_1a1159303997ace5aa18121f305a0e5b08)`(ERHAPI_Platform NewValue)` <a id="structFRHAPI__EntitlementEventRequest_1a1159303997ace5aa18121f305a0e5b08"></a>
...
#### `public inline void `[`SetPlatformUserId`](#structFRHAPI__EntitlementEventRequest_1aa3bea3a2a34e3992a6e4f24c3360520c)`(FString NewValue)` <a id="structFRHAPI__EntitlementEventRequest_1aa3bea3a2a34e3992a6e4f24c3360520c"></a>
...
#### `public inline void `[`SetSku`](#structFRHAPI__EntitlementEventRequest_1a2636be0a401ed99c883f19cabc7d9172)`(FString NewValue)` <a id="structFRHAPI__EntitlementEventRequest_1a2636be0a401ed99c883f19cabc7d9172"></a>
...
#### `public inline void `[`SetQuantity`](#structFRHAPI__EntitlementEventRequest_1a1018fc761bdcb67f9140828642be7523)`(int32 NewValue)` <a id="structFRHAPI__EntitlementEventRequest_1a1018fc761bdcb67f9140828642be7523"></a>
...
#### `public inline void `[`SetPlatformTransactionId`](#structFRHAPI__EntitlementEventRequest_1a4863bd72a119f1f7e11d1ae893091299)`(FString NewValue)` <a id="structFRHAPI__EntitlementEventRequest_1a4863bd72a119f1f7e11d1ae893091299"></a>
...
#### `public inline void `[`SetPlatformData`](#structFRHAPI__EntitlementEventRequest_1a9f9b0e6896a3d27b1d59acc7b72f7d97)`(`[`FRHAPI_JsonObject`](undefined.md#structFRHAPI__JsonObject)` NewValue)` <a id="structFRHAPI__EntitlementEventRequest_1a9f9b0e6896a3d27b1d59acc7b72f7d97"></a>
