...
`public virtual bool `[`FromJson`](#structFRHAPI__AuditEvent_1a4e597580853536ed812623c585c5c2a3)`(const TSharedPtr< FJsonValue > & JsonValue)` | Fills this object with data from the passed in JSON.
`public virtual void `[`WriteJson`](#structFRHAPI__AuditEvent_1a10d9551869f79a19f98f4f0d7194f922)`(TSharedRef< TJsonWriter<>> & Writer) const` | Writes the data from this object into the specified JSON Writer stream.
...
`public inline void `[`SetEventName`](#structFRHAPI__AuditEvent_1a35d086ff5d373c7b18834bcc4ec5dbb7)`(FString NewValue)` | Sets the value of EventName.
...
`public inline void `[`SetSessionId`](#structFRHAPI__AuditEvent_1ad2dfc7f3c30eee51f92f77ea9874fe71)`(FString NewValue)` | Sets the value of SessionId.
...
`public inline void `[`SetCustomData`](#structFRHAPI__AuditEvent_1a2d7bf574b0b86cf17909b4c4cd6ef4b1)`(TMap< FString, FString > NewValue)` | Sets the value of CustomData_Optional and also sets CustomData_IsSet to true.
...
`public inline void `[`SetSessionType`](#structFRHAPI__AuditEvent_1aba3fd584f090e3fc3b9b86e4770ac158)`(FString NewValue)` | Sets the value of SessionType_Optional and also sets SessionType_IsSet to true.
...
`public inline void `[`SetRegionId`](#structFRHAPI__AuditEvent_1af845080bcec668d33f1d1425747d56f1)`(FString NewValue)` | Sets the value of RegionId_Optional and also sets RegionId_IsSet to true.
...
`public inline void `[`SetJoinable`](#structFRHAPI__AuditEvent_1ae29a92456a729e8d57020178d5e54169)`(bool NewValue)` | Sets the value of Joinable_Optional and also sets Joinable_IsSet to true.
...
`public inline void `[`SetUpdatedTeams`](#structFRHAPI__AuditEvent_1a0e98ef3b3b6107756e734e12cd7a3598)`(TArray< `[`FRHAPI_TeamUpdate`](RHAPI_TeamUpdate.md#structFRHAPI__TeamUpdate)` > NewValue)` | Sets the value of UpdatedTeams_Optional and also sets UpdatedTeams_IsSet to true.
...
`public inline void `[`SetSource`](#structFRHAPI__AuditEvent_1aaeb479585909594bbf3d1734f79f4db6)`(ERHAPI_InviteSource NewValue)` | Sets the value of Source_Optional and also sets Source_IsSet to true.
...
`public inline void `[`SetPlayerUuid`](#structFRHAPI__AuditEvent_1a50f8004b7bc6f1547b08b45d5ed07ea7)`(FGuid NewValue)` | Sets the value of PlayerUuid_Optional and also sets PlayerUuid_IsSet to true.
...
`public inline void `[`SetTeamId`](#structFRHAPI__AuditEvent_1af784702803f1b435a2287921695f0906)`(int32 NewValue)` | Sets the value of TeamId_Optional and also sets TeamId_IsSet to true.
...
`public inline void `[`SetInvitedSessionId`](#structFRHAPI__AuditEvent_1a07176c9df7fd359deb04b7a4918a552a)`(FString NewValue)` | Sets the value of InvitedSessionId_Optional and also sets InvitedSessionId_IsSet to true.
...
`public inline void `[`SetRemovedSessionId`](#structFRHAPI__AuditEvent_1a6d0340459b6d3ede09629777e307da7c)`(FString NewValue)` | Sets the value of RemovedSessionId_Optional and also sets RemovedSessionId_IsSet to true.
...
`public inline void `[`SetVersion`](#structFRHAPI__AuditEvent_1a686ef2f5a61fe3a2f5f317c58ea0ab18)`(FString NewValue)` | Sets the value of Version_Optional and also sets Version_IsSet to true.
...
`public inline void `[`SetClientSettings`](#structFRHAPI__AuditEvent_1a0a286ba42010c025ff3b93bcda75c097)`(`[`FRHAPI_ClientSettings`](RHAPI_ClientSettings.md#structFRHAPI__ClientSettings)` NewValue)` | Sets the value of ClientSettings_Optional and also sets ClientSettings_IsSet to true.
...
`public inline void `[`SetPlayerStatus`](#structFRHAPI__AuditEvent_1aaec70296833f610930b35f1ac4458626)`(ERHAPI_SessionPlayerStatus NewValue)` | Sets the value of PlayerStatus_Optional and also sets PlayerStatus_IsSet to true.
...
`public inline void `[`SetPlatform`](#structFRHAPI__AuditEvent_1ac0c81925b4e0b589b0a5bfca575cb45e)`(ERHAPI_Platform NewValue)` | Sets the value of Platform_Optional and also sets Platform_IsSet to true.
...
`public inline void `[`SetPlatformSessionId`](#structFRHAPI__AuditEvent_1ae0c5d072572d418f12bc237408e47529)`(FString NewValue)` | Sets the value of PlatformSessionId_Optional and also sets PlatformSessionId_IsSet to true.
...
`public inline void `[`SetInstanceId`](#structFRHAPI__AuditEvent_1a96088bbbc1debd2773c78506ce9b82fd)`(FString NewValue)` | Sets the value of InstanceId_Optional and also sets InstanceId_IsSet to true.
...
`public inline void `[`SetHostType`](#structFRHAPI__AuditEvent_1a36b487d631d9b65f594addff5bd52f65)`(ERHAPI_HostType NewValue)` | Sets the value of HostType_Optional and also sets HostType_IsSet to true.
...
`public inline void `[`SetHostPlayerUuid`](#structFRHAPI__AuditEvent_1a6c4169a30e658a79337ee2e24d6c603d)`(FGuid NewValue)` | Sets the value of HostPlayerUuid_Optional and also sets HostPlayerUuid_IsSet to true.
...
`public inline void `[`SetInstanceRequestTemplate`](#structFRHAPI__AuditEvent_1ab62c0ed7ce1d35086f7443805dd0ac9a)`(FGuid NewValue)` | Sets the value of InstanceRequestTemplate_Optional and also sets InstanceRequestTemplate_IsSet to true.
...
`public inline void `[`SetMap`](#structFRHAPI__AuditEvent_1a78f4cf5e4de8200340bbf6367d6992d5)`(FString NewValue)` | Sets the value of Map_Optional and also sets Map_IsSet to true.
...
`public inline void `[`SetMode`](#structFRHAPI__AuditEvent_1a88df223f4f7f8ab7dc52861b28584ce4)`(FString NewValue)` | Sets the value of Mode_Optional and also sets Mode_IsSet to true.
...
`public inline void `[`SetAllocationId`](#structFRHAPI__AuditEvent_1a08f58271fac5eb5759afe64e715db809)`(FString NewValue)` | Sets the value of AllocationId_Optional and also sets AllocationId_IsSet to true.
...
`public inline void `[`SetJoinStatus`](#structFRHAPI__AuditEvent_1ab244020d0f3e78af4b367b11dc5c68d0)`(ERHAPI_InstanceJoinableStatus NewValue)` | Sets the value of JoinStatus_Optional and also sets JoinStatus_IsSet to true.
...
`public inline void `[`SetJoinParams`](#structFRHAPI__AuditEvent_1acf5f5f67e8b6063261ca9e4aa4e953e8)`(`[`FRHAPI_JoinParams`](RHAPI_JoinParams.md#structFRHAPI__JoinParams)` NewValue)` | Sets the value of JoinParams_Optional and also sets JoinParams_IsSet to true.
...
`public inline void `[`SetInstanceHealth`](#structFRHAPI__AuditEvent_1a3809df4c6ec293a9cf8129ab504ac7dc)`(ERHAPI_InstanceHealthStatus NewValue)` | Sets the value of InstanceHealth_Optional and also sets InstanceHealth_IsSet to true.
...
`public inline void `[`SetQueueId`](#structFRHAPI__AuditEvent_1a80dfefed94a2f294da14adacb8d384ee)`(FString NewValue)` | Sets the value of QueueId_Optional and also sets QueueId_IsSet to true.
...
`public inline void `[`SetTicketId`](#structFRHAPI__AuditEvent_1a2bab32374de06ff2819a7da02362bf93)`(FString NewValue)` | Sets the value of TicketId_Optional and also sets TicketId_IsSet to true.
...
`public inline void `[`SetAdditionalParams`](#structFRHAPI__AuditEvent_1a52b2ccfd115d58511c34f9270cdb590a)`(`[`FRHAPI_AdditionalJoinParams`](RHAPI_AdditionalJoinParams.md#structFRHAPI__AdditionalJoinParams)` NewValue)` | Sets the value of AdditionalParams_Optional and also sets AdditionalParams_IsSet to true.
...
`public inline void `[`SetMapPreferences`](#structFRHAPI__AuditEvent_1a1359047c661cba1dda1c61efb437c6ac)`(TArray< FString > NewValue)` | Sets the value of MapPreferences_Optional and also sets MapPreferences_IsSet to true.
...
`public inline void `[`SetQueuedSessionId`](#structFRHAPI__AuditEvent_1ae83ce61e13635a102a32f1afe95b1236)`(FString NewValue)` | Sets the value of QueuedSessionId_Optional and also sets QueuedSessionId_IsSet to true.
...
`public inline void `[`SetRequestingUserUuid`](#structFRHAPI__AuditEvent_1a3eb04b65f35fa38ce491b3cc851d52ff)`(FGuid NewValue)` | Sets the value of RequestingUserUuid_Optional and also sets RequestingUserUuid_IsSet to true.
...
#### `public virtual bool `[`FromJson`](#structFRHAPI__AuditEvent_1a4e597580853536ed812623c585c5c2a3)`(const TSharedPtr< FJsonValue > & JsonValue)` <a id="structFRHAPI__AuditEvent_1a4e597580853536ed812623c585c5c2a3"></a>
...
#### `public virtual void `[`WriteJson`](#structFRHAPI__AuditEvent_1a10d9551869f79a19f98f4f0d7194f922)`(TSharedRef< TJsonWriter<>> & Writer) const` <a id="structFRHAPI__AuditEvent_1a10d9551869f79a19f98f4f0d7194f922"></a>
...
#### `public inline void `[`SetEventName`](#structFRHAPI__AuditEvent_1a35d086ff5d373c7b18834bcc4ec5dbb7)`(FString NewValue)` <a id="structFRHAPI__AuditEvent_1a35d086ff5d373c7b18834bcc4ec5dbb7"></a>
...
#### `public inline void `[`SetSessionId`](#structFRHAPI__AuditEvent_1ad2dfc7f3c30eee51f92f77ea9874fe71)`(FString NewValue)` <a id="structFRHAPI__AuditEvent_1ad2dfc7f3c30eee51f92f77ea9874fe71"></a>
...
#### `public inline void `[`SetCustomData`](#structFRHAPI__AuditEvent_1a2d7bf574b0b86cf17909b4c4cd6ef4b1)`(TMap< FString, FString > NewValue)` <a id="structFRHAPI__AuditEvent_1a2d7bf574b0b86cf17909b4c4cd6ef4b1"></a>
...
#### `public inline void `[`SetSessionType`](#structFRHAPI__AuditEvent_1aba3fd584f090e3fc3b9b86e4770ac158)`(FString NewValue)` <a id="structFRHAPI__AuditEvent_1aba3fd584f090e3fc3b9b86e4770ac158"></a>
...
#### `public inline void `[`SetRegionId`](#structFRHAPI__AuditEvent_1af845080bcec668d33f1d1425747d56f1)`(FString NewValue)` <a id="structFRHAPI__AuditEvent_1af845080bcec668d33f1d1425747d56f1"></a>
...
#### `public inline void `[`SetJoinable`](#structFRHAPI__AuditEvent_1ae29a92456a729e8d57020178d5e54169)`(bool NewValue)` <a id="structFRHAPI__AuditEvent_1ae29a92456a729e8d57020178d5e54169"></a>
...
#### `public inline void `[`SetUpdatedTeams`](#structFRHAPI__AuditEvent_1a0e98ef3b3b6107756e734e12cd7a3598)`(TArray< `[`FRHAPI_TeamUpdate`](RHAPI_TeamUpdate.md#structFRHAPI__TeamUpdate)` > NewValue)` <a id="structFRHAPI__AuditEvent_1a0e98ef3b3b6107756e734e12cd7a3598"></a>
...
#### `public inline void `[`SetSource`](#structFRHAPI__AuditEvent_1aaeb479585909594bbf3d1734f79f4db6)`(ERHAPI_InviteSource NewValue)` <a id="structFRHAPI__AuditEvent_1aaeb479585909594bbf3d1734f79f4db6"></a>
...
#### `public inline void `[`SetPlayerUuid`](#structFRHAPI__AuditEvent_1a50f8004b7bc6f1547b08b45d5ed07ea7)`(FGuid NewValue)` <a id="structFRHAPI__AuditEvent_1a50f8004b7bc6f1547b08b45d5ed07ea7"></a>
...
#### `public inline void `[`SetTeamId`](#structFRHAPI__AuditEvent_1af784702803f1b435a2287921695f0906)`(int32 NewValue)` <a id="structFRHAPI__AuditEvent_1af784702803f1b435a2287921695f0906"></a>
...
#### `public inline void `[`SetInvitedSessionId`](#structFRHAPI__AuditEvent_1a07176c9df7fd359deb04b7a4918a552a)`(FString NewValue)` <a id="structFRHAPI__AuditEvent_1a07176c9df7fd359deb04b7a4918a552a"></a>
...
#### `public inline void `[`SetRemovedSessionId`](#structFRHAPI__AuditEvent_1a6d0340459b6d3ede09629777e307da7c)`(FString NewValue)` <a id="structFRHAPI__AuditEvent_1a6d0340459b6d3ede09629777e307da7c"></a>
...
#### `public inline void `[`SetVersion`](#structFRHAPI__AuditEvent_1a686ef2f5a61fe3a2f5f317c58ea0ab18)`(FString NewValue)` <a id="structFRHAPI__AuditEvent_1a686ef2f5a61fe3a2f5f317c58ea0ab18"></a>
...
#### `public inline void `[`SetClientSettings`](#structFRHAPI__AuditEvent_1a0a286ba42010c025ff3b93bcda75c097)`(`[`FRHAPI_ClientSettings`](RHAPI_ClientSettings.md#structFRHAPI__ClientSettings)` NewValue)` <a id="structFRHAPI__AuditEvent_1a0a286ba42010c025ff3b93bcda75c097"></a>
...
#### `public inline void `[`SetCrossplayPreferences`](#structFRHAPI__AuditEvent_1a766114e59894e0b8ca02b8783865cbfa)`(`[`FRHAPI_CrossplayPreferences`](RHAPI_CrossplayPreferences.md#structFRHAPI__CrossplayPreferences)` NewValue)` <a id="structFRHAPI__AuditEvent_1a766114e59894e0b8ca02b8783865cbfa"></a>
...
#### `public inline void `[`SetPlayerStatus`](#structFRHAPI__AuditEvent_1aaec70296833f610930b35f1ac4458626)`(ERHAPI_SessionPlayerStatus NewValue)` <a id="structFRHAPI__AuditEvent_1aaec70296833f610930b35f1ac4458626"></a>
...
#### `public inline void `[`SetPlatform`](#structFRHAPI__AuditEvent_1ac0c81925b4e0b589b0a5bfca575cb45e)`(ERHAPI_Platform NewValue)` <a id="structFRHAPI__AuditEvent_1ac0c81925b4e0b589b0a5bfca575cb45e"></a>
...
#### `public inline void `[`SetPlatformSessionId`](#structFRHAPI__AuditEvent_1ae0c5d072572d418f12bc237408e47529)`(FString NewValue)` <a id="structFRHAPI__AuditEvent_1ae0c5d072572d418f12bc237408e47529"></a>
...
#### `public inline void `[`SetInstanceId`](#structFRHAPI__AuditEvent_1a96088bbbc1debd2773c78506ce9b82fd)`(FString NewValue)` <a id="structFRHAPI__AuditEvent_1a96088bbbc1debd2773c78506ce9b82fd"></a>
...
#### `public inline void `[`SetHostType`](#structFRHAPI__AuditEvent_1a36b487d631d9b65f594addff5bd52f65)`(ERHAPI_HostType NewValue)` <a id="structFRHAPI__AuditEvent_1a36b487d631d9b65f594addff5bd52f65"></a>
...
#### `public inline void `[`SetHostPlayerUuid`](#structFRHAPI__AuditEvent_1a6c4169a30e658a79337ee2e24d6c603d)`(FGuid NewValue)` <a id="structFRHAPI__AuditEvent_1a6c4169a30e658a79337ee2e24d6c603d"></a>
...
#### `public inline void `[`SetInstanceRequestTemplate`](#structFRHAPI__AuditEvent_1ab62c0ed7ce1d35086f7443805dd0ac9a)`(FGuid NewValue)` <a id="structFRHAPI__AuditEvent_1ab62c0ed7ce1d35086f7443805dd0ac9a"></a>
...
#### `public inline void `[`SetMap`](#structFRHAPI__AuditEvent_1a78f4cf5e4de8200340bbf6367d6992d5)`(FString NewValue)` <a id="structFRHAPI__AuditEvent_1a78f4cf5e4de8200340bbf6367d6992d5"></a>
...
#### `public inline void `[`SetMode`](#structFRHAPI__AuditEvent_1a88df223f4f7f8ab7dc52861b28584ce4)`(FString NewValue)` <a id="structFRHAPI__AuditEvent_1a88df223f4f7f8ab7dc52861b28584ce4"></a>
...
#### `public inline void `[`SetAllocationId`](#structFRHAPI__AuditEvent_1a08f58271fac5eb5759afe64e715db809)`(FString NewValue)` <a id="structFRHAPI__AuditEvent_1a08f58271fac5eb5759afe64e715db809"></a>
...
#### `public inline void `[`SetJoinStatus`](#structFRHAPI__AuditEvent_1ab244020d0f3e78af4b367b11dc5c68d0)`(ERHAPI_InstanceJoinableStatus NewValue)` <a id="structFRHAPI__AuditEvent_1ab244020d0f3e78af4b367b11dc5c68d0"></a>
...
#### `public inline void `[`SetJoinParams`](#structFRHAPI__AuditEvent_1acf5f5f67e8b6063261ca9e4aa4e953e8)`(`[`FRHAPI_JoinParams`](RHAPI_JoinParams.md#structFRHAPI__JoinParams)` NewValue)` <a id="structFRHAPI__AuditEvent_1acf5f5f67e8b6063261ca9e4aa4e953e8"></a>
...
#### `public inline void `[`SetInstanceHealth`](#structFRHAPI__AuditEvent_1a3809df4c6ec293a9cf8129ab504ac7dc)`(ERHAPI_InstanceHealthStatus NewValue)` <a id="structFRHAPI__AuditEvent_1a3809df4c6ec293a9cf8129ab504ac7dc"></a>
...
#### `public inline void `[`SetQueueId`](#structFRHAPI__AuditEvent_1a80dfefed94a2f294da14adacb8d384ee)`(FString NewValue)` <a id="structFRHAPI__AuditEvent_1a80dfefed94a2f294da14adacb8d384ee"></a>
...
#### `public inline void `[`SetTicketId`](#structFRHAPI__AuditEvent_1a2bab32374de06ff2819a7da02362bf93)`(FString NewValue)` <a id="structFRHAPI__AuditEvent_1a2bab32374de06ff2819a7da02362bf93"></a>
...
#### `public inline void `[`SetAdditionalParams`](#structFRHAPI__AuditEvent_1a52b2ccfd115d58511c34f9270cdb590a)`(`[`FRHAPI_AdditionalJoinParams`](RHAPI_AdditionalJoinParams.md#structFRHAPI__AdditionalJoinParams)` NewValue)` <a id="structFRHAPI__AuditEvent_1a52b2ccfd115d58511c34f9270cdb590a"></a>
...
#### `public inline void `[`SetMapPreferences`](#structFRHAPI__AuditEvent_1a1359047c661cba1dda1c61efb437c6ac)`(TArray< FString > NewValue)` <a id="structFRHAPI__AuditEvent_1a1359047c661cba1dda1c61efb437c6ac"></a>
...
#### `public inline void `[`SetQueuedSessionId`](#structFRHAPI__AuditEvent_1ae83ce61e13635a102a32f1afe95b1236)`(FString NewValue)` <a id="structFRHAPI__AuditEvent_1ae83ce61e13635a102a32f1afe95b1236"></a>
...
#### `public inline void `[`SetRequestingUserUuid`](#structFRHAPI__AuditEvent_1a3eb04b65f35fa38ce491b3cc851d52ff)`(FGuid NewValue)` <a id="structFRHAPI__AuditEvent_1a3eb04b65f35fa38ce491b3cc851d52ff"></a>
...
#### `public inline void `[`SetEventDatetime`](#structFRHAPI__AuditEvent_1aa2c20100e542b7df27a4e3291b5fc1eb)`(FDateTime NewValue)` <a id="structFRHAPI__AuditEvent_1aa2c20100e542b7df27a4e3291b5fc1eb"></a>
