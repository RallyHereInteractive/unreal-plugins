...
`public inline virtual TSharedRef< FJsonObject > `[`GetSummary`](#classURH__PEXStatGroup_1a9bed00e5a0fd3aae172eb0798109df8b)`() const` | Write the summary data to a JSON object.
...
#### `public inline virtual TSharedRef< FJsonObject > `[`GetSummary`](#classURH__PEXStatGroup_1a9bed00e5a0fd3aae172eb0798109df8b)`() const` <a id="classURH__PEXStatGroup_1a9bed00e5a0fd3aae172eb0798109df8b"></a>
...
`public inline FORCEINLINE `[`FRH_StatCounter`](PlayerExperience.md#structFRH__StatCounter)` & `[`GetCaptureCounter`](#classURH__PEXStatGroupsTopLevel_1a539fce74f6db9aff7e004e63611fa43e)`(ECaptureCounter Counter)` | 
`public inline FORCEINLINE const `[`FRH_StatCounter`](PlayerExperience.md#structFRH__StatCounter)` & `[`GetCaptureCounter`](#classURH__PEXStatGroupsTopLevel_1ac90b6c7e160a288f08b72272ac09cfb4)`(ECaptureCounter Counter) const` | 
...
#### `public inline FORCEINLINE `[`FRH_StatCounter`](PlayerExperience.md#structFRH__StatCounter)` & `[`GetCaptureCounter`](#classURH__PEXStatGroupsTopLevel_1a539fce74f6db9aff7e004e63611fa43e)`(ECaptureCounter Counter)` <a id="classURH__PEXStatGroupsTopLevel_1a539fce74f6db9aff7e004e63611fa43e"></a>

#### `public inline FORCEINLINE const `[`FRH_StatCounter`](PlayerExperience.md#structFRH__StatCounter)` & `[`GetCaptureCounter`](#classURH__PEXStatGroupsTopLevel_1ac90b6c7e160a288f08b72272ac09cfb4)`(ECaptureCounter Counter) const` <a id="classURH__PEXStatGroupsTopLevel_1ac90b6c7e160a288f08b72272ac09cfb4"></a>
...
`public inline const `[`URH_PEXCollectorConfig`](PlayerExperience.md#classURH__PEXCollectorConfig)` * `[`GetConfig`](#classURH__PEXCollector_1a73060520829d8a362086093da332e707)`() const` | Retrieve the config to use for this collector instance.
...
#### `public inline const `[`URH_PEXCollectorConfig`](PlayerExperience.md#classURH__PEXCollectorConfig)` * `[`GetConfig`](#classURH__PEXCollector_1a73060520829d8a362086093da332e707)`() const` <a id="classURH__PEXCollector_1a73060520829d8a362086093da332e707"></a>
...
### Summary
 ...
 Members                        | Descriptions                                
--------------------------------|---------------------------------------------
`public inline FORCEINLINE `[`FRH_StatAccumulator`](PlayerExperience.md#structFRH__StatAccumulator)` & `[`GetCaptureStat`](#classURH__PEXPrimaryStats_1a9aef0de006ea50f014a81c1e20aae31b)`(ECaptureStat Stat)` | 
`public inline FORCEINLINE const `[`FRH_StatAccumulator`](PlayerExperience.md#structFRH__StatAccumulator)` & `[`GetCaptureStat`](#classURH__PEXPrimaryStats_1a4e0f1ca4db6f6b393928223e63cd0302)`(ECaptureStat Stat) const` | 
`public inline FORCEINLINE `[`FRH_StatCounter`](PlayerExperience.md#structFRH__StatCounter)` & `[`GetCaptureCounter`](#classURH__PEXPrimaryStats_1a041cd4358f0743dfde3cfb60014690fa)`(ECaptureCounter Counter)` | 
`public inline FORCEINLINE const `[`FRH_StatCounter`](PlayerExperience.md#structFRH__StatCounter)` & `[`GetCaptureCounter`](#classURH__PEXPrimaryStats_1a28b7e6eead8bdd5ad95e1cc2957e5bfb)`(ECaptureCounter Counter) const` | 
...
#### `public inline FORCEINLINE `[`FRH_StatAccumulator`](PlayerExperience.md#structFRH__StatAccumulator)` & `[`GetCaptureStat`](#classURH__PEXPrimaryStats_1a9aef0de006ea50f014a81c1e20aae31b)`(ECaptureStat Stat)` <a id="classURH__PEXPrimaryStats_1a9aef0de006ea50f014a81c1e20aae31b"></a>

#### `public inline FORCEINLINE const `[`FRH_StatAccumulator`](PlayerExperience.md#structFRH__StatAccumulator)` & `[`GetCaptureStat`](#classURH__PEXPrimaryStats_1a4e0f1ca4db6f6b393928223e63cd0302)`(ECaptureStat Stat) const` <a id="classURH__PEXPrimaryStats_1a4e0f1ca4db6f6b393928223e63cd0302"></a>

#### `public inline FORCEINLINE `[`FRH_StatCounter`](PlayerExperience.md#structFRH__StatCounter)` & `[`GetCaptureCounter`](#classURH__PEXPrimaryStats_1a041cd4358f0743dfde3cfb60014690fa)`(ECaptureCounter Counter)` <a id="classURH__PEXPrimaryStats_1a041cd4358f0743dfde3cfb60014690fa"></a>

#### `public inline FORCEINLINE const `[`FRH_StatCounter`](PlayerExperience.md#structFRH__StatCounter)` & `[`GetCaptureCounter`](#classURH__PEXPrimaryStats_1a28b7e6eead8bdd5ad95e1cc2957e5bfb)`(ECaptureCounter Counter) const` <a id="classURH__PEXPrimaryStats_1a28b7e6eead8bdd5ad95e1cc2957e5bfb"></a>
...
### Summary
 ...
 Members                        | Descriptions                                
--------------------------------|---------------------------------------------
`public inline FORCEINLINE `[`FRH_StatAccumulator`](PlayerExperience.md#structFRH__StatAccumulator)` & `[`GetCaptureStat`](#classURH__PEXNetworkStats__Base_1a066926c3056fdfb9bf4d36df4d8d4bac)`(ECaptureStat Stat)` | 
`public inline FORCEINLINE const `[`FRH_StatAccumulator`](PlayerExperience.md#structFRH__StatAccumulator)` & `[`GetCaptureStat`](#classURH__PEXNetworkStats__Base_1aec5743b880c0098e07f97991127c41bf)`(ECaptureStat Stat) const` | 
...
#### `public inline FORCEINLINE `[`FRH_StatAccumulator`](PlayerExperience.md#structFRH__StatAccumulator)` & `[`GetCaptureStat`](#classURH__PEXNetworkStats__Base_1a066926c3056fdfb9bf4d36df4d8d4bac)`(ECaptureStat Stat)` <a id="classURH__PEXNetworkStats__Base_1a066926c3056fdfb9bf4d36df4d8d4bac"></a>

#### `public inline FORCEINLINE const `[`FRH_StatAccumulator`](PlayerExperience.md#structFRH__StatAccumulator)` & `[`GetCaptureStat`](#classURH__PEXNetworkStats__Base_1aec5743b880c0098e07f97991127c41bf)`(ECaptureStat Stat) const` <a id="classURH__PEXNetworkStats__Base_1aec5743b880c0098e07f97991127c41bf"></a>
...
### Summary
 ...
 Members                        | Descriptions                                
--------------------------------|---------------------------------------------
`public inline FORCEINLINE `[`FRH_StatAccumulator`](PlayerExperience.md#structFRH__StatAccumulator)` & `[`GetCaptureStat`](#classURH__PEXGameStats_1afbc2ea6b284ef73a6887c911affea9cb)`(ECaptureStat Stat)` | 
`public inline FORCEINLINE const `[`FRH_StatAccumulator`](PlayerExperience.md#structFRH__StatAccumulator)` & `[`GetCaptureStat`](#classURH__PEXGameStats_1ad70de512d42ba757706efddd1ff95b6d)`(ECaptureStat Stat) const` | 
...
#### `public inline FORCEINLINE `[`FRH_StatAccumulator`](PlayerExperience.md#structFRH__StatAccumulator)` & `[`GetCaptureStat`](#classURH__PEXGameStats_1afbc2ea6b284ef73a6887c911affea9cb)`(ECaptureStat Stat)` <a id="classURH__PEXGameStats_1afbc2ea6b284ef73a6887c911affea9cb"></a>

#### `public inline FORCEINLINE const `[`FRH_StatAccumulator`](PlayerExperience.md#structFRH__StatAccumulator)` & `[`GetCaptureStat`](#classURH__PEXGameStats_1ad70de512d42ba757706efddd1ff95b6d)`(ECaptureStat Stat) const` <a id="classURH__PEXGameStats_1ad70de512d42ba757706efddd1ff95b6d"></a>
...
`public inline virtual UEngine * `[`GetPEXEngine`](#classURH__TestPEXOwner_1a0041e76e89cb8775f6bdaafd8ed938c6)`() const` | 
`public inline virtual UWorld * `[`GetPEXWorld`](#classURH__TestPEXOwner_1ad5bc675c7a6d2424a87ceee088f2e984)`() const` | 
...
#### `public inline virtual UEngine * `[`GetPEXEngine`](#classURH__TestPEXOwner_1a0041e76e89cb8775f6bdaafd8ed938c6)`() const` <a id="classURH__TestPEXOwner_1a0041e76e89cb8775f6bdaafd8ed938c6"></a>

#### `public inline virtual UWorld * `[`GetPEXWorld`](#classURH__TestPEXOwner_1ad5bc675c7a6d2424a87ceee088f2e984)`() const` <a id="classURH__TestPEXOwner_1ad5bc675c7a6d2424a87ceee088f2e984"></a>
...
`public inline TSharedPtr< FJsonObject > `[`GetSummaryJson`](#structFRH__StatAccumulator_1ab628037e2e78a97f23414accff96ba9e)`(bool bIncludeName) const` | Get a JSON object representing the summary data.
...
#### `public inline TSharedPtr< FJsonObject > `[`GetSummaryJson`](#structFRH__StatAccumulator_1ab628037e2e78a97f23414accff96ba9e)`(bool bIncludeName) const` <a id="structFRH__StatAccumulator_1ab628037e2e78a97f23414accff96ba9e"></a>
...
`public inline TSharedPtr< FJsonObject > `[`GetSummaryJson`](#structFRH__StatCounter_1aec1f3ee940b4e93493c609ab1cadd6cb)`(bool bIncludeName) const` | Get a JSON object representing the summary data.
...
#### `public inline TSharedPtr< FJsonObject > `[`GetSummaryJson`](#structFRH__StatCounter_1aec1f3ee940b4e93493c609ab1cadd6cb)`(bool bIncludeName) const` <a id="structFRH__StatCounter_1aec1f3ee940b4e93493c609ab1cadd6cb"></a>
