...
// Starting from version 5.0, FVector2D has been changed to store coordinates using double floating point precision (rather single floating point precision).
#define ENGINE_COMPATIBILITY_LEGACY_VECTOR2D_API        BELOW_ENGINE_VERSION(5, 0)