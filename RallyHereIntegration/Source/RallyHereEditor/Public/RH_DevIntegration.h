...
typedef TSharedPtr<RallyHereDeveloperAPI::FHttpRetryManager> DevHttpRetryManagerPtr;
...
public:
	...
	*/
    DevHttpRetryManagerPtr GetRetryManager() const { return RetryManager; }
	/**
...
private:
    ...
    DevHttpRetryManagerPtr RetryManager;
