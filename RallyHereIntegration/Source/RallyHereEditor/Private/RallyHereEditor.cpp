...
//$$ MUL - Moved devLoginTabName to the header
...
void FRallyHereEditorModule::StartupModule()
{
	...
	AuthContext->AuthFromToken(Settings->DefaultToken);
...
void FRallyHereEditorModule::RegisterCustomPropertyLayouts()
{
	...
	PropertyModule.RegisterCustomPropertyTypeLayout(TEXT("RH_LootId"), FOnGetPropertyTypeCustomizationInstance::CreateStatic(&FRH_RHLootIdCustomization::MakeInstance));
}
...
void FRallyHereEditorModule::UnregisterCustomPropertyLayouts()
{
	...
	PropertyModule.UnregisterCustomPropertyTypeLayout(TEXT("RH_LootId"));
}
