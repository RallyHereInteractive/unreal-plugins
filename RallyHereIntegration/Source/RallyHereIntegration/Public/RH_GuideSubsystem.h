...
public:
	...
	virtual URH_GuideSearch* CreateGuideSearch(const struct FRH_GuideSearchRequest& InRequest);
	 ...
	 */
	virtual void GetGuideAsync(const FGuid& GuideID, bool bIgnoreCache = false, const FRH_GuideGetCallBlock& Delegate = FRH_GuideGetCallBlock());
	/** @private */
	 ...
	 */
	virtual void CreateGuide(FRHAPI_GuideCreateRequest Request, const FRH_GuideUpdateCallBlock& Delegate = FRH_GuideUpdateCallBlock());
	/** @private */
	 ...
	 */
	virtual void UpdateGuide(const FGuid& GuideID, FRHAPI_GuideCreateRequest Request, const FRH_GuideUpdateCallBlock& Delegate = FRH_GuideUpdateCallBlock());
	/** @private */
	 ...
	 */
	virtual void DeleteGuide(const FGuid& GuideID, const FRH_GuideUpdateCallBlock& Delegate = FRH_GuideUpdateCallBlock());
	/** @private */
	UFUNCTION(BlueprintCallable, Category = "Guide Subsystem", meta = (DisplayName = "Update Guide", AutoCreateRefTerm = "Delegate"))
